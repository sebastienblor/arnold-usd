...
#define REGISTER_AOVS \
	...
	data->aovs.push_back(params[pAovIndirectBacklight].STR); \
	data->aovs.push_back(params[pAovIndirectBacklightRaw].STR); \
...
static const char* phaseFunctionNames[] = {"Schlick", "Henyey-Greenstein", NULL};
