...
if Usd.GetVersion() < (0, 21, 11):
    print('ERROR : Cannot load the MtoA translators for MayaUSD. A more recent version of MayaUSD (0.16) is required, which can be found in https://github.com/Autodesk/maya-usd/releases/tag/v0.16.0')
else:
