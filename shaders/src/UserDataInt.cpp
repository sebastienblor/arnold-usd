...
node_parameters
{
   AiMetaDataSetStr(nentry, NULL, "maya.name", "aiUserDataInt");
   AiMetaDataSetInt(nentry, NULL, "maya.id", ARNOLD_NODEID_USER_DATA_INT);
...
shader_evaluate
{
   AtString name = AtString(AiShaderEvalParamStr(p_intAttrName));
   AtParamValue val;
   bool valid = false;
