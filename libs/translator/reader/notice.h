...
class ArnoldUsdListener : public TfWeakBase
{
public:
    ArnoldUsdListener() = default;

    virtual ~ArnoldUsdListener();
...
private:
    ArnoldUsdListener(const ArnoldUsdListener&) = delete;
    ArnoldUsdListener& operator=(const ArnoldUsdListener&) = delete;
