...
exList = [os.path.join('bin', 'kick'), os.path.join('bin', 'maketx'), os.path.join('bin', 'noice'), os.path.join('bin', 'oslc'), os.path.join('bin', 'oslinfo'), os.path.join('bin', 'lmutil'),os.path.join('bin', 'rlmutil'), os.path.join('license', 'pitreg'), os.path.join('license', 'ArnoldLicensing-8.1.0.1020_RC6-linux.run')]
for ex in exList:
