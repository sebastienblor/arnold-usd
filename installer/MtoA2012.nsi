...
Section "MtoA 2012" MtoA2012
  ...
  SetRegView 64
  ReadRegStr $R0 HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\MtoA2012" "UninstallString"
  ...
  SetRegView 64
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\MtoA2012" \
...
Section "MtoA 2012 Env Variables" MtoA2012EnvVariables
  ...
  SetOutPath "$INSTDIR"
   ...
   ;Create .mod file
    ...
    ReadRegStr $R1 HKLM "Software\Autodesk\Maya\2012\Setup\InstallPath" "MAYA_INSTALL_LOCATION"
    SetOutPath "$R1\modules"
    
    File "mtoa.mod"
    FileOpen $0 "$R1\modules\mtoa.mod" w
...
Section "Uninstall"
  ...
  SetRegView 64
  DeleteRegValue HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\MtoA2012" "DisplayName"
  DeleteRegValue HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\MtoA2012" "UninstallString"
  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\MtoA2012"
