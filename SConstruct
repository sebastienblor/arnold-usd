...
if ENABLE_USD:
    ...
    def AddHydraJsonDesc(usd_cut_version, usd_cut_full_version, usd_cut_python):
        jsonFileText = "\t\t{\n\t\t\t\"PlugPath\":\"hydra/"
    ...
    def AddRegistryJsonDesc(usd_cut_version, usd_cut_full_version, usd_cut_python):
