...
vars.AddVariables(
    ...
    PathVariable('BIFROST_ROOT',
                 'Where to the Bifrost root, which has the sdk, lib, bin, etc subdirectories. Required for the bifrost graph translator.',
                 get_default_path('BIFROST_ROOT', 'Bifrost'), PathVariable.PathIsDir),
