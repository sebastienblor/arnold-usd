...
AtNode* CMeshProceduralTranslator::CreateArnoldNodes()
{
   if (IsMasterInstance())
   {
...
AtByte CMeshProceduralTranslator::ComputeOverrideVisibility()
{
...
void CMeshProceduralTranslator::Export(AtNode* node)
{
...
void CMeshProceduralTranslator::ExportMotion(AtNode* anode)
{
   ExportMatrix(anode);
}

void CMeshProceduralTranslator::ExportInstance(AtNode *instance)
{
...
void CMeshProceduralTranslator::ExportShaders()
{
...
void CMeshProceduralTranslator::NodeChanged(MObject& node, MPlug& plug)
{
...
/*
void CMeshProceduralTranslator::ExportBoundingBox(AtNode *procedural)
{
   MFnDagNode dagNode(m_dagPath.node());
