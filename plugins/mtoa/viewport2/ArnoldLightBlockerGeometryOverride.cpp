	...
	MHWRender::MGeometry &data)
{
	...
	if (m_geometryDirty)
	{
        ...
        if (m_primitiveType == 0) // Box
        {
			...
			CGBoxPrimitive::generateData(m_wirePositions, m_wireIndexing, scale);
        }
...
#if 0
void CArnoldLightBlockerGeometryOverride::addUIDrawables(const MDagPath& objPath,
												...
												const MUserData* data)
{
	...
	drawManager.mesh(MHWRender::MUIDrawManager::kLines, 
		userData->m_wirePositions, NULL, NULL, &userData->m_wireIndexing );
