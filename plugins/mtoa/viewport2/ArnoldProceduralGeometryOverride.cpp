...
#include "ArnoldProceduralGeometryOverride.h"
...
MHWRender::MPxGeometryOverride* CArnoldProceduralGeometryOverride::Creator(const MObject& obj)
{
    return new CArnoldProceduralGeometryOverride(obj);
}

CArnoldProceduralGeometryOverride::CArnoldProceduralGeometryOverride(const MObject& obj) :
...
CArnoldProceduralGeometryOverride::~CArnoldProceduralGeometryOverride()
{
	MHWRender::MRenderer* renderer = MHWRender::MRenderer::theRenderer();
	if (renderer)
	{
...
MHWRender::DrawAPI CArnoldProceduralGeometryOverride::supportedDrawAPIs() const
{
    return (MHWRender::kAllDevices);
}

bool CArnoldProceduralGeometryOverride::isIndexingDirty(const MHWRender::MRenderItem &item) 
{ 
	return true; 
}

bool CArnoldProceduralGeometryOverride::isStreamDirty(const MHWRender::MVertexBufferDescriptor &desc) 
{ 
	return true; 
}

void CArnoldProceduralGeometryOverride::updateRenderItems(const MDagPath &path, MHWRender::MRenderItemList& list)
{
	MHWRender::MRenderer* renderer = MHWRender::MRenderer::theRenderer();
	if (!renderer)
		return;
    ...
    {
        CArnoldProceduralNode * shapeNode = dynamic_cast<CArnoldProceduralNode*>(depNode.userNode());
        if( shapeNode != NULL)
        {
...
void CArnoldProceduralGeometryOverride::populateGeometry(const MHWRender::MGeometryRequirements &requirements, 
