...
const MString CLASSIFY_ARNOLD_SHADER(ARNOLD_CLASSIFY(CLASSIFY_SHADER_SURFACE));

const MString SHADER_NO_SWATCH = CLASSIFY_ARNOLD_SHADER
                               + ":" + CLASSIFY_SHADER_SURFACE;
const MString SHADER_WITH_SWATCH = SHADER_NO_SWATCH
