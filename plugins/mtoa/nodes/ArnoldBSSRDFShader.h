#ifndef ARNOLD_BSSRDF_SHADER_H
#define ARNOLD_BSSRDF_SHADER_H

#include <maya/MPxNode.h>

class CArnoldBSSRDFShaderNode
   :  public MPxNode
{
...
public:
   ...
   static MObject s_radiusR;
   static MObject s_radiusG;
