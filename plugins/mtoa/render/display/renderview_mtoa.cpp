...
//    std::string statusFilter = "STATUS;RESOLUTION;DEVICE;SAMPLES;MEMORY;PROGRESS";
//    CRenderViewInterface::OpenOptionsWindow(250, 50,scaleFactor, menusFilter.c_str(), nullptr, false, statusFilter.c_str());
