...
public:
   ...
   static const ArnoldNodeMetadataStore *FindNodeMetadatas(const MString &nodeType, bool mayaType = false);
   static MStringArray FindMatchingMetadatas(const MString &metadata, const MString& value);
protected:
