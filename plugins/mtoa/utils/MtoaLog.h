...
#define DEFAULT_SWATCH_LOG_FLAGS AI_LOG_ALL
#else
#define DEFAULT_LOG_FLAGS (AI_LOG_ALL & ~AI_LOG_DEBUG)
#define DEFAULT_SWATCH_LOG_FLAGS (AI_LOG_WARNINGS | AI_LOG_ERRORS | AI_LOG_TIMESTAMP | AI_LOG_BACKTRACE)
#endif
