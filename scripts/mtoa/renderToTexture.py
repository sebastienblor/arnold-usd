...
class MtoARenderToTexture(object):
    ...
    def doExport(self):
        ...
        useRegion = cmds.checkBox('use_region', q=True, v=True)
    ...
    def createUI(self):
        ...
        cmds.checkBox( 'use_region',label='Use Render Region', value=False )
        cmds.rowLayout(numberOfColumns=2, columnAlign2=('left', 'right'))
        cmds.intFieldGrp('region_min_x', label='Region Minx', value1=0, ct2=('left', 'left'),  cw2=(90,110), w=230)
        cmds.intFieldGrp('region_min_y', label='Region Miny', cw2=(90,110), value1=0, w=200)
        cmds.setParent("..")
        cmds.rowLayout(numberOfColumns=2, columnAlign2=('left', 'right'))
        cmds.intFieldGrp('region_max_x', label='Region Maxx', value1=0, ct2=('left', 'left'),  cw2=(90,110), w=230)
        cmds.intFieldGrp('region_max_y', label='Region Maxy', cw2=(90,100), value1=0, w=200)
        cmds.setParent("..")
