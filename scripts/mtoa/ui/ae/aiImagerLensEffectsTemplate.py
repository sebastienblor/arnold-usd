...
class ImagerLensEffectUI(ImagerBaseUI):
    ...
    def setup(self):
        ...
        self.addControl('bloom_strength', label='Bloom Strength', annotation='', hideMapButton = True)
        self.addControl('bloom_radius', label='Bloom Radius', annotation='', hideMapButton = True)
        self.addControl('bloom_tint', label='Bloom Tint', annotation='')
        self.addControl('bloom_threshold', label='Bloom Threshold', annotation='', hideMapButton = True)
        self.endLayout()
