...
class AEaiSkinSSSExTemplate(ShaderAETemplate):
    ...
    def setup(self):
        ...
        self.addControl("primary_specular_enable_fresnel_falloff", label="Enable Fresnel Falloff")
        ...
        self.addControl("secondary_specular_enable_fresnel_falloff", label="Enable Fresnel Falloff")
