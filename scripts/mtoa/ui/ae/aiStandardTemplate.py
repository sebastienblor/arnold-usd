...
def aiStandardTemplate(nodeName):
    ...
    cmds.editorTemplate(suppress="KdColor")
    cmds.editorTemplate(suppress="diffuseRoughness")
    cmds.editorTemplate(suppress="KsColor")
    cmds.editorTemplate(suppress="specularBrdf")
    cmds.editorTemplate(suppress="specularRoughness")
    cmds.editorTemplate(suppress="specularAnisotropy")
    cmds.editorTemplate(suppress="specularRotation")
    cmds.editorTemplate(suppress="PhongExponent")
    cmds.editorTemplate(suppress="KrColor")
    cmds.editorTemplate(suppress="reflectionExitColor")
    cmds.editorTemplate(suppress="reflectionExitUseEnvironment")
    cmds.editorTemplate(suppress="KtColor")
    cmds.editorTemplate(suppress="refractionRoughness")
    cmds.editorTemplate(suppress="refractionExitColor")
    cmds.editorTemplate(suppress="refractionExitUseEnvironment")
    cmds.editorTemplate(suppress="specularFresnel")
    cmds.editorTemplate(suppress="FresnelAffectDiff")
    cmds.editorTemplate(suppress="emissionColor")
    cmds.editorTemplate(suppress="directSpecular")
    cmds.editorTemplate(suppress="indirectSpecular")
    cmds.editorTemplate(suppress="directDiffuse")
    cmds.editorTemplate(suppress="indirectDiffuse")
    cmds.editorTemplate(suppress="enableGlossyCaustics")
    cmds.editorTemplate(suppress="enableReflectiveCaustics")
    cmds.editorTemplate(suppress="enableRefractiveCaustics")
    cmds.editorTemplate(suppress="enableInternalReflections")
    cmds.editorTemplate(suppress="KsssColor")
    cmds.editorTemplate(suppress="sssRadius")
    cmds.editorTemplate(suppress="bounceFactor")
    cmds.editorTemplate(suppress="aovEmission")
    cmds.editorTemplate(suppress="aovDirectDiffuse")
    cmds.editorTemplate(suppress="aovDirectSpecular")
    cmds.editorTemplate(suppress="aovIndirectDiffuse")
    cmds.editorTemplate(suppress="aovIndirectSpecular")
    cmds.editorTemplate(suppress="aovReflection")
    cmds.editorTemplate(suppress="aovRefraction")
    cmds.editorTemplate(suppress="aovSss")
