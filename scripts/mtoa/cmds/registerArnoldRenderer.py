...
def arnoldAddGlobalsTabs():
    cmds.renderer('arnold', edit=True, addGlobalsTab=('Common', utils.pyToMelProc(createArnoldRendererCommonGlobalsTab, shortName=True), utils.pyToMelProc(updateArnoldRendererCommonGlobalsTab, shortName=True)))
    cmds.renderer('arnold', edit=True, addGlobalsTab=('Arnold Renderer', utils.pyToMelProc(createArnoldRendererGlobalsTab, shortName=True), utils.pyToMelProc(updateArnoldRendererGlobalsTab, shortName=True)))
