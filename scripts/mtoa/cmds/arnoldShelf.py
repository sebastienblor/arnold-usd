...
def createArnoldShelf():
   ...
   cmds.shelfButton(label='Create SkyDome Light', command='import mtoa.utils as mutils; mutils.createLocator("aiSkyDomeLight", asLight=True)', sourceType='python', annotation='Create SkyDome Light', image='SkydomeLightShelf.svg', style='iconOnly')
   cmds.shelfButton(label='Create Sky', command='import mtoa.cmds.arnoldShelf as arnoldShelf; arnoldShelf.createSky()', sourceType='python', annotation='Create Sky', image='SkyShelf.svg', style='iconOnly')
   cmds.shelfButton(label='Create Physical Sky', command='import mtoa.cmds.arnoldShelf as arnoldShelf; arnoldShelf.createPhysicalSky()', sourceType='python', annotation='Create Physical Sky', image='PhysicalSkyShelf.svg', style='iconOnly')
   cmds.shelfButton(label='Create Light Portal', command='import mtoa.ui.arnoldmenu as arnoldmenu; arnoldmenu.doCreateLightPortal()', sourceType='python', annotation='Create Light Portal', image='LightPortalShelf.svg', style='iconOnly')   
   cmds.shelfButton(label='Create Area Light', command='import mtoa.utils as mutils;mutils.createLocator("aiAreaLight", asLight=True)', sourceType='python', annotation='Create Area Light', image='AreaLightShelf.svg', style='iconOnly')
   cmds.shelfButton(label='Create Mesh Light', command='import mtoa.utils as mutils; mutils.createMeshLight()', sourceType='python', annotation='Create Mesh Light', image='MeshLightShelf.svg', style='iconOnly')
   cmds.shelfButton(label='Create Photometric Light', command='import mtoa.utils as mutils; mutils.createLocator("aiPhotometricLight", asLight=True)', sourceType='python', annotation='Create Photometric Light', image='PhotometricLightShelf.svg', style='iconOnly') 
