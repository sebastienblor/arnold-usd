...
def createArnoldShelf():
   ...
   cmds.shelfButton(label='Arnold RenderView', command='import maya.cmds as cmds; cmds.arnoldRenderView()', sourceType='python', annotation='Arnold RenderView', image='RenderViewShelf.png', style='iconOnly')    
