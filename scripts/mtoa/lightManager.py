...
class MtoALightManager(object):
    def __init__(self):
        ...
        callbacks.addAttributeChangedCallback(self.meshTranslatorChanged, 'mesh', 'aiTranslator', applyToExisting=False)
    ...
    def createUI(self):
        cmds.scrollLayout(childResizable=True, minChildWidth=750)
        ...
        cmds.rowLayout(numberOfColumns=6, adjustableColumn=2, columnWidth6=[50, 160, 160, 180, 180, 40], columnAttach=[(1, 'both', 5), (2, 'both', 5), (3, 'both', 5), (4, 'both', 5), (5, 'both', 5), (6, 'both', 1)] )
