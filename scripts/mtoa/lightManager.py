...
class MtoALightManager(object):
    ...
    def createUI(self):
        ...
        cmds.nodeIconButton( style='iconOnly', command=lambda *args: mutils.createLocator('aiAreaLight', asLight=True), image1='AreaLightShelf.svg' )
        cmds.nodeIconButton( style='iconOnly', command=lambda *args: mutils.createLocator('aiSkyDomeLight', asLight=True), image1='SkydomeLightShelf.svg' )
        cmds.nodeIconButton( style='iconOnly', command=lambda *args: mutils.createLocator('aiPhotometricLight', asLight=True), image1='PhotometricLightShelf.svg' )
        cmds.nodeIconButton( style='iconOnly', command=lambda *args: mutils.createMeshLight(), image1='MeshLightShelf.svg' )
        cmds.setParent('..')
        cmds.separator()
        cmds.setParent('..')
