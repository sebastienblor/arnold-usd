...
//Name: test.ma
//Last modified: Fri, Feb 17, 2017 09:25:39 PM
//Codeset: 1252
requires maya "2017";
requires -nodeType "aiOptions" -nodeType "aiAOVDriver" -nodeType "aiAOVFilter" -nodeType "aiUtility"
		 -nodeType "aiMotionVector" -nodeType "aiStandard" "mtoa" "2.0.0.0";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FD47A79B-4D7E-886D-D1AD-8F819550BAFF";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "D77391FC-466B-6CC1-1BB6-80B930FF1A1E";
createNode displayLayer -n "defaultLayer";
	rename -uid "1D8E55E9-4BC9-C4EF-728D-9791017FAAA2";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "95E83940-4278-3C23-6B70-3A9A28A78347";
...
createNode cacheFile -n "nParticleShape1Cache1";
	...
	setAttr ".cp" -type "string" "D:/arnold/mtoa/testsuite/test_0122/data/test/";
	setAttr ".os" 1;
	setAttr ".oe" 100;
	setAttr ".ss" 1;
	setAttr ".se" 100;
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7EC3381B-4AF6-1035-91B7-3FAC83A1FA16";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8729174B-4470-AE0B-FE66-50B9510BF2CE";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi" 0;
	setAttr -k on ".nds";
