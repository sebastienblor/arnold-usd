...
//Name: test.ma
//Last modified: Fri, Jun 22, 2012 06:27:08 PM
//Codeset: UTF-8
requires maya "2011";
...
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" -1.183002068002228 -1.9424675824916786 6.8884646225719495 ;
	setAttr ".r" -type "double3" -66.998783856856946 38.303008176074755 -46.210671185033156 ;
...
createNode aiStandard -n "aiStandard5";
	setAttr ".Kd_color" -type "float3" 0 1 0 ;
...
createNode displacementShader -n "displacementShader4";
	addAttr -ci true -k true -sn "ai_displacement_padding" -ln "aiDisplacementPadding" 
		-at "float";
	addAttr -ci true -k true -sn "ai_displacement_zero_value" -ln "aiDisplacementZeroValue" 
		-at "float";
	addAttr -ci true -k true -sn "ai_displacement_auto_bump" -ln "aiDisplacementAutoBump" 
		-min 0 -max 1 -at "bool";
	setAttr -k on ".ai_displacement_padding" 1;
...
createNode displacementShader -n "displacementShader6";
	...
	addAttr -ci true -k true -sn "ai_displacement_auto_bump" -ln "aiDisplacementAutoBump" 
		-min 0 -max 1 -at "bool";
	setAttr -k on ".ai_displacement_zero_value" 1;
	setAttr -k on ".ai_displacement_auto_bump" yes;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
