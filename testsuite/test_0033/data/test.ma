...
//Name: test.ma
//Last modified: Thu, Mar 16, 2017 05:02:56 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	rename -uid "596780CD-4700-941F-F7C9-2E9373E23627";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.4235782869176601 1.0063204384796565 1.4004041871751336 ;
	setAttr ".r" -type "double3" -29.738352729602607 44.600000000000257 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "C751A535-45DA-C608-A1B8-24874E142C9B";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 2.2357839209826662;
...
createNode transform -s -n "top";
	rename -uid "E8EF3E2B-48F5-CDA0-7438-66BB8FF217F0";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "F6D4E569-4CE4-9DD7-0891-7E9DC6A7F0BF";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "134B748F-4F98-C1A1-176F-B0B4651AEC34";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "83835B3D-46DC-2DA2-9F1E-698334558067";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "6C0C09E8-42C7-2455-D672-069449B4572E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "BB842311-42E7-8C25-045F-95B03D0BF645";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -n "pCube1";
	rename -uid "C875B583-4C55-F6FC-C1A9-63904F76947F";
createNode mesh -n "pCubeShape1" -p "pCube1";
	rename -uid "FAA1CABD-4568-88EC-4597-53ABF475BE45";
...
createNode place3dTexture -n "place3dTexture1";
	rename -uid "6A9DC0F0-4019-3816-DB79-C9BB9738A698";
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "1A4FDA19-4861-7649-EFC0-AA8608D226CA";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F63A0D6D-4A0D-4F2D-0507-7F85B9265917";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "C33F539D-4337-B591-E97F-919EE7E4EC63";
createNode displayLayer -n "defaultLayer";
	rename -uid "2EB1CB90-4A9C-EBEC-DA30-0D814E4F5290";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C82A5D8E-4B9C-89B9-0164-1C81F83F5342";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "77C87967-4AA4-574F-5D4A-1092674F3010";
	setAttr ".g" yes;
createNode polyCube -n "polyCube1";
	rename -uid "0300A117-4BBA-2E1A-4A4F-3F9A49885807";
	setAttr ".cuv" 4;
createNode deleteComponent -n "deleteComponent1";
	rename -uid "C6DC2750-49B1-3C7E-FADB-C48D358B0E5C";
	setAttr ".dc" -type "componentList" 2 "f[0:1]" "f[4]";
createNode projection -n "projection1";
	rename -uid "CB8CC6AB-4186-D1FF-F778-8C8072D209AF";
...
createNode file -n "file1";
	rename -uid "882D0571-4DD3-8747-0430-49901528ED77";
	setAttr ".ftn" -type "string" "D:/arnold/mtoa/testsuite/test_0033/data/grid_opacity.tif";
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "BD5B67EC-4D28-7145-859B-7DAD1D770177";
createNode shadingEngine -n "surfaceShader1SG";
	rename -uid "2E70AF3F-4CFF-A5BB-380F-0B936A19E40E";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "D4CA27DD-4427-46B2-7675-FD960B8A45A7";
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "9AA73E70-4243-EE69-24EF-E69576934D7F";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 48 ";
	setAttr ".st" 6;
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "AEB11064-491D-F996-B324-1CB8058FB100";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "9075AC11-490E-892D-F82A-A6AAED1496D3";
...
createNode script -n "uiConfigurationScriptNode";
	rename -uid "3FE1873F-4521-CF58-A922-43B1AEA3A67C";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "35B4758E-452E-6A0A-2C3E-6F857D79CEF9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "51BDE5D4-472C-96EE-D89A-21AD238E7E48";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "172B437A-4B2C-B0F7-B426-A39B93D0D48E";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode aiUtility -n "aiUtility1";
	rename -uid "6331AC23-43FB-7F8E-2B14-DDB332D7E55A";
	setAttr ".shade_mode" 2;
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "86CFA0B8-4E80-BC66-D02C-4AB8DD524EA2";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -197.52934946690286 -385.57469834679381 ;
	setAttr ".tgi[0].vh" -type "double2" 628.10087947563318 308.10549400675256 ;
	setAttr -s 5 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -331.42855834960937;
	...
	setAttr ".tgi[0].ni[3].x" -638.5714111328125;
	setAttr ".tgi[0].ni[3].y" 44.285713195800781;
	setAttr ".tgi[0].ni[3].nvs" 1923;
	setAttr ".tgi[0].ni[4].x" 253.8348388671875;
	setAttr ".tgi[0].ni[4].y" 194.14295959472656;
...
connectAttr "aiUtility1.out" "surfaceShader1SG.ss";
...
connectAttr "projection1.oc" "aiUtility1.color";
