...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.074187244628984 1.5556403887681427 2.0741872148266616 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 3.3203195593500814;
...
createNode place3dTexture -n "place3dTexture1";
	setAttr ".r" -type "double3" 29.999999999999996 59.999999999999993 90 ;
...
connectAttr "solidFractal1.oc" "surfaceShader1.oc";
