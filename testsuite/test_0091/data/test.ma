...
//Name: test.ma
//Last modified: Fri, Feb 17, 2017 05:23:52 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	rename -uid "DDB25B20-49F5-7531-38EF-4D94014AE0BC";
...
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "766B6F42-4EC2-F3A0-2E63-59AA3EE0F94F";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr -k off ".v" no;
...
createNode transform -s -n "top";
	rename -uid "CDAC08CC-47B8-6635-9FE2-B2A6AFA982B5";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".v" no;
...
createNode camera -s -n "topShape" -p "top";
	rename -uid "596428AF-49A2-E55C-9D73-E8AF751A4E46";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
...
createNode transform -s -n "front";
	rename -uid "3C4D7347-4B55-4019-8B37-309FCCEE5692";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 100.1 ;
	setAttr ".lumaID" -type "string" "a:1338571498.23:0.020474217924";
createNode camera -s -n "frontShape" -p "front";
	rename -uid "BAC5E083-420E-868C-B27A-F49CDA61F054";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
...
createNode transform -s -n "side";
	rename -uid "A97902F1-4C16-3615-9A33-4581497DCB20";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".v" no;
...
createNode camera -s -n "sideShape" -p "side";
	rename -uid "2C149C69-46D7-4A1D-ACFD-7ABDA3ECF16A";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
...
createNode transform -n "pPlane1";
	rename -uid "8AB9B394-4E23-9B0C-C1A7-7B80256113BE";
...
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "BE773CB5-4C6C-59E3-436B-E59F28307959";
...
createNode transform -n "pCylinder1";
	rename -uid "5A345557-4E69-7C49-3078-E9BC5441E576";
	setAttr ".t" -type "double3" 0.48884127763690621 0.56287865063488252 -0.63205810580458688 ;
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	rename -uid "36258C5C-4973-F72D-0EBF-9D93B9D56BE3";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	addAttr -ci true -sn "ai_sss_sample_spacing" -ln "aiSssSampleSpacing" -dv 0.10000000149011612 
...
createNode transform -n "pCube1";
	rename -uid "ED4E3041-4695-6842-0AFA-13A4FB9A993A";
	setAttr ".t" -type "double3" -1.1940193459091279 0.28760028298830953 1.4979388730369196 ;
createNode mesh -n "pCubeShape1" -p "pCube1";
	rename -uid "5E670747-4084-3AA8-95F8-96A305D3018B";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	addAttr -ci true -sn "ai_sss_sample_spacing" -ln "aiSssSampleSpacing" -dv 0.10000000149011612 
...
createNode transform -n "aiAreaLight1";
	rename -uid "ACDCAAE2-4937-7EB0-3F32-55A57A4A45A0";
...
createNode aiAreaLight -n "aiAreaLightShape1" -p "aiAreaLight1";
	rename -uid "CB002CD9-4F9E-E2B1-8F0F-428AF18ABDD6";
...
createNode transform -n "aiAreaLight2";
	rename -uid "01A1FF93-4802-F82D-BAC9-7F8E8EC0828E";
...
createNode aiAreaLight -n "aiAreaLightShape2" -p "aiAreaLight2";
	rename -uid "059D33BC-4ED5-6F57-A9A6-079F823EF317";
	addAttr -ci true -h true -sn "aal" -ln "attributeAliasList" -dt "attributeAlias";
	addAttr -ci true -sn "ai_bounce_factor" -ln "aiBounceFactor" -dv 1 -at "float";
	addAttr -ci true -sn "ai_bounces" -ln "aiBounces" -dv 999 -at "long";
	setAttr -k off ".v";
...
createNode transform -n "pTorus1";
	rename -uid "C96BD3E4-4FD8-70C8-B505-2BAF6F9D56A0";
	setAttr ".t" -type "double3" 0.47754778398915132 0.5 -0.62709806308194616 ;
createNode mesh -n "pTorusShape1" -p "pTorus1";
	rename -uid "DE1A194F-497F-3A38-EAFC-8AA43B60E7F2";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pCube2";
	rename -uid "2717623F-4141-A653-AF8B-06BD48EC248F";
	setAttr ".t" -type "double3" -2.144529165510018 0.067668986066620307 2.1059178931327809 ;
	setAttr ".r" -type "double3" 9.4201817973586834 0.014741289124281303 -17.777487177596285 ;
createNode mesh -n "pCubeShape2" -p "pCube2";
	rename -uid "460AF2C6-4AE0-D0B1-EDD6-92A51F832EC0";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "4030CEF3-40B7-A838-DB0D-3D855269C7CE";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".ai_translator" -type "string" "gaussian";
	setAttr ".lumaID" -type "string" "a:1338571498.24:0.00289691703387";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "9BB3E12C-467B-279C-5A9C-1BAAC49C1941";
...
createNode script -n "uiConfigurationScriptNode";
	rename -uid "0D522DA4-47B3-D541-5E94-2083BDC52944";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "20D84243-450F-4C70-7133-119F3ED21CC3";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 48 ";
	setAttr ".st" 6;
	setAttr ".lumaID" -type "string" "a:1338571498.24:0.327427577445";
createNode shadingEngine -n "aiStandard1SG";
	rename -uid "F6777E7A-4386-8D0E-A5D6-798CBBA281C4";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
	setAttr ".lumaID" -type "string" "a:1338571498.24:0.605096344078";
createNode materialInfo -n "materialInfo1";
	rename -uid "735BCFE5-4CFD-250D-FB11-5AAF1E602FCD";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".lumaID" -type "string" "a:1338571498.24:0.205191995159";
createNode shadingEngine -n "lambert2SG";
	rename -uid "42755E18-4E7E-CB9A-31FB-749EFC92E2B2";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "98FA8693-41A2-F1CA-B1F5-B39356FA72B9";
createNode polyPlane -n "polyPlane1";
	rename -uid "6E8E780B-4BFD-C6AA-540A-7284AD5B0E42";
...
createNode aiStandard -n "aiStandard2";
	rename -uid "5117A987-47ED-9C83-45DA-F09EDE6960A1";
createNode shadingEngine -n "aiStandard2SG";
	rename -uid "0F84FFCC-4021-F2C0-D07F-0CA103DE3759";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "F1C32207-4E2D-C43C-7898-B1B935264CE1";
createNode polyCylinder -n "polyCylinder1";
	rename -uid "C52D38F2-4EE4-9CAA-D3CE-3AB70AB5B50A";
	setAttr ".r" 0.16848355281410488;
	setAttr ".h" 1.125757301269765;
	setAttr ".sc" 1;
	setAttr ".cuv" 3;
createNode polyCube -n "polyCube1";
	rename -uid "10FE534C-41DE-B5C2-5D4F-E19F2BA1E5CC";
	setAttr ".w" 0.57520056597661906;
	setAttr ".h" 0.57520056597661906;
	setAttr ".d" 0.57520056597661906;
	setAttr ".cuv" 4;
createNode polyTorus -n "polyTorus1";
	rename -uid "61176940-4096-4521-8573-74BA41DC16BA";
	setAttr ".r" 0.8890965984374386;
	setAttr ".sr" 0.19999999999999996;
createNode polyCube -n "polyCube2";
	rename -uid "474A923E-4191-2C72-038F-E995CAEBE795";
	setAttr ".w" 0.48456881949214381;
	setAttr ".h" 0.62220969711138807;
	setAttr ".d" 0.5842524218305285;
	setAttr ".cuv" 4;
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "DB8F62D5-47A8-367B-AA31-19A4198D9DE1";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CF68AE9B-4E8D-006F-7CDA-8B919E69AB4A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D2275025-4B67-24AB-5D92-889DE2B3FA0D";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
