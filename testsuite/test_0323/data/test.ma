...
//Name: test.ma
//Last modified: Fri, Jan 25, 2019 10:38:35 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	rename -uid "11E10788-415C-2FC3-F52A-DDA09F06FBA1";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.6283554565121412 3.2574683443113575 0.15421752981121523 ;
	setAttr ".r" -type "double3" -95.738352729603776 -0.20000000000004547 -6.21205870822091e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "9B28347F-4B50-7C96-3AE3-58B33BC17FEA";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 3.2427883324705458;
...
createNode transform -s -n "top";
	rename -uid "B1BB51BF-4E43-2660-A674-52992E7A339D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "4015DF3E-461C-D741-A73C-35A7E013E0D9";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "3AA1892D-40A8-41C3-D6EA-AD9FDF364038";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "5B4A0C41-47FF-4852-C891-398D4449ECD5";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "8E5AD249-4F26-3172-0503-1BAF759690CE";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "F2B38C6E-430A-89D2-9807-2B87985E7EF6";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -n "pPlane3";
	rename -uid "71EE9A79-48B9-353D-5128-C1AB37161612";
createNode mesh -n "pPlaneShape3" -p "pPlane3";
	rename -uid "D151FF1E-4946-49B8-FDE8-1AA5A79126ED";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "pPlane4";
	rename -uid "064C90ED-4712-4E59-11D4-F88FCAD1EC43";
	setAttr ".t" -type "double3" 1.1166347727752544 0 0 ;
createNode mesh -n "pPlaneShape4" -p "pPlane4";
	rename -uid "6548E6F9-41E7-F797-8A15-928B3C247C38";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pPlane5";
	rename -uid "E37378EB-464D-9648-46DA-40BA5F68BED0";
	setAttr ".t" -type "double3" 0.51328106620276825 0 1.0453388564355863 ;
createNode mesh -n "pPlaneShape5" -p "pPlane5";
	rename -uid "923261F1-4146-5983-8D2B-A2B26738DD47";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "45080DBC-4F1F-A3D6-D478-9D971EDBB529";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0177DE5F-4229-ED9E-A888-62BFE30C1830";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4ED25F85-42E8-2936-9A31-2AABCA991374";
createNode displayLayerManager -n "layerManager";
	rename -uid "45B93B19-4AE8-13EA-326C-C381FE8A0A10";
createNode displayLayer -n "defaultLayer";
	rename -uid "3B125B46-4025-71E8-767F-92B5A203BDDE";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BDBB3156-40F2-155B-F058-EB984C181DB6";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "7731D3B3-4567-CE66-5554-3C89C4D9D407";
	setAttr ".g" yes;
createNode aiFlat -n "aiFlat1";
	rename -uid "C83706EC-4F7F-4EF2-0B98-71BC008647D7";
createNode shadingEngine -n "aiFlat1SG";
	rename -uid "1137CED1-48DD-5E3D-2A28-3EA394C30B2D";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "D2F7D65B-4616-ABD0-8E55-5BB1E6050AF1";
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "229014E8-4CC7-DB69-F236-B8B9D51FC2FF";
...
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "D08D5D34-4505-ABC3-0F6A-6992449986F4";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "E3D073F6-4118-DED3-765E-209F2B65A2FE";
	setAttr ".ai_translator" -type "string" "tif";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "EA9EE003-412A-3B02-C4A3-0BB22AF18EF5";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode file -n "file1";
	rename -uid "38AFE102-4683-4E07-8EE7-E6A8F9B002C9";
	setAttr ".ftn" -type "string" "D:/arnold/scenes/textures/test.tx";
	setAttr ".cs" -type "string" "Raw";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "438A45DC-40F6-D935-79E6-758B033EFB6D";
createNode aiFlat -n "aiFlat2";
	rename -uid "5A99CFA2-4A58-5AF6-CEAC-E584602E8340";
createNode shadingEngine -n "aiFlat2SG";
	rename -uid "5C91801B-4DFE-14D8-202C-6E85C77438CB";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "19FDDE62-4D1A-969F-94A1-96ACFFDD3A4B";
createNode hsvToRgb -n "hsvToRgb1";
	rename -uid "0429B4FE-4CD3-A53B-6CFB-589AEB82BC90";
createNode rgbToHsv -n "rgbToHsv1";
	rename -uid "8770B909-4E07-3AD0-D74E-139B755560DA";
createNode script -n "uiConfigurationScriptNode";
	rename -uid "C8D21B9C-40F3-B7D9-63EF-A6AC0ABA6C78";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "39A7CA40-4C6F-596B-D296-AAA3B9451194";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 120 -ast 1 -aet 200 ";
	setAttr ".st" 6;
createNode polyPlane -n "polyPlane2";
	rename -uid "4F86F3E3-430B-D8C3-C3DC-8C990CA14096";
	setAttr ".cuv" 2;
createNode polyPlane -n "polyPlane3";
	rename -uid "84C8C509-4387-5287-2786-7694ABA82D24";
	setAttr ".cuv" 2;
createNode aiFlat -n "aiFlat3";
	rename -uid "C89CA21D-457A-D0D8-0C9D-D197787B24F8";
createNode shadingEngine -n "aiFlat3SG";
	rename -uid "FF0AD90E-4FC5-42D5-71B6-C480E06F9CA0";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "B47A76AB-4B99-3B64-F5A7-D896671B9D1E";
createNode remapHsv -n "remapHsv1";
	rename -uid "78EAB93E-452E-920E-5300-BDA328448967";
	setAttr -s 4 ".h[0:3]"  0 0 1 1 0.62 1 0.80000001 0.31999999 
		1 0.12173913 0.69999999 1;
	setAttr -s 4 ".s[0:3]"  0 0 1 0.99130434 0.88 1 0.39130434 0.34 
		1 0.54782611 1 1;
	setAttr -s 3 ".v[0:2]"  0 0.25999999 1 1 1 1 0.46956521 0.25999999 
		1;
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "F90FA5BB-48F9-BA49-267B-FDB8A4FA003D";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -907.89954331342904 -405.95236482128325 ;
	setAttr ".tgi[0].vh" -type "double2" 440.04241904725814 445.2380775459236 ;
	...
	setAttr ".tgi[0].ni[2].x" -792.85711669921875;
	...
	setAttr ".tgi[0].ni[4].x" -130.35008239746094;
	setAttr ".tgi[0].ni[4].y" -106.43956756591797;
	setAttr ".tgi[0].ni[4].nvs" 1923;
	setAttr ".tgi[0].ni[5].x" -439.48117065429688;
	setAttr ".tgi[0].ni[5].y" -178.47491455078125;
	setAttr ".tgi[0].ni[5].nvs" 1923;
	setAttr ".tgi[0].ni[6].x" 128.57142639160156;
	setAttr ".tgi[0].ni[6].y" -31.428571701049805;
	setAttr ".tgi[0].ni[6].nvs" 1923;
	setAttr ".tgi[0].ni[7].x" -641.2503662109375;
	setAttr ".tgi[0].ni[7].y" -67.849288940429688;
	setAttr ".tgi[0].ni[7].nvs" 1923;
	setAttr ".tgi[0].ni[8].x" -413.525634765625;
	setAttr ".tgi[0].ni[8].y" 319.6229248046875;
	setAttr ".tgi[0].ni[8].nvs" 1923;
	setAttr ".tgi[0].ni[9].x" -689.2691650390625;
	setAttr ".tgi[0].ni[9].y" 336.46914672851563;
	setAttr ".tgi[0].ni[9].nvs" 1939;
	setAttr ".tgi[0].ni[10].x" -170;
	setAttr ".tgi[0].ni[10].y" 392.85714721679688;
...
connectAttr "pPlaneShape3.iog" "aiFlat1SG.dsm" -na;
connectAttr "pPlaneShape4.iog" "aiFlat1SG.dsm" -na;
...
connectAttr "hsvToRgb1.o" "aiFlat2.color";
...
connectAttr "rgbToHsv1.o" "hsvToRgb1.i";
connectAttr "file1.oc" "rgbToHsv1.i";
connectAttr "file1.oc" "aiFlat3.color";
connectAttr "remapHsv1.oc" "aiFlat3SG.ss";
connectAttr "pPlaneShape5.iog" "aiFlat3SG.dsm" -na;
connectAttr "aiFlat3SG.msg" "materialInfo3.sg";
connectAttr "remapHsv1.msg" "materialInfo3.m";
connectAttr "remapHsv1.msg" "materialInfo3.t" -na;
connectAttr "aiFlat3.out" "remapHsv1.cl";
...
connectAttr "aiFlat1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "aiFlat2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "hsvToRgb1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "aiFlat2SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
connectAttr "rgbToHsv1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[7].dn"
		;
connectAttr "remapHsv1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[8].dn"
		;
connectAttr "aiFlat3.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
connectAttr "aiFlat3SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[10].dn"
		;
...
connectAttr "remapHsv1.oc" ":internal_standInShader.ic";
// End of test.ma
