...
//Name: test.ma
//Last modified: Wed, Feb 29, 2012 01:04:35 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.798112782989111 8.100807298106405 14.010413414521599 ;
	setAttr ".r" -type "double3" -28.538352729602373 44.600000000000009 -2.2334538879380644e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 21.144978120320665;
...
createNode aiStandIn -n "ArnoldStandInShape" -p "ArnoldStandIn";
	...
	setAttr ".min" -type "float3" -10 -10 -10 ;
	setAttr ".max" -type "float3" 10 10 10 ;
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 6.3031027928792644 12.31289426580245 16.924616628982402 ;
...
connectAttr "aiHair1.out" "aiStandard2SG.ss";
connectAttr "ArnoldStandInShape.iog" "aiStandard2SG.dsm" -na;
connectAttr "aiStandard2SG.msg" "materialInfo2.sg";
connectAttr "aiHair1.msg" "materialInfo2.m";
connectAttr "aiHair1.msg" "materialInfo2.t" -na;
