...
//Name: test.ma
//Last modified: Mon, Jul 10, 2017 09:48:27 PM
//Codeset: 1252
requires maya "2017ff05";
requires -nodeType "aiOptions" -nodeType "aiAOVDriver" -nodeType "aiAOVFilter" -nodeType "aiSkyDomeLight"
		 -nodeType "aiSky" -nodeType "aiStandard" -nodeType "aiStandardSurface" "mtoa" "2.0.2.wip";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BA492E34-4A5C-202D-A53F-E98BC164E7D5";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "FF181387-4947-3964-F4C4-F19DAD7374BE";
createNode displayLayer -n "defaultLayer";
	rename -uid "D4FDFFFE-4283-3C44-E5D2-21930D7E93D5";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "53736CA3-4A4C-025A-1B23-A5BA2D8A174C";
...
createNode file -n "file1";
	...
	setAttr ".ag" 0;
	setAttr ".ao" 1;
	setAttr ".ftn" -type "string" "D:/arnold/mtoa/testsuite/test_0015/data/grid_opacity.tif";
	setAttr ".exp" 1;
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6DA2D719-4B64-C4D7-3342-628B0A4BCD54";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "23290870-4D37-04C7-681B-E0B912E634AF";
