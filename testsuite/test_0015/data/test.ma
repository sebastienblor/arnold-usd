...
//Name: test.ma
//Last modified: Fri, Dec 28, 2018 10:32:14 AM
//Codeset: 1252
requires maya "2018ff09";
requires -nodeType "aiOptions" -nodeType "aiAOVDriver" -nodeType "aiAOVFilter" -nodeType "aiSkyDomeLight"
		 -nodeType "aiSky" -nodeType "aiStandard" -nodeType "aiStandardSurface" "mtoa" "3.1.3.wip";
...
createNode aiSky -n "aiSkyShape" -p "aiSky";
	...
	setAttr ".csh" no;
	setAttr ".rcsh" no;
	setAttr ".hwta" 0.41007193922996521;
	setAttr ".ai_vidr" no;
	setAttr ".ai_visr" no;
	setAttr ".ai_vidt" no;
	setAttr ".ai_vist" no;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5880BB21-4201-42D1-0D21-739102C87459";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "66311014-4FD9-F296-D960-EDBCC20709BD";
createNode displayLayer -n "defaultLayer";
	rename -uid "D4FDFFFE-4283-3C44-E5D2-21930D7E93D5";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1414C4A9-43DB-7B6B-9B93-7FA777763000";
...
createNode file -n "file1";
	...
	setAttr ".ag" 0;
	setAttr ".ao" 1;
	setAttr ".ftn" -type "string" "grid_opacity.tif";
	setAttr ".exp" 1;
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "87B6BD83-4CFE-E226-B07B-E0A44C9A5FB9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "11300ED4-49C9-3FC6-13E1-F78B4306CF4B";
...
connectAttr "transform1_scaleConstraint1.w0" "transform1_scaleConstraint1.tg[0].tw"
		;
connectAttr "file1.oc" "aiSkyShape.sc";
