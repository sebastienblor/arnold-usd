...
//Name: sky_rotate.ma
//Last modified: Wed, Jun 08, 2011 04:38:29 PM
//Codeset: 1252
requires maya "2011";
requires "mtoa" "0.7.0";
...
createNode transform -shared -name "persp";
	...
	setAttr ".translate" -type "double3" -3.337860107421875e-006 0 40 ;
createNode camera -shared -name "perspShape" -parent "persp";
	...
	setAttr ".tumblePivot" -type "double3" -3.337860107421875e-006 0 -2.86102294921875e-006 ;
...
createNode aiSkyDomeLight -name "aiSkyDomeLight1" -parent "transform1";
	...
	setAttr ".hwtexalpha" 0.47482013702392578;
	setAttr ".intensity" 0.5;
	setAttr -keyable on ".aiSamples" 4;
createNode orientConstraint -name "transform1_orientConstraint1" -parent "transform1";
	addAttr -cachedInternally true -keyable true -shortName "w0" -longName "aiSkyW0" 
	...
	setAttr ".lastTargetRotate" -type "double3" 126.83034137558157 61.647299176252808 
		142.62570879268659 ;
	setAttr ".restRotate" -type "double3" 126.83034137558157 61.647299176252808 142.62570879268659 ;
	setAttr -keyable on ".aiSkyW0";
createNode scaleConstraint -name "transform1_scaleConstraint1" -parent "transform1";
	addAttr -cachedInternally true -keyable true -shortName "w0" -longName "aiSkyW0" 
		-defaultValue 1 -minValue 0 -attributeType "double";
	setAttr -keyable on ".nodeState";
	setAttr -keyable off ".visibility";
...
createNode aiSky -name "aiSkyShape" -parent "aiSky";
	...
	setAttr ".hwtexalpha" 0.41007193922996521;
	setAttr ".intensity" 0.5;
...
createNode aiStandard -name "aiStandard1";
	...
	setAttr ".specularRoughness" 0.001;
...
connectAttr "transform1_orientConstraint1.constraintRotateX" "transform1.rotateX"
		;
connectAttr "transform1_orientConstraint1.constraintRotateY" "transform1.rotateY"
		;
connectAttr "transform1_orientConstraint1.constraintRotateZ" "transform1.rotateZ"
		;
connectAttr "transform1_scaleConstraint1.constraintScaleX" "transform1.scaleX";
connectAttr "transform1_scaleConstraint1.constraintScaleY" "transform1.scaleY";
connectAttr "transform1_scaleConstraint1.constraintScaleZ" "transform1.scaleZ";
connectAttr "file1.outColor" "aiSkyDomeLight1.color";
connectAttr "transform1.rotateOrder" "transform1_orientConstraint1.constraintRotateOrder"
		;
connectAttr "transform1.parentInverseMatrix" "transform1_orientConstraint1.constraintParentInverseMatrix"
		;
connectAttr "aiSky.rotate" "transform1_orientConstraint1.target[0].targetRotate"
		;
connectAttr "aiSky.rotateOrder" "transform1_orientConstraint1.target[0].targetRotateOrder"
		;
connectAttr "aiSky.parentMatrix" "transform1_orientConstraint1.target[0].targetParentMatrix"
		;
connectAttr "transform1_orientConstraint1.aiSkyW0" "transform1_orientConstraint1.target[0].targetWeight"
		;
connectAttr "transform1.parentInverseMatrix" "transform1_scaleConstraint1.constraintParentInverseMatrix"
		;
connectAttr "aiSky.scale" "transform1_scaleConstraint1.target[0].targetScale";
connectAttr "aiSky.parentMatrix" "transform1_scaleConstraint1.target[0].targetParentMatrix"
		;
connectAttr "transform1_scaleConstraint1.aiSkyW0" "transform1_scaleConstraint1.target[0].targetWeight"
		;
connectAttr "file1.outColor" "aiSkyShape.color";
...
connectAttr "aiStandard1.outColor" "aiStandard3SG.surfaceShader";
connectAttr "pSphereShape1.instObjGroups" "aiStandard3SG.dagSetMembers" -nextAvailable
		;
...
connectAttr "aiSkyDomeLight1.lightData" ":lightList1.lights" -nextAvailable;
connectAttr "place2dTexture1.message" ":defaultRenderUtilityList1.utilities" -nextAvailable
		;
connectAttr "transform1.instObjGroups" ":defaultLightSet.dagSetMembers" -nextAvailable
		;
// End of sky_rotate.ma
