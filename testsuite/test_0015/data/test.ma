...
//Name: test.ma
//Last modified: Tue, Jan 04, 2022 11:07:44 PM
//Codeset: 1252
requires maya "2022";
requires "stereoCamera" "10.0";
requires -nodeType "aiOptions" -nodeType "aiAOVDriver" -nodeType "aiAOVFilter" -nodeType "aiSkyDomeLight"
		 -nodeType "aiStandard" -nodeType "aiStandardSurface" -nodeType "aiSky" "mtoa" "5.1.0";
requires "stereoCamera" "10.0";
currentUnit -l centimeter -a degree -t film;
fileInfo "application" "maya";
fileInfo "product" "Maya 2022";
fileInfo "version" "2022";
fileInfo "cutIdentifier" "202110201415-591e95f1ca";
fileInfo "osv" "Windows 10 Enterprise v2009 (Build: 19044)";
fileInfo "UUID" "611F23AA-426C-4DF9-CCDC-75AEE6911123";
createNode transform -s -n "persp";
	rename -uid "B66B037C-4ED9-215E-EF35-49B5F24ACF0D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.337860107421875e-06 0 40 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "9272029A-4914-C908-AC3E-40BEC27AFDCE";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	...
	setAttr ".ovr" 1.3;
	setAttr ".fl" 10.001;
	setAttr ".coi" 38.782854214948081;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -3.337860107421875e-06 0 -2.86102294921875e-06 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
	setAttr ".dr" yes;
	setAttr ".ai_translator" -type "string" "perspective";
createNode transform -s -n "top";
	rename -uid "6BFADCCB-4767-06E5-855D-4FAE1A388D36";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 100.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "21B6735C-4393-3989-C040-388C9F72A991";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -s -n "front";
	rename -uid "20519CC8-4D28-6022-241A-C29DDFFAECE2";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 100.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "32AE6313-4F8D-3EDA-9166-2F8E56141D93";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -s -n "side";
	rename -uid "0A60F731-4EF9-5CD5-0FF0-7DA8A9C2AFF1";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "4FF717DC-4F6E-B6A2-7FA7-B99EDE71362C";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -n "transform1";
	rename -uid "B37DD32E-4DC1-80AF-D531-A6861887F76B";
createNode aiSkyDomeLight -n "aiSkyDomeLight1" -p "transform1";
	rename -uid "F1CFE9CA-4F77-E7DF-B9A7-C9B1B421D90F";
	...
	setAttr ".csh" no;
	setAttr ".rcsh" no;
	setAttr ".hwta" 0.47482013702392578;
	setAttr ".camera" 0;
	setAttr -k on ".ai_samples" 4;
	setAttr ".aal" -type "attributeAlias" {"exposure","aiExposure"} ;
createNode orientConstraint -n "transform1_orientConstraint1" -p "transform1";
	rename -uid "7ADCFA38-4522-335D-1B7C-48B24B7F597A";
	addAttr -ci true -k true -sn "w0" -ln "aiSkyW0" -dv 1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	setAttr -k off ".ty";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" 126.83034137558157 61.647299176252808 142.62570879268659 ;
	setAttr ".rsrr" -type "double3" 126.83034137558157 61.647299176252808 142.62570879268659 ;
	setAttr -k on ".w0";
createNode scaleConstraint -n "transform1_scaleConstraint1" -p "transform1";
	rename -uid "049B3CE6-4E91-A9FF-5351-11B12C578AB2";
	addAttr -ci true -k true -sn "w0" -ln "aiSkyW0" -dv 1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	...
	setAttr ".erp" yes;
	setAttr -k on ".w0";
createNode transform -n "groupSky";
	rename -uid "96640AD0-40A6-8CF4-8609-39B895E58F0C";
	setAttr ".r" -type "double3" 10 40 59.999999999999993 ;
createNode transform -n "aiSky" -p "groupSky";
	rename -uid "485CE5FA-4E81-68C5-6529-14AEB5C4408E";
	setAttr ".r" -type "double3" 59.999999999999993 45 29.999999999999996 ;
	setAttr ".s" -type "double3" 1.5 1 1 ;
createNode transform -n "pSphere1";
	rename -uid "3C392F4F-4498-099A-022F-3EB9A92724CC";
	setAttr ".s" -type "double3" 2.3746635020218343 2.3746635020218343 2.3746635020218343 ;
createNode mesh -n "pSphereShape1" -p "pSphere1";
	rename -uid "2B76146D-4900-17A6-DC95-73B5A9A875AE";
...
createNode aiSky -n "aiSkyShape";
	rename -uid "514F47F9-4573-A800-BB05-43923A3ACA83";
	setAttr ".visibility" 129;
	setAttr ".format" 2;
	setAttr ".X_angle" -126.83000183105469;
	setAttr ".Y_angle" 61.639999389648438;
	setAttr ".Z_angle" -142.6199951171875;
	setAttr ".X" -type "float3" 0.66600001 0 0 ;
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "28A3CB80-4476-172D-84E3-D4A287998ADA";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6182E755-45DD-DF5C-6F86-07BDCB5034AB";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "59494788-4EFB-F26E-61E6-ED8AC00C5AD0";
createNode displayLayer -n "defaultLayer";
	rename -uid "D4FDFFFE-4283-3C44-E5D2-21930D7E93D5";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "70FC0CA8-4F6E-B9CB-2F16-66BCA05C847C";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "28E24596-4407-2FCD-127F-7482D7AC160E";
	setAttr ".g" yes;
createNode polySphere -n "polySphere1";
	rename -uid "7F8C5A79-4C2D-9D8D-AB7B-83BE27708DAE";
	setAttr ".r" 11;
	setAttr ".sa" 50;
	setAttr ".sh" 50;
createNode shadingEngine -n "aiStandard1SG";
	rename -uid "07AA68D9-4D16-0656-0F8C-68952BBCD824";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "EDB32650-4879-64DC-C6CB-DAAEEDA1A16C";
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "B1F2F758-4A61-6D1D-996D-77ACAEEE220F";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 48 ";
	setAttr ".st" 6;
createNode file -n "file1";
	rename -uid "E9258543-4C0A-92E8-D5B9-BBA09EE8D881";
	setAttr ".ag" 0;
	setAttr ".ao" 1;
	setAttr ".ftn" -type "string" "C:/arnold/mtoa2/testsuite/test_0015/data/grid_opacity.tif";
	setAttr ".exp" 1;
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "D060AE6E-4204-86FC-D325-9582BBC965BB";
createNode shadingEngine -n "aiStandard2SG";
	rename -uid "4C380084-439E-F568-7E06-4D924E0E5DA4";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "3EECB625-4FB7-91C3-CA8B-B8A734D76F01";
createNode aiStandard -n "aiStandard1";
	rename -uid "61C65868-4374-5700-1049-D682EC1E6602";
	setAttr ".Kd" 0;
	setAttr ".Ks" 1;
	setAttr ".specular_roughness" 0.0010000000474974513;
createNode shadingEngine -n "aiStandard3SG";
	rename -uid "383BA638-46DA-3166-ACED-CCA9E90B7180";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "B2262B4A-455A-F24A-7D27-F08FF74E7AF4";
createNode script -n "uiConfigurationScriptNode";
	rename -uid "5E0CFED6-413A-0BC3-46FB-B5A72341BF40";
...
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "E9A06438-4A44-EAB1-AFF6-38B21123D8CD";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "72BFE5B6-4F20-0710-9C69-B48998D24E0C";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "479018A6-4961-D84D-E9BD-16BB033B7C07";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6DE9B7AB-4A08-3678-74C9-40894D17D731";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "4EDCF7B7-450B-93C9-5C3C-E38D2C33B163";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode aiStandardSurface -n "aiStandardSurface1";
	rename -uid "1687D49E-49B3-396B-A841-65968FC3EDEC";
	setAttr ".base" 0;
	setAttr ".specular" 0;
...
createNode shadingEngine -n "aiStandardSurface1SG";
	rename -uid "0C1522B8-4D36-1463-5C83-0A836E55F688";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo4";
	rename -uid "6342C355-424F-950D-481F-EF83ACC89D51";
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "01E69669-48DC-B5AC-572D-BEA449744156";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -160.13070252453355 -135.36413524111904 ;
	setAttr ".tgi[0].vh" -type "double2" 416.33984259192505 302.17084603774799 ;
...
connectAttr "aiSky.r" "transform1_orientConstraint1.tg[0].tr";
connectAttr "aiSky.ro" "transform1_orientConstraint1.tg[0].tro";
connectAttr "aiSky.pm" "transform1_orientConstraint1.tg[0].tpm";
...
connectAttr "aiSky.s" "transform1_scaleConstraint1.tg[0].ts";
connectAttr "aiSky.pm" "transform1_scaleConstraint1.tg[0].tpm";
connectAttr "transform1_scaleConstraint1.w0" "transform1_scaleConstraint1.tg[0].tw"
		;
connectAttr "polySphere1.out" "pSphereShape1.i";
connectAttr "file1.oc" "aiSkyShape.color";
...
connectAttr "aiStandard1.out" "aiStandard3SG.ss";
...
connectAttr "file1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "aiSkyShape.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
