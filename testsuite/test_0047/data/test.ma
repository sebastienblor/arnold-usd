...
//Name: test.ma
//Last modified: Thu, Apr 09, 2020 05:13:55 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "E074027A-46C1-8264-1E18-05AFB712BEC5";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2581642A-4228-FCDA-9FB5-31AAE2ACFD57";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "B2FA216C-4C3C-5921-2D09-6984060D5CFB";
createNode displayLayer -n "defaultLayer";
	rename -uid "10E86ADF-4980-40EF-BCFA-E7A444253B78";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "21EE56D8-49DF-A2C4-BD65-5A8C6A36D567";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "589B335C-428B-C751-9474-35AE1B3B223D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5FE2FA41-48BA-0D0C-B71F-79BF8327CFCD";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
