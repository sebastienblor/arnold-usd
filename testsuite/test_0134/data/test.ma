...
//Name: test.ma
//Last modified: Tue, Nov 12, 2013 03:31:11 PM
//Codeset: UTF-8
requires maya "2012";
...
fileInfo "osv" "Linux 2.6.32-358.23.2.el6.centos.plus.x86_64 #1 SMP Thu Oct 17 00:31:29 UTC 2013 x86_64";
...
createNode transform -n "nurbsCircle1";
	setAttr ".t" -type "double3" -0.29304070632451995 -0.068702421231109867 -2.5614917601152181 ;
	setAttr ".r" -type "double3" 21.821126689540641 0 0 ;
	setAttr ".s" -type "double3" 1.4118436261995457 1.4118436261995457 1.4118436261995457 ;
...
createNode makeNurbCircle -n "makeNurbCircle1";
	...
	setAttr ".r" 1.5266282345602367;
createNode ramp -n "ramp2";
	setAttr -s 2 ".cel";
	setAttr ".cel[0].ep" 0;
	setAttr ".cel[0].ec" -type "float3" 0 0 0 ;
	setAttr ".cel[2].ep" 1;
	setAttr ".cel[2].ec" -type "float3" 0.30000001 0.30000001 0.30000001 ;
createNode place2dTexture -n "place2dTexture2";
createNode aiHair -n "aiHair1";
	setAttr ".rootcolor" -type "float3" 1 1 1 ;
...
connectAttr "ramp2.oa" "nurbsCircleShape1.cwdth";
connectAttr "aiHair1.out" "nurbsCircleShape1.ai_curve_shader";
...
connectAttr "aiStandard2SG.msg" "materialInfo12.sg";
