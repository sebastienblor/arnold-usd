...
//Name: test.ma
//Last modified: Tue, May 31, 2011 11:51:22 AM
//Codeset: 1252
requires maya "2011";
requires "mtoa" "0.7.0";
...
createNode transform -name "pointLight1";
	setAttr ".translate" -type "double3" 0 10 0 ;
createNode pointLight -name "pointLightShape1" -parent "pointLight1";
	...
	addAttr -cachedInternally true -keyable true -shortName "sss_samples" -longName "sssSamples" 
		-defaultValue -1 -minValue 0 -maxValue 100 -attributeType "long";
	addAttr -cachedInternally true -keyable true -shortName "affect_volumetrics" -longName "affectVolumetrics" 
		-defaultValue 1 -minValue 0 -maxValue 1 -attributeType "bool";
	addAttr -cachedInternally true -keyable true -shortName "cast_volumetric_shadows" 
		-longName "castVolumetricShadows" -defaultValue 1 -minValue 0 -maxValue 1 -attributeType "bool";
	setAttr -keyable off ".visibility";
...
createNode layeredShader -name "layeredShader1";
	setAttr -size 2 ".inputs";
	setAttr ".inputs[0].transparency" -type "float3" 0.79343861 0.79343861 0.79343861 ;
	setAttr ".inputs[0].glowColor" -type "float3" 0 0 0 ;
	setAttr ".inputs[1].color" -type "float3" 0.2 0.69999999 0.30000001 ;
	setAttr ".inputs[1].transparency" -type "float3" 0.2 0.2 0.2 ;
	setAttr ".inputs[1].glowColor" -type "float3" 0 0 0 ;
...
connectAttr "checker1.outColor" "layeredShader1.inputs[0].color";
connectAttr "layeredShader1.outColor" "layeredShader1SG.surfaceShader";
connectAttr "pPlaneShape1.instObjGroups" "layeredShader1SG.dagSetMembers" -nextAvailable
		;
connectAttr "layeredShader1SG.message" "materialInfo1.shadingGroup";
connectAttr "layeredShader1.message" "materialInfo1.material";
connectAttr "layeredShader1.message" "materialInfo1.texture" -nextAvailable;
...
connectAttr "layeredShader1.message" ":defaultShaderList1.shaders" -nextAvailable
		;
