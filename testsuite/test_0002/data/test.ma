...
//Name: test.ma
//Last modified: Wed, Feb 29, 2012 12:30:25 PM
//Codeset: 1252
requires maya "2011";
...
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	...
	addAttr -ci true -k true -sn "sss_samples" -ln "sssSamples" -dv -1 -min 0 -max 100 
		-at "long";
	addAttr -ci true -k true -sn "affect_volumetrics" -ln "affectVolumetrics" -dv 1 
		-min 0 -max 1 -at "bool";
	addAttr -ci true -k true -sn "cast_volumetric_shadows" -ln "castVolumetricShadows" 
		-dv 1 -min 0 -max 1 -at "bool";
	setAttr -k off ".v";
	setAttr ".us" no;
...
createNode layeredShader -n "layeredShader1";
	setAttr -s 2 ".cs";
	setAttr ".cs[0].t" -type "float3" 0.79343861 0.79343861 0.79343861 ;
...
connectAttr "checker1.oc" "layeredShader1.cs[0].c";
connectAttr "layeredShader1.oc" "layeredShader1SG.ss";
connectAttr "pPlaneShape1.iog" "layeredShader1SG.dsm" -na;
