...
//Name: test.ma
//Last modified: Mon, Jul 10, 2017 06:28:18 PM
//Codeset: UTF-8
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DC290D4A-7F42-2C7B-E082-C8BDCC4DF85C";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "606421C2-A244-B4F9-2FFE-A5ABBB0FC6EE";
createNode displayLayer -n "defaultLayer";
	rename -uid "50DD17A2-7B40-0DEC-DF99-B98DA851C3FA";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "9231A6EA-184D-86DB-B4B7-27A89B233664";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C3224189-2A41-A57F-3395-948F6E4B6118";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "05A4B67A-C243-54A2-7536-FA8CBB8CBD91";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "checker1.oc" "aiSkyShape.sc";
