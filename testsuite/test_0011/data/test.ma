...
//Name: test.ma
//Last modified: Tue, Jan 04, 2022 09:56:36 PM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "457168FE-447A-82E8-335A-5DA130B6CAD0";
createNode transform -s -n "persp";
	rename -uid "D6ACEBA0-5343-B0BD-D334-FFB7361E1103";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.337860107421875e-06 0 40 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "2F6B55CC-4F40-1952-2B0A-4E94B2802269";
	...
	setAttr ".dr" yes;
	setAttr ".ai_horizontal_fov" 360;
	setAttr ".ai_vertical_fov" 75;
	setAttr ".ai_translator" -type "string" "cylindrical";
createNode transform -s -n "top";
	rename -uid "231BBF6C-9545-B1B8-3926-BA8097A20B37";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 100.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "4800678B-8F46-1C23-C46D-B99AF89A50FF";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -s -n "front";
	rename -uid "1C44466C-1847-6BC8-D1BD-DD9E96D61E42";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 100.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "A9F4366F-4744-9FA0-7A25-59A9F7A25BD8";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -s -n "side";
	rename -uid "3D203197-6642-2809-53BD-AABEB2C19DB3";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "E8208878-1248-BA7E-B15A-D99B72924F4C";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -n "aiSky";
	rename -uid "A1D822DA-8C40-390C-0D27-86B48BB3E837";
createNode aiSky -n "aiSkyShape";
	rename -uid "A03D8B67-2040-FEDB-F4FC-1198EF2A04F4";
	setAttr ".format" 2;
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "28941ABB-5947-0DE6-169C-A98D6CA9118E";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5DADEB1E-4809-D8DE-8AD4-C6BB2389D42C";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "480D4690-4700-C5FE-6824-40990087F80E";
createNode displayLayer -n "defaultLayer";
	rename -uid "50DD17A2-7B40-0DEC-DF99-B98DA851C3FA";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F8C48511-493C-4008-B93E-2CACAFA1A915";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "47C63284-014E-10BB-12F7-6FA532B96131";
	setAttr ".g" yes;
createNode shadingEngine -n "aiStandard1SG";
	rename -uid "9B8D36C8-484A-8452-ED5D-1F9D5A8BABAF";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "B02DCA05-B948-3A76-9540-26811C6D5703";
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "9B648902-0A4B-FCC7-685E-478E28ACECE2";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 48 ";
	setAttr ".st" 6;
createNode shadingEngine -n "aiStandard2SG";
	rename -uid "EAF6A92D-D34B-52DE-8222-419BB68458E3";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "BC2AB3C1-3549-F9D2-4759-BEB3DB71D372";
createNode shadingEngine -n "aiStandard3SG";
	rename -uid "1F1543E9-E648-AE4B-E02F-F781B931E5B1";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "CB187C57-374C-0C4E-70FE-8EB70DEEC06A";
createNode checker -n "checker1";
	rename -uid "105FE95D-8C4E-E6B4-FEA0-FF82837A8B58";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "D5B7107D-C746-A6A0-6B9E-DB9BCBBB66E8";
	setAttr ".re" -type "float2" 4 4 ;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "3D5F0C92-B543-34F5-086D-9496E722C3F3";
...
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "57B23F4C-814E-3C80-AE2B-0E9C5824F4EE";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "FD25A316-5244-C94A-7DAD-BFACA7380783";
	addAttr -ci true -sn "dither_amplitude" -ln "ditherAmplitude" -dv 1 -at "float";
	setAttr ".ai_translator" -type "string" "tif";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "8D113316-4B49-A490-14C6-7C9C351B35E1";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F1248F80-4842-17CF-AD11-0081BAFC1DD3";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B3473445-422E-0103-CBA4-7F91310AFC0F";
createNode checker -n "checker2";
	rename -uid "18B809E6-466F-FAF9-BB88-018DD955F39D";
createNode place2dTexture -n "place2dTexture2";
	rename -uid "1BD242A0-4462-4723-5327-96BAA86F7450";
	setAttr ".re" -type "float2" 4 4 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "checker2.oc" "aiSkyShape.color";
