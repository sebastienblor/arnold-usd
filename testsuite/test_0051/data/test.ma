...
//Name: test.ma
//Last modified: Fri, Feb 17, 2017 02:13:56 PM
//Codeset: 1252
requires maya "2017";
requires -nodeType "aiOptions" -nodeType "aiAOVDriver" -nodeType "aiAOVFilter" -nodeType "aiSkyDomeLight"
		 -nodeType "aiAreaLight" -nodeType "aiLightDecay" "mtoa" "2.0.0.0";
...
createNode transform -s -n "persp";
	rename -uid "C84AB136-46B9-16BE-FB1A-48A13DDF5FCE";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.220155450079801 4.972563642131 0.039217757618153201 ;
	setAttr ".r" -type "double3" -18.338352729596039 89.399999999997775 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "6F659FB5-4EF4-5F52-74CD-7D9B4A0A80CF";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 11.781346124016716;
...
createNode transform -s -n "top";
	rename -uid "7AABD30B-4298-35DA-2DB0-9F8D1C751D6C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "EBBA3DD3-4400-4FEE-CA45-4FB8BA8A6D6F";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "7DD406B8-435B-763E-4AA5-D5B007CA8C0C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "FB032E6C-44F6-6680-F606-7D9D5C37B8EC";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "34E1CE47-4AC9-52DE-98CD-F7A8CDD75FA9";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "F569C539-425A-1BE9-DD2B-9FAAE2671C40";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -n "pointLight1";
	rename -uid "0C432002-494E-412E-11E5-40BFFD1BB992";
	setAttr ".t" -type "double3" 0 6.2945017026765964 3.4485805657840869 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	rename -uid "D5C560B1-4D1F-1DDE-CCF7-958B3F299121";
	...
	setAttr ".rdl" 1;
	setAttr ".us" no;
	setAttr -k on ".ai_decay_type";
createNode transform -n "pCube1";
	rename -uid "3E47C28A-4C82-B4CD-D249-D386FAC56622";
	setAttr ".t" -type "double3" 0 2 4 ;
	setAttr ".s" -type "double3" 2.1164442943626969 2.1164442943626969 2.1164442943626969 ;
createNode mesh -n "pCubeShape1" -p "pCube1";
	rename -uid "24F64FED-4C64-8BAF-E379-ECA0901BD732";
...
createNode transform -n "pCube2";
	rename -uid "FC75184C-4BF5-944C-2542-27BD7B27F7D4";
	setAttr ".t" -type "double3" 0 2 0 ;
	setAttr ".s" -type "double3" 2.1164442943626969 2.1164442943626969 2.1164442943626969 ;
createNode mesh -n "pCubeShape2" -p "pCube2";
	rename -uid "480828F2-4BB6-A69E-CB2E-CE822C38FB4D";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	addAttr -ci true -sn "ai_sss_sample_spacing" -ln "aiSssSampleSpacing" -dv 0.10000000149011612 
...
createNode transform -n "pCube3";
	rename -uid "AD406981-4A8A-FB90-82AA-83B20AC7D509";
	setAttr ".t" -type "double3" 0 2 -4 ;
	setAttr ".s" -type "double3" 2.1164442943626969 2.1164442943626969 2.1164442943626969 ;
createNode mesh -n "pCubeShape3" -p "pCube3";
	rename -uid "5A712DBC-4EC2-3138-CCAF-36AAAE7C1248";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	addAttr -ci true -sn "ai_sss_sample_spacing" -ln "aiSssSampleSpacing" -dv 0.10000000149011612 
...
createNode transform -n "pPlane1";
	rename -uid "EFBA5C8F-4262-5398-BF2B-019A8DD97BD9";
	setAttr ".s" -type "double3" 100 100 100 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "9F104990-455E-6292-C885-30A2F50A060E";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	addAttr -ci true -sn "ai_sss_sample_spacing" -ln "aiSssSampleSpacing" -dv 0.10000000149011612 
...
createNode transform -n "transform1";
	rename -uid "C1957900-4312-A0DE-940A-218D10D97F81";
	setAttr ".t" -type "double3" 0 6.185134645509982 0 ;
	setAttr ".r" -type "double3" -92.466832608443326 0 16.296122634951072 ;
createNode aiAreaLight -n "aiAreaLight" -p "transform1";
	rename -uid "DB6A2E25-47F9-540E-7D87-1E92BCE992A9";
	...
	setAttr ".intensity" 64;
	setAttr ".ai_translator" -type "string" "quad";
	setAttr ".aal" -type "attributeAlias" {"exposure","aiExposure"} ;
createNode transform -n "transform2";
	rename -uid "CBF0BDD2-4DD7-4599-79A2-93B003D1AC2D";
createNode aiSkyDomeLight -n "aiSkyDomeLight" -p "transform2";
	rename -uid "18018863-4754-A4B7-0547-5684F6368320";
	addAttr -ci true -h true -sn "aal" -ln "attributeAliasList" -dt "attributeAlias";
	addAttr -ci true -sn "ai_bounce_factor" -ln "aiBounceFactor" -dv 1 -at "float";
	addAttr -ci true -sn "ai_bounces" -ln "aiBounces" -dv 999 -at "long";
	setAttr -k off ".v";
...
createNode expression -n "expression1";
	rename -uid "30AE82C6-477A-6E17-185A-8EBA009B2215";
	setAttr -k on ".nds";
	setAttr ".ixp" -type "string" ".O[0]=.I[0]*2;";
	setAttr ".ani" 0;
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "B27BA543-4FDC-37FF-4E03-9E87D779A3D9";
	...
	setAttr -k on ".driver_exr_compression" 0;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2956E1E1-4C72-7115-B1F4-D1A02EE6D86C";
	setAttr -s 8 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "A5694BD6-4A4E-59E4-4DCE-C9A32C4AAC13";
createNode displayLayer -n "defaultLayer";
	rename -uid "AEA97DE1-450B-2E6D-82F3-36BC08D067B0";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "129F6A9E-47A6-FF46-1BF2-669EF8F1B45D";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "AE22596B-4E89-3CA2-F92D-86BD3E64455C";
	setAttr ".g" yes;
createNode aiLightDecay -n "defaultLightDecay";
	rename -uid "2919916E-412E-EB74-4793-0D92BA5B6DBD";
createNode polyCube -n "polyCube1";
	rename -uid "ED5B0B1E-4FF5-6389-A34F-48BA8FC3C2FE";
	setAttr ".cuv" 4;
createNode polyPlane -n "polyPlane1";
	rename -uid "14A93B70-4B46-BE3F-50C3-27A4A3A3970F";
	setAttr ".cuv" 2;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "A8B9ECB1-4A67-13B8-7DEF-538F84624133";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "4B286CD2-4562-7425-5223-E9977FB299F8";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 48 ";
	setAttr ".st" 6;
createNode ramp -n "ramp1";
	rename -uid "19B19E08-497E-C9D6-9C37-D3A6449BFB19";
	setAttr -s 3 ".cel";
	setAttr ".cel[0].ep" 0.44999998807907104;
	setAttr ".cel[0].ec" -type "float3" 0.185 0.13418667 0.032560002 ;
	setAttr ".cel[1].ep" 0.5;
	setAttr ".cel[1].ec" -type "float3" 0.75300002 0.75300002 1 ;
	setAttr ".cel[2].ep" 1;
	setAttr ".cel[2].ec" -type "float3" 0 0 1 ;
createNode place2dTexture -n "place2dTexture1";
	rename -uid "64892DCC-46A2-6016-DF7B-1B9B06FDED47";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "554EE7C1-450B-184A-57FA-64A041117142";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "2C4F178E-4B00-2275-3961-51B5C8F5AB35";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "74567F4E-4FAC-B276-D8A3-27A274CBA456";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "79534DA5-4AE0-4D13-2A8C-6D93B375153F";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "B09440A3-43EF-F221-0DBF-F19056CDE61C";
...
connectAttr "defaultLightDecay.msg" "aiAreaLight.ai_filters[0]";
connectAttr "ramp1.oc" "aiSkyDomeLight.sc";
...
relationship "link" ":lightLinker1" "pPlaneShape1.message" "pointLightShape1.message";
relationship "link" ":lightLinker1" "pCubeShape2.message" "aiAreaLight.message";
relationship "link" ":lightLinker1" "pCubeShape3.message" "aiSkyDomeLight.message";
relationship "link" ":lightLinker1" "pPlaneShape1.message" "aiSkyDomeLight.message";
relationship "link" ":lightLinker1" "pPlaneShape1.message" "aiAreaLight.message";
...
connectAttr "aiSkyDomeLight.ltd" ":lightList1.l" -na;
