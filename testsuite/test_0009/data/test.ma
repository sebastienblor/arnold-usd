...
fileInfo "UUID" "A4EE730F-469E-444F-05B1-D9B713F26D09";
createNode transform -s -n "persp";
	rename -uid "D5398601-4E62-F39D-AB08-46897CD8FADC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.337860107421875e-06 0 40 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "AF2C7D9F-468D-E237-BF27-40957537FF22";
...
createNode transform -s -n "top";
	rename -uid "15EC7A15-42B8-D0E2-93F0-8586F7062938";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 100.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "A182BB53-4D7D-1D84-2261-7EAD01E47B21";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -s -n "front";
	rename -uid "9225659B-4490-D173-F8BE-A9B51DBF07F8";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 100.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "1EBDB394-46F5-C4FB-621A-2C8714ABCD37";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -s -n "side";
	rename -uid "03FE1AA1-48CE-4B97-17DC-DB96F5C967F5";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "A9736509-4948-67AD-9956-0CA86167619F";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -n "pSphere1";
	rename -uid "CE5E68C0-4F38-55E9-77F8-1EA84100B3C8";
createNode mesh -n "pSphereShape1" -p "pSphere1";
	rename -uid "1E5D9940-4CC9-93EF-78A8-B390AFED03C5";
...
createNode transform -n "aiSky";
	rename -uid "1E71CA02-47D8-DBAE-776F-7F9D49BE500C";
createNode aiSky -n "aiSkyShape";
	rename -uid "19A14EFC-4749-8539-C824-5CAE92B06BBD";
	setAttr ".format" 2;
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "84AE12C0-4F2A-8901-4832-E8BE55BEC237";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B7E23B7E-4625-37B7-3E61-9A917CE5236F";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "44B5CBBA-494C-6BAE-07A2-2392945645DE";
createNode displayLayer -n "defaultLayer";
	rename -uid "82075170-4644-06ED-779D-9E8480062C69";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "7C3D5A5C-4049-CF7E-4CDC-1ABBD6368F94";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "46C066DC-4609-CC3C-D31F-9AA710017235";
	setAttr ".g" yes;
createNode polySphere -n "polySphere1";
	rename -uid "DBDA0E89-4A0E-D6EE-6E99-31AB76766DA7";
	setAttr ".r" 11;
	setAttr ".sa" 50;
	setAttr ".sh" 50;
createNode shadingEngine -n "aiStandard1SG";
	rename -uid "C4252A2C-49F0-160C-2924-B7BE35885DFA";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "88B0FE67-4722-C1F1-DC2B-CF89498DC5C5";
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "E000F0B5-4EAF-9DF0-9045-A5AF659E0031";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 48 ";
	setAttr ".st" 6;
createNode shadingEngine -n "aiStandard2SG";
	rename -uid "8EA36B06-49F9-0755-3506-AC95D3817BDA";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "6F4221E3-4E82-AFB9-2F4C-F39E7AD53A19";
createNode aiStandard -n "aiStandard1";
	rename -uid "08C097C8-4A0E-40A5-692F-66884CB417BA";
	setAttr ".Kd" 0;
	setAttr ".Kr" 1;
createNode shadingEngine -n "aiStandard3SG";
	rename -uid "CE22DD04-43D3-5C09-CAC4-12B3864BC90C";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "F5697DCB-4505-38C8-A33A-788752B8EEEB";
createNode checker -n "checker1";
	rename -uid "AC78B605-42E5-D91F-6493-00965808FCAB";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "1F954CA9-4B4E-A2EC-096F-7E99B80525E4";
	setAttr ".re" -type "float2" 4 4 ;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "F978C70F-43A8-B3BF-B273-CF90FDF523F0";
...
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "9B9D1319-438D-6ED4-8312-97BF07F14447";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "20B1679D-4029-2682-9607-BEAAC0D47401";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "89AABCD3-4C09-D745-0668-8CB179923BEC";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "968F827A-4E49-7F53-F126-63AE60502721";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "8906C166-4E5A-B5BA-AE38-C5A1A681A18E";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode checker -n "checker2";
	rename -uid "418332B4-4825-00A6-EB3C-B7B76F23DD20";
createNode place2dTexture -n "place2dTexture2";
	rename -uid "A22E46C7-4380-0E87-5305-A5AFBB511649";
	setAttr ".re" -type "float2" 4 4 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
