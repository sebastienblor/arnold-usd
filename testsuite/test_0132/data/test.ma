...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 0 0 -0.99984957638857264 ;
...
createNode mesh -n "pPlaneShape3" -p "pPlane3";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 4 ".vt[0:3]"  -0.5 -1.110223e-16 0.5 0.5 -1.110223e-16 0.5 -0.5 1.110223e-16 -0.5
...
createNode aiStandard -n "aiStandard2";
	setAttr ".specular_roughness" 0.0099999997764825821;
...
connectAttr "ramp1.oc" "aiAreaLightShape1.sc";
connectAttr "polyPlane2.out" "pPlaneShape2.i";
connectAttr "ramp1.oc" "pPlaneShape2.sc";
connectAttr "ramp1.oc" "pPlaneShape3.sc";
...
connectAttr "aiStandard2.msg" "materialInfo12.m";
connectAttr "aiStandard2.msg" "materialInfo12.t" -na;
