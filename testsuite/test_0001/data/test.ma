...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 38.830849793308516 29.12313734498116 38.830849793308516 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 62.159688867911854;
...
createNode layeredTexture -n "layeredTexture1";
	...
	setAttr ".cs[6].bm" 1;
	setAttr ".cs[6].iv" yes;
	setAttr ".cs[7].c" -type "float3" 1 0 0 ;
	setAttr ".cs[7].a" 1;
	setAttr ".cs[7].bm" 0;
	setAttr ".cs[7].iv" yes;
...
connectAttr "checker1.oc" "layeredTexture1.cs[6].c";
connectAttr "checker1.oa" "layeredTexture1.cs[6].a";
