...
//Name: test.ma
//Last modified: Tue, May 31, 2011 04:59:33 PM
//Codeset: 1252
requires maya "2011";
requires "mtoa" "0.7.0";
...
createNode layeredTexture -name "layeredTexture1";
	...
	setAttr ".inputs[0].blendMode" 1;
	setAttr ".inputs[0].isVisible" yes;
	setAttr ".inputs[1].color" -type "float3" 0.20020001 0.69999999 0.30016002 ;
	setAttr ".inputs[1].alpha" 1;
	setAttr ".inputs[1].blendMode" 0;
	setAttr ".inputs[1].isVisible" yes;
...
connectAttr "file1.outAlpha" "layeredTexture1.inputs[0].alpha";
connectAttr "file1.outColor" "layeredTexture1.inputs[0].color";
