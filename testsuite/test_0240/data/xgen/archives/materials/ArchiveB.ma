...
//Name: ArchiveB.ma
//Last modified: Wed, Oct 25, 2017 09:52:57 PM
//Codeset: 1252
...
createNode transform -n "aiStandardSurface2SG_materialRef";
	rename -uid "08C45FFC-4F35-90DA-C25E-8DAEB4BB84A6";
createNode mesh -n "aiStandardSurface2SG_materialRefShape" -p "aiStandardSurface2SG_materialRef";
	rename -uid "875389B6-4676-64F3-B221-2694293F2E33";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode shadingEngine -n "aiStandardSurface2SG";
	rename -uid "B9380FF2-4349-888C-874B-909F383F1420";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "A2EFE6A3-422C-56BF-F04F-DAA9CE56FE92";
createNode aiStandardSurface -n "aiStandardSurface2";
	rename -uid "68371AE9-4C4D-76DD-5103-29B88B3FACED";
	setAttr ".base_color" -type "float3" 0 0 1 ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F3E4CCF6-4637-6916-7233-3488DF04CA6F";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
select -ne :time1;
	setAttr ".o" 1;
...
connectAttr "pPipeShape1.iog" "aiStandardSurface2SG.dsm" -na;
