...
//Name: test.ma
//Last modified: Wed, Feb 29, 2012 01:23:45 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -n "pPlane3";
	setAttr ".t" -type "double3" -17.367924022405859 2.8421709430404007e-014 2.9993704283807521 ;
	setAttr ".s" -type "double3" 2.0716000854897341 2.0716000854897341 2.0716000854897341 ;
createNode mesh -n "pPlaneShape3" -p "pPlane3";
	...
	setAttr -s 4 ".pt[0:3]" -type "float3"  -7.1054274e-015 0 -30 -30 
		0 7.1054274e-015 30 0 -7.1054274e-015 7.1054274e-015 0 30;
	setAttr -s 4 ".vt[0:3]"  -15 -3.3306691e-015 15 15 -3.3306691e-015 
...
createNode transform -n "persp1";
	setAttr ".t" -type "double3" -16.965054730798531 96.148804431379148 3.1959753453529021 ;
	setAttr ".r" -type "double3" -90 0 6.4608559495538169e-015 ;
