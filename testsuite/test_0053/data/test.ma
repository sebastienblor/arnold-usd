...
//Name: test.ma
//Last modified: Thu, Oct 18, 2012 02:52:11 PM
//Codeset: UTF-8
requires maya "2011";
...
fileInfo "osv" "Linux 3.5.4-2.fc17.x86_64 #1 SMP Wed Sep 26 21:58:50 UTC 2012 x86_64";
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -18.458398751121567 93.360449040982687 5.2531092019197017 ;
	setAttr ".r" -type "double3" -89.138352729603312 -0.19999999999997853 -1.2424117416441818e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 86.183004913426856;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -17.726293670327614 1000 1.8935806022906734 ;
...
createNode transform -n "persp1";
	setAttr ".t" -type "double3" 6.4787973741998242 7.3290600110013715 5.5398394562399291 ;
	setAttr ".r" -type "double3" -45.000000000001556 49.99999999999995 -4.9480647005852158e-15 ;
createNode camera -n "perspShape2" -p "persp1";
	...
	setAttr ".coi" 9.5176012833629926;
...
createNode aiStandIn -n "ArnoldStandInShape" -p "ArnoldStandIn";
	...
	setAttr ".dso" -type "string" "./LightLinkOverride.ass";
	setAttr ".deferStandinLoad" no;
	setAttr -k on ".oll" no;
createNode transform -n "ArnoldStandIn1";
	setAttr ".t" -type "double3" -2 0 2 ;
createNode aiStandIn -n "ArnoldStandIn1Shape" -p "ArnoldStandIn1";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr ".dso" -type "string" "./LightLinkNoOverride.ass";
	setAttr ".deferStandinLoad" no;
	setAttr -k on ".oll" no;
createNode transform -n "directionalLight3";
	setAttr ".r" -type "double3" -115.17817392508687 9.2616873218558258 32.71215282113878 ;
...
createNode aiStandIn -n "ArnoldStandIn2Shape" -p "ArnoldStandIn2";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr ".dso" -type "string" "./NoLightLinkOverride.ass";
	setAttr ".deferStandinLoad" no;
	setAttr -k on ".oll" no;
createNode transform -n "ArnoldStandIn3";
	setAttr ".t" -type "double3" 2 0 2 ;
createNode aiStandIn -n "ArnoldStandIn3Shape" -p "ArnoldStandIn3";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr ".dso" -type "string" "./NoLightLinkNoOverride.ass";
	setAttr ".deferStandinLoad" no;
	setAttr -k on ".oll" no;
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 0 -0.46593166633284866 0 ;
	setAttr ".s" -type "double3" 35.129723432923214 35.129723432923214 35.129723432923214 ;
...
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	...
	setAttr ".sgamma" 1;
	setAttr ".tgamma" 1;
	setAttr ".ai_user_options" -type "string" "enable_procedural_cache off";
...
createNode ramp -n "ramp3";
	setAttr ".t" 2;
	setAttr -s 5 ".cel";
	setAttr ".cel[0].ep" 0.67500001192092896;
	setAttr ".cel[0].ec" -type "float3" 1 0.37300223 0 ;
	setAttr ".cel[1].ep" 0.094999998807907104;
	setAttr ".cel[1].ec" -type "float3" 0 0.49224091 1 ;
	setAttr ".cel[2].ep" 1;
	setAttr ".cel[2].ec" -type "float3" 0 0 1 ;
	setAttr ".cel[3].ep" 0.32499998807907104;
	setAttr ".cel[3].ec" -type "float3" 0.34177199 0.65822798 0 ;
	setAttr ".cel[4].ep" 0.51499998569488525;
	setAttr ".cel[4].ec" -type "float3" 1 0 0 ;
	setAttr ".uw" 0.21951219439506531;
	setAttr ".vw" 0.26829269528388977;
...
connectAttr "ArnoldStandInShape.iog" ":ArnoldStandInDefaultLightSet.dsm" -na;
connectAttr "ArnoldStandIn1Shape.iog" ":ArnoldStandInDefaultLightSet.dsm" -na;
connectAttr "ArnoldStandIn2Shape.iog" ":ArnoldStandInDefaultLightSet.dsm" -na;
connectAttr "ArnoldStandIn3Shape.iog" ":ArnoldStandInDefaultLightSet.dsm" -na;
