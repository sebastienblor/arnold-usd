...
//Name: test.ma
//Last modified: Mon, Nov 28, 2011 04:07:34 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -n "pSphere1";
	setAttr ".t" -type "double3" -0.48848639743892264 0 0.8565351064842055 ;
createNode mesh -n "pSphereShape1" -p "pSphere1";
	...
	setAttr -k on ".ai_subdiv_iterations" 3;
...
connectAttr "checker1.oc" "envSphere1.so";
connectAttr "envSphere1SG.msg" "materialInfo3.sg";
connectAttr "envSphere1.oc" "surfaceShader2.oc";
