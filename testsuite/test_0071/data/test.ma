...
//Name: test.ma
//Last modified: Fri, Mar 23, 2012 07:24:01 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.35463743940297932 19.089110470387553 0.83607159828359556 ;
	setAttr ".r" -type "double3" -87.338352729575305 -0.19999999999967194 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 18.394044818136383;
