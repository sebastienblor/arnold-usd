...
//Name: test.ma
//Last modified: Thu, Jan 12, 2012 04:02:04 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.4288524161142244 18.347790001760867 35.100258176148664 ;
	setAttr ".r" -type "double3" -27.938352729602681 -1.399999999999769 2.4855503070594132e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 39.726964792115993;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.4083295608872799 6.2920978973830461 1000.1 ;
...
createNode mesh -n "pSphereShape1" -p "pSphere1";
	...
	addAttr -ci true -sn "self_shadows" -ln "self_shadows" -dv 1 -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "opaque" -ln "opaque" -dv 1 -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "diffuse_visibility" -ln "diffuse_visibility" -dv 1 -min 0 
		-max 1 -at "bool";
	addAttr -ci true -sn "glossy_visibility" -ln "glossy_visibility" -dv 1 -min 0 -max 
		1 -at "bool";
	addAttr -ci true -sn "subdiv_type" -ln "subdiv_type" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "subdiv_iterations" -ln "subdiv_iterations" -dv 1 -min 0 -max 
		100 -at "long";
	addAttr -ci true -sn "subdiv_adaptive_metric" -ln "subdiv_adaptive_metric" -at "long";
	addAttr -ci true -sn "subdiv_pixel_error" -ln "subdiv_pixel_error" -min 0 -max 50 
		-at "float";
	addAttr -ci true -sn "subdiv_dicing_camera" -ln "subdiv_dicing_camera" -dt "string";
	addAttr -ci true -sn "subdiv_uv_smoothing" -ln "subdiv_uv_smoothing" -at "long";
	addAttr -ci true -sn "sss_use_gi" -ln "sss_use_gi" -dv 1 -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "sss_max_samples" -ln "sss_max_samples" -dv 100000 -min 0 -max 
		1000000000 -at "long";
	addAttr -ci true -sn "sss_sample_spacing" -ln "sss_sample_spacing" -dv 0.1 -min 
		0 -max 10 -at "float";
	addAttr -ci true -sn "export_tangents" -ln "export_tangents" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "export_colors" -ln "export_colors" -min 0 -max 1 -at "bool";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "transform1";
	setAttr ".t" -type "double3" 13.181185309949182 9.5625550114428233 12.227286581842323 ;
	setAttr ".r" -type "double3" -35.857810735752722 51.562840528206323 -2.5581311053783442e-015 ;
	setAttr ".s" -type "double3" 2.7658318759614322 8.7668503860207529 2.7658318759614322 ;
createNode aiAreaLight -n "aiAreaLight" -p "transform1";
	...
	addAttr -ci true -k true -sn "ai_samples" -ln "aiSamples" -dv 1 -min 0 -max 100 
		-at "long";
	addAttr -ci true -k true -dv 1 -at "long";
	addAttr -ci true -k true -sn "ai_normalize" -ln "aiNormalize" -dv 1 -min 0 -max 
		1 -at "bool";
	addAttr -ci true -k true -sn "ai_bounce_factor" -ln "aiBounceFactor" -dv 1 -at "float";
	addAttr -ci true -k true -sn "ai_bounces" -ln "aiBounces" -dv 999 -at "long";
	addAttr -ci true -k true -m -sn "ai_filters" -ln "aiFilters" -at "message";
	addAttr -ci true -k true -sn "ai_decay_type" -ln "aiDecayType" -dv 1 -min 0 -max 
		1 -en "constant:quadratic" -at "enum";
	...
	addAttr -ci true -k true -sn "ai_resolution" -ln "aiResolution" -dv 512 -at "long";
	addAttr -ci true -k true -sn "ai_translator" -ln "aiTranslator" -dt "string";
	addAttr -ci true -k true -sn "ai_mis" -ln "aiMis" -dv 1 -min 0 -max 1 -at "bool";
	setAttr -k off ".v";
	setAttr ".intensity" 2;
	setAttr -k on ".ai_exposure" 3;
	setAttr -k on ".ai_decay_type" 0;
	setAttr -k on ".ai_translator" -type "string" "cylinder";
createNode transform -n "persp1";
	setAttr ".t" -type "double3" 0.30042401628311666 70.539902822523317 86.064791427536917 ;
	setAttr ".r" -type "double3" -39.338352729602875 0.20000000000003759 -2.112099960795109e-016 ;
createNode camera -n "perspShape2" -p "persp1";
	...
	setAttr ".coi" 111.27945213859545;
...
createNode aiStandard -n "aiStandard1";
	...
	setAttr ".diffuse_roughness" 0.20325203239917755;
