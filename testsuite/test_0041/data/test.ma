...
//Name: test.ma
//Last modified: Tue, Oct 09, 2012 01:11:55 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.1084824741669352 5.6627183628397164 16.783890085309171 ;
	setAttr ".r" -type "double3" -17.738352729603591 3.4000000000000901 2.9870276966145674e-016 ;
...
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" 0 0 12.073598951688094 ;
	setAttr ".r" -type "double3" -33.384023790972606 7.1915915828266863 -4.7159914076884588 ;
...
createNode particle -n "particleShape1" -p "particle1";
	...
	addAttr -ci true -k true -sn "ai_render_points_as" -ln "aiRenderPointsAs" -dv 21111 
	...
	setAttr ".pos0" -type "vectorArray" 2 -6.0515803073507586 0 -0.021124086060201108 6.0141864844834831
		 0 0.1049520120334364 ;
	...
	setAttr -k on ".ai_export_particle_ids" yes;
	setAttr ".lifespanPP0" -type "doubleArray" 2 3.4028234663852886e+038 3.4028234663852886e+038 ;
	setAttr -k on ".lifespan" 1;
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0.069051668262255506 0.1666981000661254 0.70255419973025557 ;
...
createNode polyCube -n "polyCube1";
	setAttr ".w" 3.0380112547920963;
	setAttr ".h" 3.3183345060505123;
	setAttr ".d" 3.1372283291671508;
	setAttr ".cuv" 4;
createNode aiStandard -n "aiStandard1";
	setAttr ".Kd" 1;
	setAttr ".Ks" 1;
	setAttr ".specular_roughness" 0.0081300809979438782;
	setAttr ".Ksn" 1;
...
createNode aiUserDataInt -n "aiUserDataInt1";
	setAttr ".intAttrName" -type "string" "particleId";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "pCube1.m" "cube1.inh[0]";
...
connectAttr "aiUserDataInt1.out" "aiStandard1.specular_Fresnel";
...
connectAttr "aiUserDataInt1.msg" ":defaultShaderList1.s" -na;
