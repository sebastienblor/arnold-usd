...
//Name: test.ma
//Last modified: Wed, Jun 13, 2012 11:56:07 AM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.8239109281615447 6.7384306446971474 0.61000658671139185 ;
	setAttr ".r" -type "double3" -84.338352729575391 -0.59999999999968634 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 5.9862866673814921;
...
createNode transform -n "pSphere1";
	setAttr ".t" -type "double3" -12.731485295088987 0 0 ;
	setAttr ".s" -type "double3" 1.0883143791397554 1.0883143791397554 1.0883143791397554 ;
...
createNode pointEmitter -n "emitter1";
	setAttr ".t" -type "double3" -8.1111427335861315 0 0 ;
	setAttr ".emt" 0;
	setAttr ".rat" 2;
	setAttr ".sro" no;
	setAttr -l on ".urpp";
...
createNode particle -n "particleShape1" -p "particle1";
	...
	addAttr -ci true -k true -sn "ai_render_points_as" -ln "aiRenderPointsAs" -dv -3809 
	...
	setAttr -k on ".lifespan" 0.95;
createNode instancer -n "inst1";
...
connectAttr "particleShape1.idt[0].ipd" "inst1.inp";
connectAttr "pSphere1.m" "inst1.inh[0]";
