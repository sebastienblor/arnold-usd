...
//Name: test.ma
//Last modified: Thu, Jun 29, 2017 11:25:27 PM
//Codeset: 1252
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "50F62C23-4CC6-A88F-3472-4DA92CCB70F8";
	setAttr -s 11 ".lnk";
	setAttr -s 11 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "F9F59660-42E3-C9B8-2259-7DBA5154CD0A";
createNode displayLayer -n "defaultLayer";
	rename -uid "3B6F9797-4A6A-5B9E-B7C5-8ABB16872CEF";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "75B3D7D7-4D00-9730-354E-448221A40B44";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C72135C8-4DF8-4649-D8DE-A0B1AF6ED057";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "AF3A823F-4AFD-0E49-4188-51A3005A6E47";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
