...
//Name: test.ma
//Last modified: Tue, Jun 14, 2011 05:04:56 PM
//Codeset: 1252
requires maya "2011";
requires "mtoa" "0.7.0";
...
createNode multiplyDivide -name "multiplyDivide1";
	setAttr ".input2" -type "float3" 0.5 0.2 0.1 ;
...
connectAttr "multiplyDivide1.output" "surfaceShader2.outColor";
...
connectAttr "checker1.outColor" "multiplyDivide1.input1";
...
connectAttr "place2dTexture2.message" ":defaultRenderUtilityList1.utilities" -nextAvailable
		;
connectAttr "multiplyDivide1.message" ":defaultRenderUtilityList1.utilities" -nextAvailable
		;
// End of test.ma
