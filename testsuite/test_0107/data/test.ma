...
//Name: test.ma
//Last modified: Fri, Feb 17, 2017 09:14:57 PM
//Codeset: 1252
requires maya "2017";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BDDE5A50-496E-A31B-4235-7789F12B6FE9";
	setAttr -s 14 ".lnk";
	setAttr -s 14 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "0693F07C-439B-2DA1-443E-60B0D1180684";
createNode displayLayer -n "defaultLayer";
	rename -uid "08A19D11-4C4C-DF23-EFD0-FFBBB9B9AB33";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "48A72F2B-4212-C803-E7A0-29AF5E0EF333";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "09C28F24-4DA1-134D-117E-6AB052DB90D9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "105990EB-4D1E-348D-3089-9E8C7FA51802";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
