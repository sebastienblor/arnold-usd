...
//Name: test.ma
//Last modified: Tue, Jul 18, 2017 03:30:16 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	rename -uid "04067510-4A5A-AF57-8A1A-10AE4FDD3A9A";
	setAttr ".v" no;
...
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "F4A1A905-415A-0F9D-2092-DDA8EE8485DF";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
...
createNode transform -s -n "top";
	rename -uid "D09FFC6F-44C1-9310-DC7A-FB988B7C0982";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "14A7EFDC-48D7-5D98-0116-96A840CEFDE4";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "F2E9B605-4EF8-4381-ABB9-B2B82D6BC0AC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "FD267F6C-4916-DD00-1CCF-E6AD7CC9C08D";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "BDF117C9-42BB-6DF9-672F-6ABB34518C19";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "95DBF41F-47A2-8472-43F8-4ABFD2C6CD1F";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode pointEmitter -n "emitter1";
	rename -uid "5195F9A9-4AED-2396-F1F7-F9BF73A9F3A3";
	setAttr ".sro" no;
	setAttr -l on ".urpp";
	setAttr ".spd" 5;
createNode transform -n "particle1";
	rename -uid "77C6637F-47DC-B0B9-3E56-76BD3FFEA9EF";
createNode particle -n "particleShape1" -p "particle1";
	rename -uid "F51B6EF2-43BA-E148-845E-E38D8EA66524";
	...
	addAttr -s false -ci true -sn "randIndex" -ln "randIndex" -dt "doubleArray";
	setAttr -k off ".v";
...
createNode transform -n "directionalLight1";
	rename -uid "D8D89E1E-4112-7A53-8DBB-CBA754C3E22F";
...
createNode directionalLight -n "directionalLightShape1" -p "directionalLight1";
	rename -uid "A285EF86-40FE-3F95-5112-FDAE3AC39623";
...
createNode transform -n "pSphere1";
	rename -uid "C527545A-44DD-CA36-D2D6-EBAC6941F06C";
	setAttr ".v" no;
...
createNode mesh -n "pSphereShape1" -p "pSphere1";
	rename -uid "B64A4DA6-431C-4D19-A5B6-92AF862422D4";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	addAttr -ci true -sn "ai_sss_sample_spacing" -ln "aiSssSampleSpacing" -dv 0.10000000149011612 
...
createNode transform -n "pCube1" -p "group1";
	rename -uid "B91308ED-4C4D-4B74-6337-1E871B3EA999";
	setAttr ".t" -type "double3" -0.64180109447066647 0.25754645453249347 0.32268916701187322 ;
createNode mesh -n "pCubeShape1" -p "pCube1";
	rename -uid "71A99022-4310-1780-D667-4DADA2EE3601";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	addAttr -ci true -sn "ai_sss_sample_spacing" -ln "aiSssSampleSpacing" -dv 0.10000000149011612 
...
createNode instancer -n "cube1";
	rename -uid "0AA9B5D0-4535-F09D-BC8A-B1BBFEC90815";
	setAttr -s 2 ".inh";
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "26534879-4DFA-B57E-8939-A78298554FA0";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "114D9707-40F8-3FDC-A16A-0BB79FDC7C3F";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "456C2349-4210-261C-E8D8-449FC97C63F3";
createNode displayLayer -n "defaultLayer";
	rename -uid "0ABFA89E-4F4A-E728-4334-91A61BE073AE";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CB4CEE08-4187-A657-C998-8EA23248C917";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "B04AE14E-4F1C-935E-A2DA-4E86DCAA49A7";
	setAttr ".g" yes;
createNode aiStandard -n "ArnoldStandardShader1";
	rename -uid "8C5FE01B-4ACC-A63A-F5A1-A9B0B81E8264";
...
createNode shadingEngine -n "ArnoldStandardShader1SG";
	rename -uid "CF047E6C-4C3C-F6C0-D6B7-B2B3F3579442";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "18DC9E1A-4DF0-3B4B-45C9-65B3EB051E5A";
createNode shadingEngine -n "ArnoldStandardShader1SG1";
	rename -uid "2E730CCC-4B4A-F1AF-8B19-E39D62F7E5EB";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "30CC2D40-4A10-0FB0-8CDB-26B24B2C32EC";
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "4B44470B-4450-C4D0-1ACF-9BAABC0E9E1A";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 100 -ast 1 -aet 100 ";
	setAttr ".st" 6;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "7D366A48-4A85-2DBB-E367-EABDDBFCE1AE";
...
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "EE16249B-4F78-B530-0D99-E48888D0E675";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "6AA8578A-41C3-C60B-8D6A-7FA61BEA261F";
...
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "CB9BD58D-4E19-E31F-032D-EDB1E2C3500F";
	addAttr -ci true -sn "gamma" -ln "gamma" -dv 2.2000000476837158 -min 9.9999997473787516e-005 
		-smx 5 -at "float";
	addAttr -ci true -sn "dither_amplitude" -ln "ditherAmplitude" -dv 1 -at "float";
	addAttr -ci true -sn "host_name" -ln "hostName" -dt "string";
...
createNode dynGlobals -n "dynGlobals1";
	rename -uid "8A378148-46AA-6235-1A09-5DB470EE1886";
	setAttr ".upd" yes;
	setAttr ".cd" -type "string" "test";
	setAttr -l on ".mnf" 1;
	setAttr -l on ".mxf" 100;
createNode polySphere -n "polySphere1";
	rename -uid "138ABBA4-4998-9C50-3BB3-FA9A687ED70F";
	setAttr ".r" 0.12964140278882041;
createNode polyCube -n "polyCube1";
	rename -uid "21DC9D60-49E6-8550-A1A4-36BC74060BDD";
	setAttr ".w" 0.5168806452551209;
	setAttr ".h" 0.51509290906498695;
	setAttr ".d" 0.58021709392073006;
	setAttr ".cuv" 4;
createNode polyCone -n "polyCone1";
	rename -uid "532304CB-45E9-F161-3C17-449C814E5BD0";
	setAttr ".r" 0.26544175148942223;
	setAttr ".h" 0.82257100902397151;
	setAttr ".cuv" 3;
createNode aiStandard -n "aiStandard1";
	rename -uid "BCD83340-4C91-D80D-B438-04BADFF8CBC7";
	setAttr ".Kd_color" -type "float3" 1 0 0 ;
createNode shadingEngine -n "aiStandard1SG";
	rename -uid "9E989592-4D3A-2FB4-B358-1CAD1601287A";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "69137F74-4731-3787-DF4E-9EBF944DB0DE";
createNode aiStandard -n "aiStandard2";
	rename -uid "0A1889A0-433D-7037-52F3-FDB61864717D";
	setAttr ".Kd_color" -type "float3" 1 1 0 ;
createNode shadingEngine -n "aiStandard2SG";
	rename -uid "34289672-4BAD-71B2-A93B-62A82A7C056A";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo4";
	rename -uid "0513B751-4252-3121-31EC-08B884F5B687";
createNode aiStandard -n "aiStandard3";
	rename -uid "5CC207D5-4FAF-611C-230F-F4BF17F4EAAF";
	setAttr ".Kd_color" -type "float3" 0 1 1 ;
createNode shadingEngine -n "aiStandard3SG";
	rename -uid "0BC6C0DA-4250-71F0-1F8F-2B91B85F6923";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo5";
	rename -uid "11215E83-4BBE-F05B-49E9-25B235C51309";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1B527745-4DD6-791C-9720-4883C3EB51A6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F63054E7-4259-3826-33BA-4FAD27DB247D";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
