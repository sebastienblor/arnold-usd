...
//Name: test.ma
//Last modified: Wed, Apr 03, 2019 08:02:26 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.3824931659364892 2.2591494550409781 4.3072037261065059 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D47AC945-474D-B7A4-088C-E7872C2B04A3";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "EE18DE32-48DD-FC4C-E9AF-C69A11CA8C07";
createNode displayLayer -n "defaultLayer";
	rename -uid "ABC9F258-4792-0A2B-EBF5-99A0F113F75A";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0F15D87B-41D6-5D69-D11F-DDB269B066BA";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "2FA83DA3-447F-7ABC-D383-2394FC03AFE5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "68545A63-4CD8-C69C-01C2-7F9977F51771";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "B05A53F2-4464-1927-8061-989087ED897E";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode aiNoise -n "aiNoise1";
	rename -uid "A3534F38-492C-6256-EAE2-DAB089F72844";
	setAttr ".octaves" 3;
	setAttr ".scale" -type "float3" 4 4 4 ;
createNode aiStandardSurface -n "aiStandard2";
	rename -uid "91A8E1C9-4B59-4138-FA43-82BAA2A70C4A";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "CBE7244F-4333-3C8E-B244-EC801DD27431";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -116.26473980993634 -577.65943532460074 ;
	setAttr ".tgi[0].vh" -type "double2" 712.30665583702319 319.32611225651135 ;
...
connectAttr "bump2d1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "aiStandard2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
