...
//Name: test.ma
//Last modified: Tue, Mar 19, 2019 02:49:08 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.81397674616560389 -0.40933319355013409 5.7414896340575599 ;
	setAttr ".r" -type "double3" -7.5383527295998247 -12.600000000000113 -1.018450934260859e-16 ;
...
createNode transform -n "pSphere1";
	...
	setAttr ".t" -type "double3" -0.88313328307147299 0 0 ;
createNode mesh -n "pSphereShape1" -p "pSphere1";
	...
	setAttr -k on ".ai_subdiv_iterations";
	setAttr ".ai_disp_height" 0.10000000149011612;
	setAttr ".ai_disp_padding" 0.10000000149011612;
	setAttr ".ai_disp_zero_value" 0.5;
	setAttr ".ai_disp_autobump" yes;
	setAttr ".ai_autobump_visibility" 65;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode transform -n "pSphere2";
	rename -uid "432596B8-469A-0228-AE6B-5CB4FA84DC98";
	setAttr ".t" -type "double3" 1.2855969213042617 0 -0.015930282827991471 ;
createNode mesh -n "pSphereShape2" -p "pSphere2";
	...
	setAttr ".ai_disp_height" 0.10000000149011612;
	setAttr ".ai_disp_autobump" yes;
	setAttr ".ai_autobump_visibility" 9;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode transform -n "pPlane1";
	rename -uid "4F9199D6-44A5-04AD-3472-D497B8E80E5D";
	setAttr ".t" -type "double3" 0 3.5 2.9259403764607921 ;
	setAttr ".r" -type "double3" 77.794578270313053 -7.5288517120335863 0.87215355688144991 ;
	setAttr ".s" -type "double3" 8.093741177722185 8.093741177722185 8.093741177722185 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "2DD650CE-4107-B282-D428-BF99B7FF9E59";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pPlane2";
	rename -uid "B5C1F9CC-47C0-69C9-FA0C-70AC10AFA746";
	setAttr ".t" -type "double3" 0 -1.1170766096375722 0 ;
	setAttr ".s" -type "double3" 11.817485683918465 11.817485683918465 11.817485683918465 ;
createNode mesh -n "pPlaneShape2" -p "pPlane2";
	rename -uid "1B18D648-4F7A-4D1D-D1DB-AA88CFAF0DE8";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "directionalLight1";
	rename -uid "2AB510B4-421B-4618-180A-D7928E749372";
	setAttr ".r" -type "double3" -18.92894385371623 0 0 ;
createNode directionalLight -n "directionalLightShape1" -p "directionalLight1";
	rename -uid "AD994851-4F20-4F76-4BD1-4C97DFBA5B3F";
	setAttr -k off ".v";
	setAttr ".in" 3;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4788FDB3-400E-F3C0-02F4-0B9496139EFD";
	setAttr -s 10 ".lnk";
	setAttr -s 10 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "825D01C3-46BB-A86A-8675-2A8EF789FAFF";
createNode displayLayer -n "defaultLayer";
	rename -uid "ABC9F258-4792-0A2B-EBF5-99A0F113F75A";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "7E43135C-429B-0F38-0069-8F910BFE31C8";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "193FE4E5-43D2-26DA-914A-608234EA2922";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3DCFA1C0-42BE-E4DB-B8A5-EF8E6FC5C06A";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "B05A53F2-4464-1927-8061-989087ED897E";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode aiNoise -n "aiNoise1";
	rename -uid "B43CDAB0-4C6D-4F15-7A46-92B77569BFA3";
	setAttr ".octaves" 3;
	setAttr ".scale" -type "float3" 4 4 4 ;
createNode aiStandardSurface -n "aiStandard4";
	rename -uid "399770E7-4FAC-9520-34DB-149AE2787B9C";
...
createNode aiStandardSurface -n "aiStandard2";
	rename -uid "0E0DD5AD-4F14-54E2-7163-B6B3E6B0A5F2";
...
createNode polyPlane -n "polyPlane1";
	rename -uid "0A8EF28C-4F45-3F60-C533-F29FAFB50C37";
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode polyPlane -n "polyPlane2";
	rename -uid "7EF12963-43D3-956A-3BE1-7E82D382DDAA";
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode aiStandardSurface -n "aiStandardSurface1";
	rename -uid "6D47618B-4D3E-3895-1725-259851A776C5";
	setAttr ".base" 0;
	setAttr ".specular_roughness" 0;
	setAttr ".specular_IOR" 0.88815790414810181;
createNode shadingEngine -n "aiStandardSurface1SG";
	rename -uid "36781F8D-45A5-C91A-E90F-B497AF860A72";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo7";
	rename -uid "41E3B666-422F-AAAF-8FEB-2ABC56678940";
createNode aiStandardSurface -n "aiStandardSurface2";
	rename -uid "1BB7F1E2-4975-F594-EFA6-5C99A272AC8C";
	setAttr ".base" 0;
	setAttr ".specular" 0;
	setAttr ".specular_IOR" 1;
	setAttr ".transmission" 1;
createNode shadingEngine -n "aiStandardSurface2SG";
	rename -uid "247C9745-4715-9414-F659-F0A018518BE2";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo8";
	rename -uid "D6C9FCF4-479D-DC40-C104-43AB1D598C45";
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "588CE6A6-4402-E382-6293-8AB541A75035";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -225.4558988226141 -508.73689504070677 ;
	setAttr ".tgi[0].vh" -type "double2" 853.53566755114321 659.34571809785609 ;
	setAttr -s 9 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 557.59307861328125;
	setAttr ".tgi[0].ni[0].y" 435.83840942382813;
	setAttr ".tgi[0].ni[0].nvs" 1923;
	setAttr ".tgi[0].ni[1].x" 195.71427917480469;
	setAttr ".tgi[0].ni[1].y" 485.71429443359375;
	setAttr ".tgi[0].ni[1].nvs" 1923;
	setAttr ".tgi[0].ni[2].x" -121.32757568359375;
	setAttr ".tgi[0].ni[2].y" 422.36065673828125;
	...
	setAttr ".tgi[0].ni[5].nvs" 2403;
	setAttr ".tgi[0].ni[6].x" 395.71429443359375;
	setAttr ".tgi[0].ni[6].y" 407.14285278320313;
	...
	setAttr ".tgi[0].ni[8].y" 402.85714721679688;
...
connectAttr "pSphereShape2.iog" "aiStandard2SG.dsm" -na;
...
connectAttr "aiNoise1.outr" "displacementShader2.d";
...
connectAttr "directionalLightShape1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "aiStandardSurface2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
