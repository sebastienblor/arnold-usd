...
//Name: test.ma
//Last modified: Wed, Sep 20, 2017 10:38:05 AM
//Codeset: 1252
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "54192D06-4BAB-A13C-543A-17A0E0D1B27A";
	setAttr -s 17 ".lnk";
	setAttr -s 17 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "804785FE-48A9-95C2-569E-629B465867F7";
createNode displayLayer -n "defaultLayer";
	rename -uid "930D98C6-42A6-ACCA-D203-1FA3CD6DF7B2";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DB1FECC1-4FB2-E745-D00C-34906F00BD3F";
...
createNode objectSet -n "set1";
	...
	setAttr ".ai_matte_color" -type "float3" 0.26299977 1 0.26299977 ;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A8A496D5-4B89-E2A4-608C-6B8A804E6F9C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B5C466A8-40F1-79AD-16F9-D3B3D4FE5F53";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
