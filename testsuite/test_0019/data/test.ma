...
//Name: test.ma
//Last modified: Thu, Jan 12, 2012 01:37:02 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 32.364702040154384 21.773633774227896 31.81567579885289 ;
	setAttr ".r" -type "double3" -27.938352729602407 44.200000000000038 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 50.303220597829224;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 24.793086314131887 19.626588310430417 28.776564590043222 ;
...
createNode transform -n "pointLight2";
	setAttr ".t" -type "double3" 31.066538685512125 19.626588310430417 27.063197844091434 ;
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "C:/solidAngle/mtoa/mtoa-main/testsuite/test_0019/data/ball.tif";
...
connectAttr "expression2.out[0]" "pointLightShape2.de";
connectAttr "pointLightShape1.ai_decay_type" "expression1.in[0]";
connectAttr "pointLightShape1.msg" "expression1.obm";
connectAttr "pointLightShape2.ai_decay_type" "expression2.in[0]";
connectAttr "pointLightShape2.msg" "expression2.obm";
...
connectAttr "file1.oc" "aiStandard3.Kd_color";
connectAttr "aiStandard3.out" "aiStandard3SG.ss";
connectAttr "ArnoldStandInShape.iog" "aiStandard3SG.dsm" -na;
