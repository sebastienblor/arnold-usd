...
//Name: test.ma
//Last modified: Fri, Aug 23, 2019 02:47:30 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".r" -type "double3" -30.938352729602393 38.200000000000159 4.0472441090538709e-15 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A82C9D06-4BF7-5BFD-D199-E7AA2BAF34FC";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E74AEC32-421E-9585-F7E0-618FA08DC16E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D3E13CCC-474C-95DD-4B28-62B73B3370F4";
createNode displayLayerManager -n "layerManager";
	rename -uid "C7413808-41F6-C9AA-51D8-43B0123B5C86";
createNode displayLayer -n "defaultLayer";
	rename -uid "03CBB940-0000-6A04-5D38-4F63000003A5";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CB090600-4BFB-CE77-13C0-0EBFCF7F8D67";
...
createNode script -n "uiConfigurationScriptNode";
	rename -uid "14CCA310-4FA7-55F6-85BA-D89A5299BAA6";
