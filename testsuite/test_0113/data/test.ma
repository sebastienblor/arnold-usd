...
//Name: test.ma
//Last modified: Fri, Apr 05, 2013 03:41:26 PM
//Codeset: UTF-8
requires maya "2014";
requires -nodeType "aiStandIn" -nodeType "SphereLocator" -nodeType "aiOptions" -nodeType "aiAOV"
		 -nodeType "aiAOVDriver" -nodeType "aiAOVFilter" -nodeType "aiSkyDomeLight" -nodeType "aiAreaLight"
		 -nodeType "aiLightBlocker" -nodeType "aiSky" -nodeType "aiAmbientOcclusion" -nodeType "aiBarndoor"
		 -nodeType "aiBump2d" -nodeType "aiBump3d" -nodeType "aiFog" -nodeType "aiGobo" -nodeType "aiHair"
		 -nodeType "aiImage" -nodeType "aiLightDecay" -nodeType "aiMotionVector" -nodeType "aiNoise"
		 -nodeType "aiRaySwitch" -nodeType "aiStandard" -nodeType "aiUtility" -nodeType "aiVolumeScattering"
		 -nodeType "aiWireframe" -nodeType "aiMeshLightMaterial" -nodeType "aiShadowCatcher"
		 -nodeType "aiSkinSss" -nodeType "aiUserDataBool" -nodeType "aiUserDataColor" -nodeType "aiUserDataFloat"
		 -nodeType "aiUserDataInt" -nodeType "aiUserDataPnt2" -nodeType "aiUserDataString"
		 -nodeType "aiUserDataVector" -nodeType "aiWriteColor" -nodeType "aiWriteFloat" -nodeType "dWarthog"
		 "mtoa" "0.23.0.dev";
...
fileInfo "cutIdentifier" "201303082103-864851";
fileInfo "osv" "Linux 2.6.32-358.2.1.el6.centos.plus.x86_64 #1 SMP Wed Mar 13 02:09:07 UTC 2013 x86_64";
...
createNode fluidShape -n "fluidShape1" -p "fluid1";
	...
	setAttr -s 2 ".cl";
	setAttr ".cl[0].clp" 0;
	setAttr ".cl[0].clc" -type "float3" 0 1 1 ;
	setAttr ".cl[0].cli" 1;
	setAttr ".cl[1].clp" 0.49565216898918152;
	setAttr ".cl[1].cli" 1;
	setAttr ".coi" 1;
...
connectAttr "aiNoise1.ot" "fluidShape1.cl[1].clc";
