...
//Name: test.ma
//Last modified: Thu, Mar 16, 2017 06:07:36 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	rename -uid "EB0AA25E-419C-AE50-64E3-84BBD0C7BC85";
	setAttr ".v" no;
...
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "B948F1D5-446B-C783-5CB4-D4A7D9CC5A51";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
...
createNode transform -s -n "top";
	rename -uid "B11FD359-4FC8-3826-1E25-E69617524110";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1000000000003 2.2206680938552382e-013 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "74691783-4DD5-5664-5D63-5789C03976FD";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 1000.1;
...
createNode transform -s -n "front";
	rename -uid "759B1C72-4417-E2A5-41C2-84A9C828AE4F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "A08E13AE-4FEF-1CDC-9E7C-91943013264D";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "5A950763-4C8C-4104-560B-44871123D318";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "1C9D3A30-4EE2-8F96-156F-2DBAAF7D280E";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode lookAt -n "Camera_Root";
	rename -uid "634B81CA-4A46-6BE8-2FC3-A586D3EE004B";
...
createNode transform -n "Camera_Interest" -p "Camera_Root";
	rename -uid "28F3D1A8-4829-2CE5-10CC-C197D6527854";
	setAttr ".v" no;
...
createNode locator -n "Camera_InterestShape" -p "Camera_Interest";
	rename -uid "404B49B2-48AC-B16D-42C3-9CB7BC0CFCCA";
	setAttr -k off ".v";
createNode transform -n "pSphere1";
	rename -uid "DF1D17C7-47F2-22D9-C95D-C8A0B66EA448";
	setAttr ".t" -type "double3" -6.3368284475488457 0 -0.13449199753171048 ;
createNode mesh -n "pSphereShape1" -p "pSphere1";
	rename -uid "9290D297-459E-BDF8-1479-7DA6F701C0F7";
...
createNode transform -n "pPlane1";
	rename -uid "4B0D9E59-476B-8F45-DA45-F2B4CCD8F540";
	setAttr ".t" -type "double3" -6.3737659348309972 0 0.065395592907025346 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "67484837-49AC-0D1A-0A75-509A236386B5";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	addAttr -ci true -sn "ai_sss_sample_spacing" -ln "aiSssSampleSpacing" -dv 0.10000000149011612 
...
createNode transform -n "directionalLight1";
	rename -uid "EB06FE67-4F3C-B227-30BF-978C5BABB482";
	setAttr ".r" -type "double3" -26.139057823792907 0 0 ;
createNode directionalLight -n "directionalLightShape1" -p "directionalLight1";
	rename -uid "B63FF17B-4917-C8A9-CDC3-998044EA6C73";
...
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "84D04B83-4E1D-9FBC-B5E4-F9924B9FBA33";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0EDA2CAA-44EF-17B9-0E47-6B93F16543FC";
	setAttr -s 19 ".lnk";
	setAttr -s 19 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "10F7E435-426C-5823-428E-EEA756355AD6";
createNode displayLayer -n "defaultLayer";
	rename -uid "71D84892-4F3C-200D-104E-55A7F74F668A";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1A05899C-45A6-C971-3315-33BF6E1BE4F4";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "42F4DE64-4993-16B9-B8A9-6F9E986DCD53";
	setAttr ".g" yes;
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "A1B68F3C-4967-A654-8AF4-C0B05B000E49";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 50 -ast 1 -aet 50 ";
	setAttr ".st" 6;
createNode shadingEngine -n "ArnoldStandardShader1SG";
	rename -uid "D536AD72-4C6B-6001-EFA2-0FAD9A705CD0";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "D02D5C5D-4123-2A08-E3FC-B09314802BD2";
createNode shadingEngine -n "surfaceShader1SG";
	rename -uid "769D1E65-47C2-2556-0893-5C9465655B41";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "DB7601FC-49C4-0739-E59D-618C1334DC92";
createNode script -n "uiConfigurationScriptNode";
	rename -uid "B8658B0B-4630-8C2A-5F09-1995C7C23827";
	setAttr ".b" -type "string" (
		...
		+ "            -showUnitlessCurves 1\n            -showCompounds 1\n            -showLeafs 1\n            -showNumericAttrsOnly 0\n            -highlightActive 1\n            -autoSelectNewObjects 0\n            -doNotSelectNewObjects 0\n            -dropIsParent 1\n            -transmitFilters 0\n            -setFilter \"0\" \n            -showSetMembers 1\n            -allowMultiSelection 1\n            -alwaysToggleSelect 0\n            -directSelect 0\n            -isSet 0\n            -isSetMember 0\n            -displayMode \"DAG\" \n            -expandObjects 0\n            -setsIgnoreFilters 1\n            -containersIgnoreFilters 0\n            -editAttrName 0\n            -showAttrValues 0\n            -highlightSecondary 0\n            -showUVAttrsOnly 0\n            -showTextureNodesOnly 0\n            -attrAlphaOrder \"default\" \n            -animLayerFilterOptions \"allAffecting\" \n            -sortOrder \"none\" \n            -longNames 0\n            -niceNames 1\n            -showNamespace 1\n            -showPinIcons 0\n            -mapMotionTrails 0\n"
		+ "            -ignoreHiddenAttribute 0\n            -ignoreOutlinerColor 0\n            -renderFilterVisible 0\n            -renderFilterIndex 0\n            -selectionOrder \"chronological\" \n            -expandAttribute 0\n            $editorName;\n\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\n\n\tif ($useSceneConfig) {\n        string $configName = `getPanel -cwl (localizedPanelLabel(\"Current Layout\"))`;\n        if (\"\" != $configName) {\n\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-userCreated false\n\t\t\t\t-defaultImage \"vacantCell.xP:/\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"vertical2\\\" -ps 1 32 100 -ps 2 67 100 $gMainPane;\"\n\t\t\t\t-removeAllPanels\n\t\t\t\t-ap false\n\t\t\t\t\t(localizedPanelLabel(\"Outliner\")) \n\t\t\t\t\t\"outlinerPanel\"\n"
		+ "\t\t\t\t\t\"$panelName = `outlinerPanel -unParent -l (localizedPanelLabel(\\\"Outliner\\\")) -mbv $menusOkayInPanels `;\\n$editorName = $panelName;\\noutlinerEditor -e \\n    -docTag \\\"isolOutln_fromSeln\\\" \\n    -showShapes 1\\n    -showAssignedMaterials 0\\n    -showTimeEditor 1\\n    -showReferenceNodes 0\\n    -showReferenceMembers 0\\n    -showAttributes 0\\n    -showConnected 0\\n    -showAnimCurvesOnly 0\\n    -showMuteInfo 0\\n    -organizeByLayer 1\\n    -showAnimLayerWeight 1\\n    -autoExpandLayers 1\\n    -autoExpand 0\\n    -showDagOnly 1\\n    -showAssets 1\\n    -showContainedOnly 1\\n    -showPublishedAsConnected 0\\n    -showContainerContents 1\\n    -ignoreDagHierarchy 0\\n    -expandConnections 0\\n    -showUpstreamCurves 1\\n    -showUnitlessCurves 1\\n    -showCompounds 1\\n    -showLeafs 1\\n    -showNumericAttrsOnly 0\\n    -highlightActive 1\\n    -autoSelectNewObjects 0\\n    -doNotSelectNewObjects 0\\n    -dropIsParent 1\\n    -transmitFilters 0\\n    -setFilter \\\"defaultSetFilter\\\" \\n    -showSetMembers 1\\n    -allowMultiSelection 1\\n    -alwaysToggleSelect 0\\n    -directSelect 0\\n    -isSet 0\\n    -isSetMember 0\\n    -displayMode \\\"DAG\\\" \\n    -expandObjects 0\\n    -setsIgnoreFilters 1\\n    -containersIgnoreFilters 0\\n    -editAttrName 0\\n    -showAttrValues 0\\n    -highlightSecondary 0\\n    -showUVAttrsOnly 0\\n    -showTextureNodesOnly 0\\n    -attrAlphaOrder \\\"default\\\" \\n    -animLayerFilterOptions \\\"allAffecting\\\" \\n    -sortOrder \\\"none\\\" \\n    -longNames 0\\n    -niceNames 1\\n    -showNamespace 1\\n    -showPinIcons 0\\n    -mapMotionTrails 0\\n    -ignoreHiddenAttribute 0\\n    -ignoreOutlinerColor 0\\n    -renderFilterVisible 0\\n    -renderFilterIndex 0\\n    -selectionOrder \\\"chronological\\\" \\n    -expandAttribute 0\\n    $editorName\"\n"
		+ "\t\t\t\t\t\"outlinerPanel -edit -l (localizedPanelLabel(\\\"Outliner\\\")) -mbv $menusOkayInPanels  $panelName;\\n$editorName = $panelName;\\noutlinerEditor -e \\n    -docTag \\\"isolOutln_fromSeln\\\" \\n    -showShapes 1\\n    -showAssignedMaterials 0\\n    -showTimeEditor 1\\n    -showReferenceNodes 0\\n    -showReferenceMembers 0\\n    -showAttributes 0\\n    -showConnected 0\\n    -showAnimCurvesOnly 0\\n    -showMuteInfo 0\\n    -organizeByLayer 1\\n    -showAnimLayerWeight 1\\n    -autoExpandLayers 1\\n    -autoExpand 0\\n    -showDagOnly 1\\n    -showAssets 1\\n    -showContainedOnly 1\\n    -showPublishedAsConnected 0\\n    -showContainerContents 1\\n    -ignoreDagHierarchy 0\\n    -expandConnections 0\\n    -showUpstreamCurves 1\\n    -showUnitlessCurves 1\\n    -showCompounds 1\\n    -showLeafs 1\\n    -showNumericAttrsOnly 0\\n    -highlightActive 1\\n    -autoSelectNewObjects 0\\n    -doNotSelectNewObjects 0\\n    -dropIsParent 1\\n    -transmitFilters 0\\n    -setFilter \\\"defaultSetFilter\\\" \\n    -showSetMembers 1\\n    -allowMultiSelection 1\\n    -alwaysToggleSelect 0\\n    -directSelect 0\\n    -isSet 0\\n    -isSetMember 0\\n    -displayMode \\\"DAG\\\" \\n    -expandObjects 0\\n    -setsIgnoreFilters 1\\n    -containersIgnoreFilters 0\\n    -editAttrName 0\\n    -showAttrValues 0\\n    -highlightSecondary 0\\n    -showUVAttrsOnly 0\\n    -showTextureNodesOnly 0\\n    -attrAlphaOrder \\\"default\\\" \\n    -animLayerFilterOptions \\\"allAffecting\\\" \\n    -sortOrder \\\"none\\\" \\n    -longNames 0\\n    -niceNames 1\\n    -showNamespace 1\\n    -showPinIcons 0\\n    -mapMotionTrails 0\\n    -ignoreHiddenAttribute 0\\n    -ignoreOutlinerColor 0\\n    -renderFilterVisible 0\\n    -renderFilterIndex 0\\n    -selectionOrder \\\"chronological\\\" \\n    -expandAttribute 0\\n    $editorName\"\n"
...
createNode mentalrayItemsList -s -n "mentalrayItemsList";
	rename -uid "98FFA6DB-4058-AF7B-3966-FE96E5A998A9";
createNode mentalrayGlobals -s -n "mentalrayGlobals";
	rename -uid "6756F512-4B0E-8424-16FF-F4A7A652FE43";
	setAttr ".rvb" 3;
	setAttr ".ivb" 0;
createNode mentalrayOptions -s -n "miDefaultOptions";
	rename -uid "6140B86C-4098-D4F6-151E-AEB40B8E14AF";
...
createNode mentalrayFramebuffer -s -n "miDefaultFramebuffer";
	rename -uid "2743E09D-44DC-DF9B-4EB0-F0B5EA270C95";
createNode shadingEngine -n "envSphere1SG";
	rename -uid "14CF392C-4074-4FBF-58F4-A19DCEB8DFD2";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "37EB256F-47AE-931F-311C-01925AA52CE1";
createNode shadingEngine -n "surfaceShader2SG";
	rename -uid "C000FEDD-405D-206E-AF7A-1CAECF00A37B";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo4";
	rename -uid "40B92769-43CB-7B8A-BEFD-6BACAD298087";
createNode phong -n "Scene_Material";
	rename -uid "B130B33A-44CD-DDA6-67B4-9D91B8D4426F";
	setAttr ".dc" 1;
...
createNode shadingEngine -n "sphereSG";
	rename -uid "A99A559B-43B7-BA5B-5BCA-4B968075F880";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "MB_test2_materialInfo1";
	rename -uid "04CDAB70-402D-952E-62F3-A6B7F5926577";
createNode phong -n "phong1";
	rename -uid "052C2FD3-4287-9486-8E1A-389047563410";
	setAttr ".dc" 1;
...
createNode shadingEngine -n "crvlistSG";
	rename -uid "85B24A4E-4077-A9D5-6FA7-248F209C371D";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "MB_test2_materialInfo2";
	rename -uid "54FB77EF-4408-D087-5DC3-269DC6E2133D";
createNode aiStandard -n "aiStandard1";
	rename -uid "5BA99DC7-435E-0CF9-08ED-AC9D27C96366";
	setAttr ".Kd" 1;
...
createNode shadingEngine -n "aiStandard1SG";
	rename -uid "0312E02D-4B13-838C-942C-11B8E22F7134";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "MB_test2_materialInfo3";
	rename -uid "7A86F8F8-4F0A-0F95-4D67-438868156972";
createNode lambert -n "lambert2";
	rename -uid "5E487F4F-4BFD-F3DF-5943-2DADA3B2D2B2";
	setAttr ".c" -type "float3" 1 0 0 ;
createNode shadingEngine -n "lambert2SG";
	rename -uid "3C891826-4737-A571-AEB5-EE8C6E75D5CB";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo5";
	rename -uid "855114D4-4345-8FD5-3F58-0F9A1C3F75E3";
createNode lambert -n "lambert3";
	rename -uid "7E4B81FF-46DF-DDBE-491B-FBA5E830A27C";
	setAttr ".c" -type "float3" 1 1 0 ;
createNode shadingEngine -n "lambert3SG";
	rename -uid "2BB125FC-4A03-27FB-8EAB-B8960850AF4D";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo6";
	rename -uid "683B66EA-4613-242F-FD7A-A4818352E34F";
createNode lambert -n "lambert4";
	rename -uid "6859D705-4110-3834-3189-4DBAB50B3207";
	setAttr ".c" -type "float3" 0 0 1 ;
createNode shadingEngine -n "lambert4SG";
	rename -uid "6A41CF89-48E8-692B-9574-F5BE05C0ABAB";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo7";
	rename -uid "C9CBA9D9-41BB-5702-0D0B-6BA3C168B03D";
createNode aiLightDecay -n "defaultLightDecay";
	rename -uid "AD9C0AC9-41AB-56C4-5703-90BFCF3386D4";
createNode lambert -n "lambert5";
	rename -uid "41C67E5A-4FA7-3506-7386-919A3C26FA47";
	setAttr ".c" -type "float3" 1 0 0 ;
createNode shadingEngine -n "lambert5SG";
	rename -uid "CC75C36E-40A3-DEAA-ACCD-FBBF4C4C8358";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo8";
	rename -uid "BBADF41D-4F64-C78A-84B2-CB993CEBF20A";
createNode lambert -n "lambert6";
	rename -uid "B0D371D8-41D2-D778-F181-FCBC9E051731";
	setAttr ".c" -type "float3" 1 0 0 ;
createNode shadingEngine -n "lambert6SG";
	rename -uid "2D60372F-4A7F-D20B-36CE-6083A2FBA505";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo9";
	rename -uid "68DBBD70-4123-B592-3A39-25B3110ED97F";
createNode lambert -n "lambert7";
	rename -uid "DE3DF746-48CD-60D0-CF8F-238F5B5BC9E5";
	setAttr ".c" -type "float3" 0 0 1 ;
createNode shadingEngine -n "lambert7SG";
	rename -uid "0CA8DB1A-4E00-14E1-19AD-518928C83B7D";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo10";
	rename -uid "DE7E1737-42F6-5531-0E73-D799740A463C";
createNode lambert -n "lambert8";
	rename -uid "FF20B582-4AED-3B0E-0E56-B6964B63C7F3";
	setAttr ".c" -type "float3" 0 1 0 ;
createNode shadingEngine -n "lambert8SG";
	rename -uid "7AF48227-4119-2532-131F-009F8DCF8F04";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo11";
	rename -uid "3F8829A9-4AD8-EF14-B92D-5AB60E0748F6";
createNode lambert -n "lambert9";
	rename -uid "D0590273-4174-2F39-7B56-92B9BE6C9CC2";
	setAttr ".c" -type "float3" 1 0 1 ;
createNode shadingEngine -n "lambert9SG";
	rename -uid "76DA02E8-4AE6-55D3-9B9C-90AD94DE2290";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo12";
	rename -uid "EE005C24-470C-B6E8-55C9-00BC437C7265";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "D112CC62-47C4-57A6-BFE9-118D009BECD6";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "E12C1ABA-4C6C-7E79-3318-C68EF3541330";
...
createNode dynGlobals -n "dynGlobals1";
	rename -uid "EBE36D82-4D4C-DC14-F873-F8BCCA4B27A4";
	setAttr ".upd" yes;
	setAttr ".cd" -type "string" "test";
	setAttr -l on ".mnf" 1;
	setAttr -l on ".mxf" 50;
createNode polySphere -n "polySphere1";
	rename -uid "5F5AA0BC-4661-E331-376C-DB8B602D24A2";
	setAttr ".r" 1.3701092051452992;
createNode polyPlane -n "polyPlane1";
	rename -uid "29A0DD94-473A-8D49-4D1C-798A300348D3";
...
createNode aiStandard -n "aiStandard2";
	rename -uid "B40A3989-4E14-FC15-765C-EDBF68CBFDC2";
...
createNode shadingEngine -n "aiStandard2SG";
	rename -uid "00095545-438C-77A7-5032-05AC3AE74225";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo13";
	rename -uid "703D0B09-4FD8-616C-FF4F-94970852BAE7";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "500A3939-4EF3-3F1E-2AFD-29BF6B23ACB7";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "18A085F8-491D-C2B8-3121-468FE557108F";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "27A2BF64-435D-A60C-3A05-44B355C09C80";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode aiStandardSurface -n "aiStandardSurface1";
	rename -uid "E884DDD7-4594-F2D4-67A3-4CBF694E26D7";
	setAttr ".base" 1;
	setAttr ".base_color" -type "float3" 0.35299999 0.35299999 1 ;
	setAttr ".specular_roughness" 0;
createNode shadingEngine -n "aiStandardSurface1SG";
	rename -uid "D733AD11-4009-818F-6F3E-96BC55B3174E";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo14";
	rename -uid "05B209DE-45AA-6D37-A32D-B98E7476EEEC";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
