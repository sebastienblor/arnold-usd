...
//Name: test.ma
//Last modified: Fri, Mar 15, 2019 02:54:42 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	rename -uid "3D030217-4197-0689-639E-588B79327AC3";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.01808256224292993 0.34065946086570836 1.2355098769598998 ;
	setAttr ".r" -type "double3" -4.5383527296064896 -0.59999999999910902 2.484944595982237e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "6C5974FB-4D47-B39F-BDEC-BE8395165C3B";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
...
createNode transform -s -n "top";
	rename -uid "0545AA8F-46ED-31A5-DF61-1BAF897C4293";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "91CED890-4912-F855-78D7-238E273F990E";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "4AEC45BC-43FF-B9D0-2780-D98E4A21F2DB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "03815CE8-4E65-3FBD-874F-A1A28D7C09A7";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "C0F22D38-4D72-AE14-62C3-1F9D6B32C582";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "C0C0270E-4A99-A484-75D1-DBA6A2894DB1";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -n "pPlane1";
	rename -uid "57628D86-4B8C-15BF-683C-5880F0BB96E5";
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "31F2E2E9-4842-D9F6-B1FF-AFACB78E35C7";
...
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "811442C9-443D-8030-9C56-22923910728D";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1A93E550-4906-6478-609E-FFBD72440FA6";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "F2E8007E-4366-2C5F-72DC-DB987972E453";
createNode displayLayer -n "defaultLayer";
	rename -uid "FECD0F08-4154-9C07-515B-C68607EC6911";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "06F3714E-4A24-6A6C-C862-0E96C916B30B";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "A7F9B2DA-4BC8-7475-FE29-D8B0FDE88EED";
	setAttr ".g" yes;
createNode aiStandard -n "ArnoldStandardShader1";
	rename -uid "B08B68FE-4539-CC5B-8A0E-1F95115B2ADB";
...
createNode shadingEngine -n "ArnoldStandardShader1SG";
	rename -uid "791577F4-4388-E62E-E149-19B2360EE270";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "29796DE2-4524-785F-BB79-62A563B4E961";
createNode shadingEngine -n "ArnoldStandardShader1SG1";
	rename -uid "13BC5722-47CF-7DA6-0166-0FA0CB91A268";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "A30BDB2E-4B1E-7159-3D8B-0193457C77FE";
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "FA250717-4B5D-9460-5381-2A861BDE904C";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 48 ";
	setAttr ".st" 6;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "EF729B79-44D2-88B9-3610-A39AB432A923";
...
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "515E6167-4F38-704C-508B-EC9D564004CD";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "80455D55-41E3-043D-62F1-3D97B3F85B0B";
...
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "9D4C045E-443C-3FE3-4CA4-D8A26B79AE43";
	addAttr -ci true -sn "dither_amplitude" -ln "ditherAmplitude" -dv 1 -at "float";
	addAttr -ci true -sn "host_name" -ln "hostName" -dt "string";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode polyPlane -n "polyPlane1";
	rename -uid "E307393F-4677-6B7D-8DC7-3FAC58E3D7BE";
	setAttr ".sw" 1;
	setAttr ".sh" 2;
	setAttr ".cuv" 2;
createNode shadingEngine -n "aiSkinSss1SG";
	rename -uid "F9B63E37-484B-947E-0754-15A0DF444E3A";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "CC8D0BFC-4C9B-A616-F2C0-A6992EF8A91E";
createNode checker -n "checker1";
	rename -uid "27019485-4D20-5007-3209-71B603C1087F";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "D1B888AF-4554-7C4C-92C4-11999B5CDB36";
	setAttr ".re" -type "float2" 4 4 ;
createNode shadingEngine -n "aiSkin1SG";
	rename -uid "709066C9-4C36-2C81-A7FB-C6BEDEC8BE70";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo4";
	rename -uid "E6E1C901-4AA6-EBCD-536F-78B84EFC6491";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A68E6690-441C-CD85-AD95-468C37F84A72";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "732D3C8D-4E99-8EA7-4C22-E9AEB710EFB4";
createNode aiStandardSurface -n "aiStandardSurface1";
	rename -uid "4AC26E58-47AE-6079-6D39-6692F3602BC2";
	setAttr ".base" 1;
...
createNode checker -n "checker2";
	rename -uid "EE60A7BD-4654-6EAB-3B42-42A33639CB34";
createNode place2dTexture -n "place2dTexture2";
	rename -uid "9FC00AE9-417A-4A07-7F4F-52A532CED8AC";
	setAttr ".tf" -type "float2" 0.2 0 ;
	setAttr ".re" -type "float2" 4 4 ;
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "CFE8B88B-44CF-9B42-A230-76A518E7AD0D";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -407.84321207301502 -19.146738668564144 ;
	setAttr ".tgi[0].vh" -type "double2" 438.58532572150784 462.99609931565789 ;
...
connectAttr "pPlaneShape1.iog" "aiSkin1SG.dsm" -na;
connectAttr "aiSkin1SG.msg" "materialInfo4.sg";
connectAttr "aiStandardSurface1.msg" "materialInfo4.m";
connectAttr "aiStandardSurface1.msg" "materialInfo4.t" -na;
connectAttr "checker1.oc" "aiStandardSurface1.subsurface_color";
connectAttr "checker2.oc" "aiStandardSurface1.subsurface_radius";
connectAttr "place2dTexture2.o" "checker2.uv";
connectAttr "place2dTexture2.ofs" "checker2.fs";
connectAttr "place2dTexture1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "aiSkin1SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
...
connectAttr "place2dTexture2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "checker2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
