...
//Name: test.ma
//Last modified: Tue, Oct 23, 2012 05:27:46 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.01808256224292993 0.34065946086570836 1.2355098769598998 ;
	setAttr ".r" -type "double3" -4.5383527296064896 -0.59999999999910902 2.484944595982237e-017 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 1.2502648780075858;
...
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	...
	setAttr -s 4 ".pt[2:5]" -type "float3"  0 0.29677099 0 0 0.29677099 
		0 0 0.56148452 0.96821368 0 0.56148452 0.96821368;
	setAttr ".ai_sss_sample_spacing" 0.0099999997764825821;
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" -3.2299590757133991 0 0 ;
	setAttr ".r" -type "double3" 0.96401600354705341 0 0 ;
...
createNode aiSkinSss -n "aiSkinSss1";
	...
	setAttr ".shallow_scatter_weight" 1;
	setAttr ".shallow_scatter_radius" 0.10000000149011612;
	setAttr ".mid_scatter_weight" 1;
	setAttr ".mid_scatter_radius" 0.10000000149011612;
	setAttr ".deep_scatter_radius" 0.10000000149011612;
	setAttr ".primary_reflection_color" -type "float3" 0 0 0 ;
	setAttr ".primary_reflection_weight" 0;
	setAttr ".primary_reflection_roughness" 0;
	setAttr ".primary_reflection_specular_weight" 0;
	setAttr ".secondary_reflection_color" -type "float3" 0 0 0 ;
	setAttr ".secondary_reflection_weight" 0;
	setAttr ".secondary_reflection_roughness" 0;
	setAttr ".secondary_reflection_specular_weight" 0;
...
connectAttr "checker1.oc" "aiSkinSss1.shallow_scatter_color";
connectAttr "checker2.oc" "aiSkinSss1.mid_scatter_color";
connectAttr "checker3.oc" "aiSkinSss1.deep_scatter_color";
connectAttr "aiSkinSss1.outColor" "aiSkinSss1SG.ss";
connectAttr "pPlaneShape1.iog" "aiSkinSss1SG.dsm" -na;
connectAttr "aiSkinSss1SG.msg" "materialInfo3.sg";
connectAttr "aiSkinSss1.msg" "materialInfo3.m";
connectAttr "aiSkinSss1.msg" "materialInfo3.t" -na;
