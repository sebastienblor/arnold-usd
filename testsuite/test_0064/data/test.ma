...
//Name: test.ma
//Last modified: Wed, Jan 18, 2012 05:41:00 PM
//Codeset: 1252
requires maya "2012";
...
createNode lookAt -n "Camera_Root";
	...
	setAttr ".wut" 0;
	setAttr ".db" 23.386218076548225;
	setAttr ".tws" 2.679831529514896;
	setAttr ".dc" no;
createNode transform -n "Camera" -p "Camera_Root";
	setAttr ".t" -type "double3" 20.295475076667284 9.3855355442654442 -34.815059148383178 ;
createNode camera -n "CameraShape" -p "Camera";
	...
	setAttr ".fcp" 32768;
	setAttr ".fd" 200;
	setAttr ".coi" 23.386218076548225;
	setAttr ".ow" 30;
...
createNode transform -n "Camera_Interest" -p "Camera_Root";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.9569404048086154 -5.0844742742956841 -35.925085212786087 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 5.4691495580356797 2.3815356696720911 2.9530913048400582 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".in" 7.9136691093444824;
	setAttr ".ai_exposure" 2.6446280479431152;
...
connectAttr "imagePlane1.msg" "CameraShape.ip" -na;
