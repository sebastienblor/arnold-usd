...
//Name: test.ma
//Last modified: Mon, Oct 08, 2012 03:51:12 PM
//Codeset: UTF-8
requires maya "2011";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 11.393800553524315;
...
createNode transform -n "directionalLight1";
	setAttr ".r" -type "double3" -192.61170030634608 40.101226918356545 -132.80946671087221 ;
...
createNode bump2d -n "bump2d1";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	addAttr -ci true -k true -sn "flip_r" -ln "aiFlipR" -dv 1 -min 0 -max 1 -at "bool";
	addAttr -ci true -k true -sn "flip_g" -ln "aiFlipG" -dv 1 -min 0 -max 1 -at "bool";
	addAttr -ci true -k true -sn "swap_tangents" -ln "aiSwapTangents" -min 0 -max 1 
		-at "bool";
	addAttr -ci true -k true -sn "use_derivatives" -ln "aiUseDerivatives" -dv 1 -min 
		0 -max 1 -at "bool";
	addAttr -ci true -k true -sn "gamma_correct" -ln "aiGammaCorrect" -dv 1 -min 0 -max 
		1 -at "bool";
	setAttr ".bi" 1;
...
createNode file -n "file1";
	...
	addAttr -ci true -sn "ai_useDefaultColor" -ln "aiUseDefaultColor" -dv 1 -min 0 -max 
		1 -at "bool";
	setAttr ".ail" yes;
	setAttr ".ftn" -type "string" "normal_map.tga";
...
connectAttr "pPlaneShape1.iog" "aiStandard3SG.dsm" -na;
