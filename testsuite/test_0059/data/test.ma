...
//Name: test.ma
//Last modified: Wed, Jun 19, 2013 02:33:12 PM
//Codeset: UTF-8
requires maya "2012";
...
createNode pointEmitter -n "emitter1";
	setAttr ".t" -type "double3" 0 -17.908489298733659 0 ;
	setAttr ".emt" 0;
	setAttr ".rat" 10000;
	setAttr ".sro" no;
	setAttr -l on ".urpp";
...
createNode particle -n "particleShape1" -p "particle1";
	...
	setAttr ".ai_export_attributes" -type "string" "rgbPP opacityPP";
	setAttr ".lifespanPP0" -type "doubleArray" 0 ;
	setAttr -k on ".lifespan" 1;
	setAttr -k on ".colorAccum";
	setAttr -k on ".useLighting";
	setAttr -k on ".pointSize" 16;
...
createNode aiUserDataFloat -n "aiUserDataFloat1";
	setAttr ".floatAttrName" -type "string" "opacityPP";
...
connectAttr "gravityField1.of[0]" "particleShape1.ifc[0]";
connectAttr "particleShape1.xo[0]" "particleShape1.mas";
connectAttr "arrayMapper2.ovpp" "particleShape1.opacityPP";
connectAttr "arrayMapper3.ocpp" "particleShape1.rgbPP";
connectAttr "particleShape1.fd" "gravityField1.ind[0]";
connectAttr "particleShape1.ppfd[0]" "gravityField1.ppda[0]";
...
connectAttr "particleShape1.ageNormalized" "arrayMapper2.vpp";
connectAttr "ramp1.msg" "arrayMapper3.cn";
connectAttr "ramp1.oc" "arrayMapper3.cnc";
connectAttr "particleShape1.ageNormalized" "arrayMapper3.vpp";
connectAttr "aiUserDataColor1.out" "surfaceShader2.oc";
connectAttr "aiUserDataFloat1.out" "surfaceShader2.otr";
connectAttr "aiUserDataFloat1.out" "surfaceShader2.otg";
connectAttr "aiUserDataFloat1.out" "surfaceShader2.otb";
connectAttr "surfaceShader2.oc" "surfaceShader2SG.ss";
connectAttr "particleShape1.iog" "surfaceShader2SG.dsm" -na;
