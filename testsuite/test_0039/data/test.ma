...
//Name: test.ma
//Last modified: Thu, Sep 22, 2011 02:44:07 PM
//Codeset: 1252
requires maya "2012";
...
createNode mesh -n "pSphereShape1" -p "pSphere1";
	...
	setAttr ".ai_subdiv_iterations" 4;
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 0.34506630335573418 1.8998226219594425 2.2074515762557692 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	addAttr -ci true -k true -sn "ai_oss" -ln "aiOverrideSssSamples" -min 0 -max 1 
		-at "bool";
...
createNode aiDisplacement -n "aiDisplacement1";
...
createNode aiDisplacement -n "aiDisplacement2";
	setAttr ".padding" 0.15957446396350861;
...
connectAttr "aiDisplacement1.od" "aiStandard2SG.ds";
...
connectAttr "checker1.oc" "aiDisplacement1.map";
connectAttr "place2dTexture2.o" "checker1.uv";
connectAttr "place2dTexture2.ofs" "checker1.fs";
connectAttr "checker2.oc" "aiDisplacement2.map";
...
connectAttr "aiDisplacement2.od" ":initialShadingGroup.ds";
connectAttr "aiStandard2.msg" ":defaultShaderList1.s" -na;
connectAttr "aiStandard3.msg" ":defaultShaderList1.s" -na;
connectAttr "aiDisplacement1.msg" ":defaultShaderList1.s" -na;
connectAttr "aiStandard4.msg" ":defaultShaderList1.s" -na;
connectAttr "aiDisplacement2.msg" ":defaultShaderList1.s" -na;
