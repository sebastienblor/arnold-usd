...
//Name: test.ma
//Last modified: Wed, Feb 29, 2012 12:52:34 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.67579604542290295 1.0016694415384872 0.67579604542290006 ;
	setAttr ".r" -type "double3" -46.538352729602344 45.000000000000057 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 1.384456708947998;
	setAttr ".ow" 1.602485229032359;
...
connectAttr "surfaceShader1.oc" "checker1SG.ss";
connectAttr "pPlaneShape1.iog" "checker1SG.dsm" -na;
