...
//Name: test.ma
//Last modified: Tue, May 31, 2011 10:13:56 PM
//Codeset: 1252
requires maya "2011";
requires "mtoa" "0.7.0";
...
createNode transform -shared -name "persp";
	...
	setAttr ".translate" -type "double3" 0.67579604542290295 1.0016694415384872 0.67579604542290006 ;
	setAttr ".rotate" -type "double3" -46.538352729602344 45.000000000000057 0 ;
createNode camera -shared -name "perspShape" -parent "persp";
	...
	setAttr ".centerOfInterest" 1.384456708947998;
	setAttr ".orthographicWidth" 1.602485229032359;
...
createNode shadingEngine -name "checker1SG";
...
connectAttr "surfaceShader1.outColor" "checker1SG.surfaceShader";
connectAttr "pPlaneShape1.instObjGroups" "checker1SG.dagSetMembers" -nextAvailable
		;
connectAttr "checker1SG.message" "materialInfo1.shadingGroup";
connectAttr "surfaceShader1.message" "materialInfo1.material";
connectAttr "surfaceShader1.message" "materialInfo1.texture" -nextAvailable;
connectAttr "checker1.outColor" "surfaceShader1.outColor";
connectAttr "checker1SG.partition" ":renderPartition.sets" -nextAvailable;
