...
//Name: test.ma
//Last modified: Wed, Feb 29, 2012 03:47:06 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.6881069066505496 7.7597988314245443 11.464326879349153 ;
	setAttr ".r" -type "double3" -27.33835272960231 40.200000000000031 -2.0820707114365739e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 16.896887440314281;
...
createNode particle -n "particleShape1" -p "particle1";
	...
	setAttr -k on ".ai_export_attributes" -type "string" "velocity";
	setAttr -k on ".ai_interpolate_blur" no;
...
createNode aiUserDataColor -n "aiUserDataColor1";
	setAttr ".colorAttrName" -type "string" "velocity";
...
createNode dynGlobals -n "dynGlobals1";
	...
	setAttr -l on ".mnf";
	setAttr -l on ".mxf" 50;
	setAttr ".cnp" -type "string" "./test";
	setAttr ".csn" -type "string" "./test";
createNode setRange -n "setRange1";
	setAttr ".m" -type "float3" 1 1 1 ;
	setAttr ".on" -type "float3" -50 -50 -50 ;
	setAttr ".om" -type "float3" 50 50 50 ;
...
connectAttr "vortexField1.of[0]" "particleShape1.ifc[0]";
connectAttr "particleShape1.fd" "vortexField1.ind[0]";
connectAttr "particleShape1.ppfd[0]" "vortexField1.ppda[0]";
...
connectAttr "setRange1.o" "surfaceShader2.oc";
...
connectAttr "aiUserDataColor1.out" "setRange1.v";
