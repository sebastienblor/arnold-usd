...
//Name: Archive.ma
//Last modified: Tue, Nov 27, 2018 12:54:16 PM
//Codeset: 1252
...
createNode transform -n "initialShadingGroup_materialRef";
	rename -uid "E3DD58F8-494F-B10E-E097-EF8A32C420BC";
createNode mesh -n "initialShadingGroup_materialRefShape" -p "initialShadingGroup_materialRef";
	rename -uid "4B638AC6-42C6-E86F-95D3-C5AEBFEFD6B1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
select -ne :defaultColorMgtGlobals;
	setAttr ".cfe" yes;
	setAttr ".cfp" -type "string" "n:\\sabeltann\\element\\colormanagment\\aces_1.0.3\\config.ocio";
