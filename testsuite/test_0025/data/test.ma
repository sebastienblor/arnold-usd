...
//Name: test.ma
//Last modified: Wed, Jun 15, 2011 04:12:36 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -name "transform2";
createNode transform -name "transform3";
createNode transform -name "transform4";
createNode transform -name "transform5";
createNode transform -name "transform6";
createNode transform -name "transform7";
createNode transform -name "transform8";
createNode transform -name "transform9";
createNode transform -name "transform10";
createNode transform -name "transform11";
createNode transform -name "transform12";
createNode transform -name "transform13";
createNode transform -name "transform14";
createNode transform -name "transform15";
createNode transform -name "transform16";
createNode transform -name "transform17";
createNode transform -name "transform18";
createNode transform -name "transform19";
createNode transform -name "transform20";
createNode transform -name "transform21";
createNode transform -name "transform22";
createNode transform -name "transform23";
createNode transform -name "transform24";
createNode transform -name "transform25";
createNode transform -name "transform26";
createNode transform -name "transform27";
...
createNode transform -shared -name "top";
	setAttr ".visibility" no;
	setAttr ".translate" -type "double3" 0 1.0000000000000002 2.2204460492503131e-016 ;
...
createNode ramp -name "ramp1";
	...
	setAttr ".colorEntryList[1].color" -type "float3" 0 1 1 ;
	...
	setAttr ".colorEntryList[4].color" -type "float3" 0 1 0 ;
...
connectAttr "checker1.outAlpha" "ramp1.colorEntryList[1].position";
