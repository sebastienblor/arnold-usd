...
//Name: test.ma
//Last modified: Tue, Oct 15, 2013 03:32:28 PM
//Codeset: UTF-8
requires maya "2012";
...
createNode aiSkin -n "aiSkin1";
	...
	setAttr ".primary_specular_roughness" 0.76422762870788574;
	setAttr ".primary_specular_fresnel_weight" 0.58823531866073608;
	setAttr ".secondary_specular_roughness" 0.85365855693817139;
	setAttr ".secondary_specular_fresnel_weight" 0.48739495873451233;
...
connectAttr "pCylinderShape1.iog" "aiSkin1SG.dsm" -na;
connectAttr "pSphereShape1.iog" "aiSkin1SG.dsm" -na;
connectAttr "pTorusShape1.iog" "aiSkin1SG.dsm" -na;
connectAttr "aiSkin1SG.msg" "materialInfo11.sg";
connectAttr "aiSkin1.msg" "materialInfo11.m";
connectAttr "aiSkin1.msg" "materialInfo11.t" -na;
