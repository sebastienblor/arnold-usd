...
createNode transform -s -n "persp";
	...
	setAttr ".r" -type "double3" -20.738352729603672 0.59999999999883258 -1.4909667575893421e-016 ;
	setAttr ".rp" -type "double3" 2.7755575615628914e-017 5.5511151231257827e-017 0 ;
	setAttr ".rpt" -type "double3" -7.3693827207180585e-018 -7.3108369892944504e-018 
		-3.3361545752586758e-017 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BCE6DFE3-4F15-FBF0-AAF9-469BB83A4D07";
	setAttr -s 16 ".lnk";
	setAttr -s 16 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "EFFD49DF-4BC1-1FB9-A2B5-4BB87C1E9FE3";
createNode displayLayer -n "defaultLayer";
	rename -uid "3024AC66-494C-BACF-7F55-AB91320C672A";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "3E686451-4208-D6C8-C972-31BFC1481BBF";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B392A9CE-4B21-4F95-B98A-4F94958D84D3";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "AE2CA0CD-4249-ED2A-D03F-54868B27229B";
