...
//Name: test.ma
//Last modified: Mon, Jun 10, 2013 06:07:09 PM
//Codeset: UTF-8
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.93487333928003291 16.891813314165713 133.90084313129961 ;
	setAttr ".r" -type "double3" -7.2000000000000766 -0.39999999999999991 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 134.9761568933568;
...
createNode fluidShape -n "fluidShape1" -p "fluid1";
	...
	addAttr -ci true -k true -sn "ai_noise_affect_opacity" -ln "aiNoiseAffectOpacity" 
		-min 0 -max 1 -at "bool";
	addAttr -ci true -k true -sn "ai_volume_noise" -ln "aiVolumeNoise" -at "message";
	setAttr -k off ".v";
	setAttr ".rt" 1;
	setAttr ".iss" yes;
	...
	setAttr ".i[1].ii" 1;
	setAttr ".i[2].ip" 0.61739128828048706;
	setAttr ".i[2].ic" -type "float3" 0 1 0 ;
	setAttr ".i[2].ii" 1;
	setAttr ".iib" -0.079999998211860657;
	setAttr ".env[0].envp" 0;
	setAttr ".env[0].envc" -type "float3" 0 0 0 ;
	setAttr ".env[0].envi" 1;
	setAttr ".dos" 2;
	setAttr ".ai_step_size" 0.5;
...
createNode renderLayerManager -n "renderLayerManager";
	setAttr ".crl" 1;
	setAttr -s 9 ".rlmi";
	setAttr ".rlmi[1:5]" 1 2 3 4 5;
	setAttr ".rlmi[7:9]" 6 7 8;
...
createNode renderLayer -n "gradientX";
	setAttr ".g" yes;
	setAttr ".adjs[0].val" 5;
	setAttr ".do" 6;
createNode renderLayer -n "gradientY";
	setAttr ".g" yes;
	setAttr ".adjs[0].val" 6;
	setAttr ".do" 7;
createNode renderLayer -n "gradientZ";
	setAttr ".g" yes;
	setAttr ".adjs[0].val" 7;
	setAttr ".do" 8;
createNode renderLayer -n "gradientNX";
	setAttr ".g" yes;
	setAttr ".adjs[0].val" 8;
	setAttr ".do" 1;
createNode renderLayer -n "gradientNY";
	setAttr ".g" yes;
	setAttr ".adjs[0].val" 9;
	setAttr ".do" 4;
createNode renderLayer -n "gradientNZ";
	setAttr ".g" yes;
	setAttr ".adjs[0].val" 10;
	setAttr ".do" 5;
createNode renderLayer -n "gradientCenter";
	setAttr ".g" yes;
	setAttr ".adjs[0].val" 11;
	setAttr ".do" 2;
createNode renderLayer -n "gradientConstant";
	setAttr ".g" yes;
...
connectAttr "fluidShape1.tgr" "defaultRenderLayer.adjs[0].plg";
...
connectAttr "renderLayerManager.rlmi[1]" "gradientX.rlid";
connectAttr "fluidShape1.tgr" "gradientX.adjs[0].plg";
connectAttr "renderLayerManager.rlmi[2]" "gradientY.rlid";
connectAttr "fluidShape1.tgr" "gradientY.adjs[0].plg";
connectAttr "renderLayerManager.rlmi[3]" "gradientZ.rlid";
connectAttr "fluidShape1.tgr" "gradientZ.adjs[0].plg";
connectAttr "renderLayerManager.rlmi[4]" "gradientNX.rlid";
connectAttr "fluidShape1.tgr" "gradientNX.adjs[0].plg";
connectAttr "renderLayerManager.rlmi[5]" "gradientNY.rlid";
connectAttr "fluidShape1.tgr" "gradientNY.adjs[0].plg";
connectAttr "renderLayerManager.rlmi[7]" "gradientNZ.rlid";
connectAttr "fluidShape1.tgr" "gradientNZ.adjs[0].plg";
connectAttr "renderLayerManager.rlmi[8]" "gradientCenter.rlid";
connectAttr "fluidShape1.tgr" "gradientCenter.adjs[0].plg";
connectAttr "renderLayerManager.rlmi[9]" "gradientConstant.rlid";
connectAttr "fluidShape1.tgr" "gradientConstant.adjs[0].plg";
...
connectAttr "gradientX.msg" ":defaultRenderingList1.r" -na;
connectAttr "gradientY.msg" ":defaultRenderingList1.r" -na;
connectAttr "gradientZ.msg" ":defaultRenderingList1.r" -na;
connectAttr "gradientNX.msg" ":defaultRenderingList1.r" -na;
connectAttr "gradientNY.msg" ":defaultRenderingList1.r" -na;
connectAttr "gradientNZ.msg" ":defaultRenderingList1.r" -na;
connectAttr "gradientCenter.msg" ":defaultRenderingList1.r" -na;
connectAttr "gradientConstant.msg" ":defaultRenderingList1.r" -na;
// End of test.ma
