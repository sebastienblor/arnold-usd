...
//Name: test.ma
//Last modified: Tue, Jun 26, 2012 07:46:55 PM
//Codeset: UTF-8
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.5906960387267093 4.9744594066171217 4.8920371800687095 ;
	setAttr ".r" -type "double3" -38.138352729578529 47.400000000001732 2.3494368421401922e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 8.2720041494947019;
...
createNode transform -n "pCube1";
	setAttr ".s" -type "double3" 5.3631327109759077 5.3631327109759077 5.3631327109759077 ;
...
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" 0 0 9.1567406106704539 ;
	setAttr ".r" -type "double3" -52.463259975315161 30.036870172041329 -27.322444450857954 ;
...
createNode transform -n "directionalLight2";
	setAttr ".r" -type "double3" 3.1354149333589527 -114.98047116409425 27.364998389740279 ;
...
createNode bulge -n "bulge1";
	setAttr ".ail" yes;
	setAttr ".cg" -type "float3" 0.17985809 0.17985809 0.17985809 ;
...
createNode displacementShader -n "displacementShader1";
	...
	setAttr -k on ".ai_displacement_auto_bump" no;
...
connectAttr "aiStandard5SG.mwc" "pCubeShape1.iog.og[3].gco";
...
connectAttr "displacementShader1.d" "aiStandard3SG.ds";
...
connectAttr "displacementShader2.d" "aiStandard4SG.ds";
...
connectAttr "pCubeShape1.iog.og[3]" "aiStandard5SG.dsm" -na;
