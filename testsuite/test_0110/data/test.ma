...
//Name: test.ma
//Last modified: Mon, Jan 28, 2013 05:06:28 PM
//Codeset: UTF-8
requires maya "2011";
...
fileInfo "osv" "Linux 3.6.11-5.fc17.x86_64 #1 SMP Tue Jan 8 21:40:51 UTC 2013 x86_64";
fileInfo "psyop_attr_pUsers" "yyamashita";
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0.89322333672057774 1.5830065865684892 ;
	setAttr ".r" -type "double3" -29.999999999999996 0 -4.9732824146399227e-17 ;
...
createNode checker -n "checker1";
	addAttr -ci true -k true -sn "ai_user_options" -ln "aiUserOptions" -dt "string";
	addAttr -ci true -uac -sn "ai_color1" -ln "aiColor1" -at "float3" -nc 3;
	addAttr -ci true -sn "ai_color1r" -ln "aiColor1R" -dv 1 -at "float" -p "aiColor1";
	addAttr -ci true -sn "ai_color1g" -ln "aiColor1G" -dv 1 -at "float" -p "aiColor1";
	addAttr -ci true -sn "ai_color1b" -ln "aiColor1B" -dv 1 -at "float" -p "aiColor1";
	addAttr -ci true -uac -sn "ai_color2" -ln "aiColor2" -at "float3" -nc 3;
	addAttr -ci true -sn "ai_color2r" -ln "aiColor2R" -at "float" -p "aiColor2";
	addAttr -ci true -sn "ai_color2g" -ln "aiColor2G" -at "float" -p "aiColor2";
	addAttr -ci true -sn "ai_color2b" -ln "aiColor2B" -at "float" -p "aiColor2";
	addAttr -ci true -sn "ai_contrast" -ln "aiContrast" -dv 1 -at "float";
	addAttr -ci true -sn "ai_uvCoord" -ln "aiUvCoord" -at "float2" -nc 2;
	addAttr -ci true -sn "ai_uvCoordx" -ln "aiUvCoordX" -at "float" -p "aiUvCoord";
	addAttr -ci true -sn "ai_uvCoordy" -ln "aiUvCoordY" -at "float" -p "aiUvCoord";
	addAttr -ci true -uac -sn "ai_defaultColor" -ln "aiDefaultColor" -at "float3" -nc 
		3;
	addAttr -ci true -sn "ai_defaultColorr" -ln "aiDefaultColorR" -dv 0.5 -at "float" 
		-p "aiDefaultColor";
	addAttr -ci true -sn "ai_defaultColorg" -ln "aiDefaultColorG" -dv 0.5 -at "float" 
		-p "aiDefaultColor";
	addAttr -ci true -sn "ai_defaultColorb" -ln "aiDefaultColorB" -dv 0.5 -at "float" 
		-p "aiDefaultColor";
	addAttr -ci true -uac -sn "ai_colorGain" -ln "aiColorGain" -at "float3" -nc 3;
	addAttr -ci true -sn "ai_colorGainr" -ln "aiColorGainR" -dv 1 -at "float" -p "aiColorGain";
	addAttr -ci true -sn "ai_colorGaing" -ln "aiColorGainG" -dv 1 -at "float" -p "aiColorGain";
	addAttr -ci true -sn "ai_colorGainb" -ln "aiColorGainB" -dv 1 -at "float" -p "aiColorGain";
	addAttr -ci true -uac -sn "ai_colorOffset" -ln "aiColorOffset" -at "float3" -nc 
		3;
	addAttr -ci true -sn "ai_colorOffsetr" -ln "aiColorOffsetR" -at "float" -p "aiColorOffset";
	addAttr -ci true -sn "ai_colorOffsetg" -ln "aiColorOffsetG" -at "float" -p "aiColorOffset";
	addAttr -ci true -sn "ai_colorOffsetb" -ln "aiColorOffsetB" -at "float" -p "aiColorOffset";
	addAttr -ci true -sn "ai_alphaGain" -ln "aiAlphaGain" -dv 1 -at "float";
	addAttr -ci true -sn "ai_alphaOffset" -ln "aiAlphaOffset" -at "float";
	addAttr -ci true -sn "ai_alphaIsLuminance" -ln "aiAlphaIsLuminance" -min 0 -max 
		1 -at "bool";
	addAttr -ci true -sn "ai_invert" -ln "aiInvert" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "ai_filter" -ln "aiFilter" -dv 1 -at "float";
	addAttr -ci true -sn "ai_filterOffset" -ln "aiFilterOffset" -at "float";
