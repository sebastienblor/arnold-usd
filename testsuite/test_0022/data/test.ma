...
//Name: test.ma
//Last modified: Thu, Mar 16, 2017 05:17:22 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	rename -uid "CAB0C7F0-4DB7-6A32-9FFC-B0B92154567E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.8319166838703129 29.034476536544958 -0.28139837120431888 ;
	setAttr ".r" -type "double3" -97.538352729598827 85.799999999999329 4.3427539265067865e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "B9DDE13A-45F8-044A-5D6C-75A96509133A";
	...
	setAttr ".coi" 29.287601442703103;
...
createNode transform -s -n "top";
	rename -uid "ECA78C38-4B5B-C753-21B7-21A5F74272C1";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1.0000000000000002 2.2204460492503131e-016 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "FBB6F536-4F88-296B-E5A7-BEAEDB7C5F37";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -s -n "front";
	rename -uid "DB136092-4125-FB8B-6A05-D2B7D0F63832";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 100.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "558D964D-43B3-F2B8-3F05-69997B2C66CB";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -s -n "side";
	rename -uid "2C8C014F-4276-E4BF-E9B1-F898F06BDD61";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "0698104E-4AC0-DD61-0039-D2B9ABACE895";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 
		-max 1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
		-min 0 -max 20 -smn 0 -smx 0.5 -at "float";
...
createNode transform -n "pPlane1";
	rename -uid "1DA6B787-4401-CD67-1B1A-B4996E0C5947";
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "9FFFC899-42C3-06B0-92F4-F684F2E07CBD";
...
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "D6E51B72-44B0-ECDD-DCDC-54804A9F14D4";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7F6AD444-49CE-CC4C-38B8-70AB5AB96DBE";
	setAttr -s 9 ".lnk";
	setAttr -s 9 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "8A45A730-4CC2-0F0E-8525-E9AE4CF043C3";
createNode displayLayer -n "defaultLayer";
	rename -uid "052284D0-4E2C-5520-00FB-D69207DC35EB";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1760CA91-456F-EFCB-8849-6BA807CD587F";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "9BE3681D-4C54-730C-EB4E-3493B8E13565";
	setAttr ".g" yes;
createNode polyPlane -n "polyPlane1";
	rename -uid "2E68AB0E-495E-F0A5-376A-8A910DCA5C65";
	setAttr ".w" 30;
	setAttr ".h" 30;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "3DE9F98B-4583-A69F-F33A-90A232F24692";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 48 ";
	setAttr ".st" 6;
createNode shadingEngine -n "layeredShader1SG";
	rename -uid "8683BA86-42A3-39D7-6A71-9EA6C39EF63A";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "81995762-441B-CD60-D0B7-86BF492EB986";
createNode shadingEngine -n "ArnoldStandardShader1SG";
	rename -uid "D1C475B6-4DEA-77F7-511B-DF8B3D3278DE";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "02DBEF4D-4DC5-7FAC-A250-62A779EE877C";
createNode shadingEngine -n "ArnoldStandardShader2SG";
	rename -uid "56C917B8-48B4-9BA2-0C90-588222276DAF";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "D05D2856-4F59-7E05-DFB3-1CBFD26C7732";
createNode shadingEngine -n "surfaceShader1SG";
	rename -uid "370217B1-4D40-88F1-4233-CDA04F2ACBAB";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo4";
	rename -uid "8C161CA0-4BF8-1848-ACF7-ECAC3E58A591";
createNode shadingEngine -n "aiStandard1SG";
	rename -uid "6ABCB7FA-4263-8BFD-5FBB-71890860FF60";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo5";
	rename -uid "9F824F6C-434D-75D0-A77B-CFB95700C224";
createNode checker -n "checker1";
	rename -uid "7FE325A3-49FE-23AD-4754-8CB6516C54DB";
createNode place2dTexture -n "place2dTexture2";
	rename -uid "B1F1E338-4ECF-79D6-D97B-D988131EB3FF";
	setAttr ".re" -type "float2" 4 4 ;
createNode surfaceShader -n "surfaceShader2";
	rename -uid "C5F7DF6C-4C72-00F2-A1E5-F8A1E889435A";
createNode shadingEngine -n "surfaceShader2SG";
	rename -uid "0E25963A-44D7-B317-F102-09A204EC9595";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo6";
	rename -uid "20AD0382-4E2B-B0CC-D031-B2BE6045C7A6";
createNode plusMinusAverage -n "plusMinusAverage1";
	rename -uid "769AD04C-4CDE-87CD-7394-B09FE02C0C24";
	setAttr ".op" 3;
	setAttr -s 2 ".i3[1]" -type "float3"  0.5 0.2 1;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "913265FD-4696-14CD-186B-74BCAEF24F83";
...
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "7CFE3B44-4130-A753-3CEA-4A88293198BE";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "B372FB78-4BD5-D478-FCC2-E784FAA091B5";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BC58C293-4D23-97B7-D80E-549BB9E1B020";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "03662838-4D2F-33B8-07C9-61BF2D7D58A9";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "08D8F83D-45A4-CDDE-7F2C-83AF85DDBD6B";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode aiUtility -n "aiUtility1";
	rename -uid "64550FF3-486F-E7DA-1AB9-60934BAF3F12";
	setAttr ".shade_mode" 2;
createNode shadingEngine -n "aiUtility1SG";
	rename -uid "DCB2FF9E-4F6C-9BB7-38F5-1681F939373A";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo7";
	rename -uid "8498447B-4054-D918-998C-1EBD0CEC9A35";
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "1D7EE16D-4139-E517-E0AB-CD93B5A8A2F8";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -451.83025350187006 -362.7776110300847 ;
	setAttr ".tgi[0].vh" -type "double2" 606.34308896705386 550.87284165108974 ;
	setAttr -s 7 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -635.71429443359375;
	setAttr ".tgi[0].ni[0].y" 28.571428298950195;
	setAttr ".tgi[0].ni[0].nvs" 1923;
	setAttr ".tgi[0].ni[1].x" 255.96134948730469;
	setAttr ".tgi[0].ni[1].y" 90.123054504394531;
	setAttr ".tgi[0].ni[1].nvs" 1923;
	setAttr ".tgi[0].ni[2].x" 354.04177856445312;
	setAttr ".tgi[0].ni[2].y" 294.61712646484375;
	setAttr ".tgi[0].ni[2].nvs" 1923;
	setAttr ".tgi[0].ni[3].x" -328.57144165039063;
	setAttr ".tgi[0].ni[3].y" 51.428569793701172;
	setAttr ".tgi[0].ni[3].nvs" 1923;
	setAttr ".tgi[0].ni[4].x" -8.4863824844360352;
	setAttr ".tgi[0].ni[4].y" 363.01519775390625;
	setAttr ".tgi[0].ni[4].nvs" 1923;
	setAttr ".tgi[0].ni[5].x" 186.59283447265625;
	setAttr ".tgi[0].ni[5].y" 491.098876953125;
...
connectAttr "aiUtility1.out" "surfaceShader2SG.ss";
connectAttr "pPlaneShape1.iog" "surfaceShader2SG.dsm" -na;
connectAttr "surfaceShader2SG.msg" "materialInfo6.sg";
connectAttr "aiUtility1.msg" "materialInfo6.m";
connectAttr "aiUtility1.msg" "materialInfo6.t" -na;
connectAttr "checker1.oc" "plusMinusAverage1.i3[0]";
connectAttr "plusMinusAverage1.o3" "aiUtility1.color";
...
connectAttr "place2dTexture2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "surfaceShader2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
...
connectAttr "checker1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "plusMinusAverage1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "aiUtility1SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
