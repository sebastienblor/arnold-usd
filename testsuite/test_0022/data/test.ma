...
//Name: test.ma
//Last modified: Tue, Jun 14, 2011 04:43:45 PM
//Codeset: 1252
requires maya "2011";
requires "mtoa" "0.7.0";
...
createNode plusMinusAverage -name "plusMinusAverage1";
	setAttr ".operation" 3;
	setAttr -size 2 ".input3D[1]" -type "float3"  0.5 0.2 1;
...
connectAttr "plusMinusAverage1.output3D" "surfaceShader2.outColor";
...
connectAttr "checker1.outColor" "plusMinusAverage1.input3D[0]";
...
connectAttr "place2dTexture2.message" ":defaultRenderUtilityList1.utilities" -nextAvailable
		;
connectAttr "plusMinusAverage1.message" ":defaultRenderUtilityList1.utilities" -nextAvailable
		;
// End of test.ma
