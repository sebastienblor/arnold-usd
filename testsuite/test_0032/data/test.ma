...
//Name: test.ma
//Last modified: Thu, Jan 12, 2012 01:41:08 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.4269865272820879 0.95260049968280125 1.4392025719555688 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 2.2368076906330887;
...
createNode transform -n "pSphere1";
	setAttr ".s" -type "double3" 0.32643515664681161 0.32643515664681161 0.32643515664681161 ;
...
createNode transform -n "directionalLight1";
	setAttr ".r" -type "double3" -46.398593055546264 -30.527173192049762 23.370433537422709 ;
