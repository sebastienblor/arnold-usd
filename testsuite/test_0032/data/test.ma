...
//Name: test.ma
//Last modified: Wed, Mar 22, 2017 11:51:03 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	rename -uid "E44C0056-4D4D-CAC4-3B37-D2A444CC80B0";
	setAttr ".v" no;
...
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1F93970A-4CE4-7214-AE53-8FB838A86C78";
...
createNode transform -s -n "top";
	rename -uid "CEE5C89D-4E5C-068A-B360-F7A9049148EB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "407F9E2C-4105-0141-343A-D992F9CD27E5";
	addAttr -s false -ci true -k true -sn "filtermap" -ln "filtermap" -at "message";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 -max 
		1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
...
createNode transform -s -n "front";
	rename -uid "F79719E7-4FE2-5DD9-4E89-9FA45EE90CE6";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "FF9CCE09-4AC7-38A9-3511-7AA0A42D97D5";
	addAttr -s false -ci true -k true -sn "filtermap" -ln "filtermap" -at "message";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 -max 
		1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
...
createNode transform -s -n "side";
	rename -uid "F1BC3B57-47D2-6B21-936B-17984737AF3A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "1CA4AD22-444D-0EE3-62F1-DDA3D15F8AAB";
	addAttr -s false -ci true -k true -sn "filtermap" -ln "filtermap" -at "message";
	addAttr -ci true -k true -sn "focal_distance" -ln "focalDistance" -dv 5 -min 0 -max 
		1000000000 -smn 0 -smx 200 -at "float";
	addAttr -ci true -k true -sn "aperture_size" -ln "apertureSize" -dv 0.20000000298023224 
...
createNode transform -n "pSphere1";
	rename -uid "A530F2FD-4FDF-3F8C-386B-FF8BE9952720";
	setAttr ".s" -type "double3" 0.32643515664681161 0.32643515664681161 0.32643515664681161 ;
createNode mesh -n "pSphereShape1" -p "pSphere1";
	rename -uid "44132516-4501-AA7A-B0AA-739BA5003657";
...
createNode transform -n "pointLight1";
	rename -uid "BE24DCB6-4CAA-3C8D-96AF-A2BFC951DC6B";
	setAttr ".t" -type "double3" 0.8946263483617648 1.8998226219594425 2.2074515762557692 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	rename -uid "F92F160F-42C0-D72A-0387-B5B46CD8B1C1";
...
createNode transform -n "pCube1";
	rename -uid "9D98D27C-462B-9032-6579-DDBD8252F72D";
createNode mesh -n "pCubeShape1" -p "pCube1";
	rename -uid "6F2B05D7-4A05-7C5D-7381-81919D2BC1C5";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	addAttr -ci true -sn "ai_sss_sample_spacing" -ln "aiSssSampleSpacing" -dv 0.10000000149011612 
...
createNode transform -n "directionalLight1";
	rename -uid "196F1872-44AA-12DE-0232-78806F0ADF35";
	setAttr ".r" -type "double3" -46.398593055546264 -30.527173192049762 23.370433537422709 ;
createNode directionalLight -n "directionalLightShape1" -p "directionalLight1";
	rename -uid "DA671BBA-48EB-5C33-E041-F99A4112E8BD";
	addAttr -ci true -sn "ai_bounce_factor" -ln "aiBounceFactor" -dv 1 -min 0 -smx 
		20 -at "float";
	addAttr -ci true -sn "ai_bounces" -ln "aiBounces" -dv 999 -min 0 -max 10000 -at "long";
	addAttr -ci true -k true -sn "ai_mis" -ln "aiMis" -dv 1 -min 0 -max 1 -at "bool";
...
createNode expression -n "expression1";
	rename -uid "A0DF93CD-4784-25AD-8B1A-46A25A79EAA7";
	setAttr -k on ".nds";
	setAttr ".ixp" -type "string" ".O[0]=.I[0]*2;";
	setAttr ".ani" 0;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A9C4E97B-4EF1-433E-4E63-6F8FCD1A9CE5";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "DB3BC55D-4E4F-8951-1A03-6DA2F219FFC4";
createNode displayLayer -n "defaultLayer";
	rename -uid "CC945A77-4BC0-C65E-D0D1-679DCB58C95C";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F933F5F1-4836-D248-DA88-F2BC9D658C81";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "9930C383-4E5B-9CD0-F3FC-74B846E154CF";
	setAttr ".g" yes;
createNode polySphere -n "polySphere1";
	rename -uid "5647D9DD-44E1-C4D7-43F7-80983E171899";
	setAttr ".sa" 40;
	setAttr ".sh" 40;
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "03124AF7-4281-04EF-E14D-E086C25BC5E8";
...
createNode shadingEngine -n "aiStandard1SG";
	rename -uid "0C7B0711-4A10-50D6-B4DF-09AFD418F265";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "946948FD-4516-7FF3-015B-81B7379EE441";
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "D21DD2C6-43D8-11D8-61B8-13AA934AE277";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 48 ";
	setAttr ".st" 6;
createNode shadingEngine -n "surfaceShader1SG";
	rename -uid "01D0B74B-402A-BEDC-3F44-CA8F6498C4E0";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "D7EC1E1F-49E9-179D-CB44-19986D8EEF8B";
createNode aiStandard -n "aiStandard2";
	rename -uid "B92FDB71-4349-627A-B70E-7D96F58360B4";
createNode shadingEngine -n "aiStandard2SG";
	rename -uid "B427C5EA-4187-3D63-D216-25A097CA5D9D";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "EB4E3E51-484A-4992-FEA9-9B941DC5FE1B";
createNode cloth -n "cloth1";
	rename -uid "5E3043C1-46EC-C380-7684-7A8FF5FE3476";
	setAttr ".ail" yes;
createNode place2dTexture -n "place2dTexture1";
	rename -uid "EEF26BFD-48C8-40A4-74EC-7892907DACA7";
	setAttr ".re" -type "float2" 4 4 ;
createNode bump2d -n "bump2d1";
	rename -uid "FB52383E-4C46-B689-EC9E-03BB1282CC62";
	setAttr ".vc1" -type "float3" 0 2.9999999e-005 0 ;
	setAttr ".vc2" -type "float3" 9.9999997e-006 9.9999997e-006 0 ;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "00C08729-4119-AAFF-3F87-1DA433D96C3F";
...
createNode polyCube -n "polyCube1";
	rename -uid "202C604C-48DF-08CC-6413-2383D2D91138";
	setAttr ".cuv" 4;
createNode aiStandard -n "aiStandard3";
	rename -uid "96AFC041-44EC-F853-9B2B-9BAD3BF33162";
	setAttr ".Kd" 0;
	setAttr ".Kr" 1;
	setAttr ".Kt" 1;
...
createNode shadingEngine -n "aiStandard3SG";
	rename -uid "D9C55CD8-4D03-1408-236F-A3BEBB7EA47A";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo4";
	rename -uid "39D3F0CE-47AE-D341-D67E-CCBBC7876278";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "D0472EBF-4C04-4252-6DA5-12851F83400A";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "8BAF980B-4A1A-24DB-FFC0-EEB6C3EB0B2B";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "92B35F82-4056-BF76-D634-E88B221A8B88";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "83B44146-4672-92DA-A9EF-18A626B32F68";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "82E12D6D-47FC-CA54-DAC4-62B735BE1D79";
