...
//Name: test.ma
//Last modified: Wed, Sep 21, 2011 03:00:01 PM
//Codeset: 1252
requires maya "2011";
...
createNode transform -name "areaLight1";
	setAttr ".translate" -type "double3" 13.181185309949182 19.477375940652475 12.227286581842323 ;
	setAttr ".rotate" -type "double3" -35.857810735752707 51.562840528206323 0 ;
	setAttr ".scale" -type "double3" 7.1270260243465868 7.1270260243465868 7.1270260243465868 ;
createNode areaLight -name "areaLightShape1" -parent "areaLight1";
...
connectAttr "areaLightShape1.lightData" ":lightList1.lights" -nextAvailable;
connectAttr "areaLight1.instObjGroups" ":defaultLightSet.dagSetMembers" -nextAvailable
		;
// End of test.ma
