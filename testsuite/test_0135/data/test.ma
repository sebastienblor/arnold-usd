...
//Name: test.ma
//Last modified: Wed, Feb 05, 2014 05:03:35 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 37.149452675078209 24.879010072617614 34.319314963850523 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 56.302530984172236;
...
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	...
	setAttr ".ai_exprnrm" yes;
	setAttr ".ai_exprtan" yes;
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "C:/solidangle/mtoa/mtoa-main/testsuite/test_0135/data//texture.png";
...
createNode polyTweak -n "polyTweak1";
	setAttr ".uopa" yes;
	setAttr -s 4 ".tk[0:3]" -type "float3"  0 -13.37940216 -8.21829128
		 0 -13.37940216 -8.21829128 0 13.37940216 8.21829128 0 13.37940216 8.21829128;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "polyMoveVertex1.out" "pPlaneShape1.i";
