...
//Name: test.ma
//Last modified: Fri, Jan 28, 2022 09:47:54 AM
//Codeset: UTF-8
requires maya "2022";
...
fileInfo "UUID" "81F27D80-0003-38B2-61F3-BBCA00000502";
createNode transform -s -n "persp";
	rename -uid "81F27D80-0003-38B2-61F3-B7580000044C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 29.60153735981147 20.248805667886742 27.530518347909634 ;
	setAttr ".r" -type "double3" -18.938352729607587 42.60000000000128 -1.0802089619416705e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "81F27D80-0003-38B2-61F3-B7580000044D";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 45.240626760380863;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "81F27D80-0003-38B2-61F3-B7580000044E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "81F27D80-0003-38B2-61F3-B7580000044F";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "81F27D80-0003-38B2-61F3-B75800000450";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "81F27D80-0003-38B2-61F3-B75800000451";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "81F27D80-0003-38B2-61F3-B75800000452";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "81F27D80-0003-38B2-61F3-B75800000453";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -n "pPlane1";
	rename -uid "81F27D80-0003-38B2-61F3-B75E00000461";
	setAttr ".s" -type "double3" 24.031175220571495 24.031175220571495 24.031175220571495 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "81F27D80-0003-38B2-61F3-B75E00000460";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "pPlane2";
	rename -uid "81F27D80-0003-38B2-61F3-B76500000468";
	setAttr ".t" -type "double3" 0 12 -12 ;
	setAttr ".r" -type "double3" 90 0 0 ;
	setAttr ".s" -type "double3" 24.031175220571495 24.031175220571495 24.031175220571495 ;
createNode mesh -n "pPlaneShape2" -p "pPlane2";
	rename -uid "81F27D80-0003-38B2-61F3-B76500000469";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pPlane3";
	rename -uid "81F27D80-0003-38B2-61F3-B79400000475";
	setAttr ".t" -type "double3" -12 12 0 ;
	setAttr ".r" -type "double3" 0 0 -90 ;
	setAttr ".s" -type "double3" 24.031175220571495 24.031175220571495 24.031175220571495 ;
createNode mesh -n "pPlaneShape3" -p "pPlane3";
	rename -uid "81F27D80-0003-38B2-61F3-B79400000476";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode place3dTexture -n "place3dTexture1";
	rename -uid "81F27D80-0003-38B2-61F3-B7E50000048B";
	setAttr ".t" -type "double3" 0.69026398469206374 17.793338741227931 0 ;
	setAttr ".r" -type "double3" 11.184500311074798 63.309143018722601 48.229238607549313 ;
	setAttr ".s" -type "double3" 1.4809314847022488 1.4809314847022488 1.1848926356784077 ;
createNode transform -n "aiSkyDomeLight1";
	rename -uid "81F27D80-0003-38B2-61F3-B92A000004D5";
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	rename -uid "81F27D80-0003-38B2-61F3-B92A000004D4";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "81F27D80-0003-38B2-61F3-B75800000454";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "81F27D80-0003-38B2-61F3-B75800000455";
createNode displayLayer -n "defaultLayer";
	rename -uid "81F27D80-0003-38B2-61F3-B75800000456";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "81F27D80-0003-38B2-61F3-B75800000457";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "81F27D80-0003-38B2-61F3-B75800000458";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "81F27D80-0003-38B2-61F3-B75800000459";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "81F27D80-0003-38B2-61F3-B7580000045A";
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "81F27D80-0003-38B2-61F3-B7580000045B";
	addAttr -ci true -sn "ARV_options" -ln "ARV_options" -dt "string";
	setAttr ".logv" 3;
	setAttr ".mtrinf" yes;
	setAttr ".version" -type "string" "5.1.0";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "81F27D80-0003-38B2-61F3-B7580000045C";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "81F27D80-0003-38B2-61F3-B7580000045D";
	setAttr ".color_management" 1;
	setAttr ".ai_translator" -type "string" "tif";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "81F27D80-0003-38B2-61F3-B7580000045E";
	setAttr ".output_mode" 0;
	setAttr ".ai_translator" -type "string" "maya";
createNode polyPlane -n "polyPlane1";
	rename -uid "81F27D80-0003-38B2-61F3-B75E0000045F";
	setAttr ".cuv" 2;
createNode aiStandardSurface -n "aiStandardSurface1";
	rename -uid "81F27D80-0003-38B2-61F3-B7B000000482";
createNode shadingEngine -n "aiStandardSurface1SG";
	rename -uid "81F27D80-0003-38B2-61F3-B7B000000483";
	setAttr ".ihi" 0;
	setAttr -s 3 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "81F27D80-0003-38B2-61F3-B7B000000484";
createNode file -n "file1";
	rename -uid "81F27D80-0003-38B2-61F3-B7D500000489";
	setAttr ".ftn" -type "string" "DirectionCheck(50x50mm).tx";
	setAttr ".cs" -type "string" "Raw";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "81F27D80-0003-38B2-61F3-B7D50000048A";
createNode projection -n "projection1";
	rename -uid "81F27D80-0003-38B2-61F3-B7EC00000494";
...
createNode script -n "uiConfigurationScriptNode";
	rename -uid "81F27D80-0003-38B2-61F3-B948000004DF";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "81F27D80-0003-38B2-61F3-B948000004E0";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 120 -ast 1 -aet 200 ";
	setAttr ".st" 6;
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "81F27D80-0003-38B2-61F3-BBCA00000503";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -763.93075878023512 -728.01297386869146 ;
	setAttr ".tgi[0].vh" -type "double2" 580.73085052218858 499.32231899232198 ;
	setAttr -s 10 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 60;
	setAttr ".tgi[0].ni[0].y" 35.714286804199219;
	setAttr ".tgi[0].ni[0].nvs" 18304;
	setAttr ".tgi[0].ni[1].x" -672.63226318359375;
	setAttr ".tgi[0].ni[1].y" 102.02915954589844;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[0].ni[2].x" 367.14285278320312;
	setAttr ".tgi[0].ni[2].y" 35.714286804199219;
	setAttr ".tgi[0].ni[2].nvs" 18304;
	setAttr ".tgi[0].ni[3].x" -494.03732299804688;
	setAttr ".tgi[0].ni[3].y" 246.652099609375;
	setAttr ".tgi[0].ni[3].nvs" 1923;
	setAttr ".tgi[0].ni[4].x" -603.2164306640625;
	setAttr ".tgi[0].ni[4].y" -185.37669372558594;
	setAttr ".tgi[0].ni[4].nvs" 18306;
	setAttr ".tgi[0].ni[5].x" -192.38166809082031;
	setAttr ".tgi[0].ni[5].y" -64.971343994140625;
...
connectAttr "projection1.oc" "aiStandardSurface1.base_color";
...
connectAttr "aiStandardSurface1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "place2dTexture1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn";
connectAttr "aiStandardSurface1SG.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "file1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn";
connectAttr "place3dTexture1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn";
connectAttr "projection1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn";
connectAttr "aiSkyDomeLightShape1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
connectAttr "aiSkyDomeLight1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[7].dn";
