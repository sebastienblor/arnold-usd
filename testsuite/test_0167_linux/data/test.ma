...
//Name: test.ma
//Last modified: Thu, Jul 20, 2017 01:28:11 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 49.103783620309784 47.11648561709049 75.254654492322118 ;
	setAttr ".r" -type "double3" -14.138352729605236 13.000000000001005 6.1204056274641035e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "3398E8B3-4D07-620E-4BA9-45B6609CEB02";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 94.184315398952492;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "20D62C16-4489-0FF0-6330-DE9669F06A3E";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "676D3216-480D-F0C5-22C7-97844EBBF172";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E2C9F3E4-459A-536F-039C-85AB9E73BE2F";
createNode displayLayerManager -n "layerManager";
	rename -uid "48BF90FC-4B20-4560-84A0-5996812E7F08";
createNode displayLayer -n "defaultLayer";
	rename -uid "3BAC58F2-4C7D-115E-B79B-FA9B37E958E4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B7AE4E8D-4B88-B044-2B0E-37AB9829E714";
...
createNode type -n "type1";
	...
	setAttr ".vertsPerChar" -type "doubleArray" 6 101 161 169 177 246 330 ;
	setAttr ".characterBoundingBoxesMax" -type "vectorArray" 6 8.1098765807393001
		 12.302407587548638 0 19.751375547178988 12.051503222276265 0 35.135616792315176 12.051503222276265
		 0 42.837351045719842 9.0406508390077818 0 49.69620166585603 9.2915552042801561 0 58.482490272373539
		 9.2915552042801561 0 ;
	setAttr ".characterBoundingBoxesMin" -type "vectorArray" 6 0.78508785262645919
		 -0.25090436527237353 0 10.249384423638132 0 0 25.439377127918288 0 0 34.67891232976654
		 -3.3345999513618678 0 42.112414883268485 -3.3345999513618678 0 50.672080192120625
		 -0.2104359192607004 0 ;
	setAttr ".manipulatorPivots" -type "vectorArray" 6 0.78508785262645919 -0.25090436527237353
		 0 10.249384423638132 0 0 25.439377127918288 0 0 34.67891232976654 -3.3345999513618678
		 0 42.112414883268485 -3.3345999513618678 0 50.672080192120625 -0.2104359192607004
		 0 ;
	setAttr ".holeInfo" -type "Int32Array" 9 1 29 132 4 26
		 220 5 17 313 ;
...
createNode typeExtrude -n "typeExtrude1";
	...
	setAttr ".capComponents" -type "componentList" 7 "f[0]" "f[405:406]" "f[647:648]" "f[681:682]" "f[715:716]" "f[993:994]" "f[1331]";
	setAttr ".extrusionComponents" -type "componentList" 6 "f[1:404]" "f[407:646]" "f[649:680]" "f[683:714]" "f[717:992]" "f[995:1330]";
