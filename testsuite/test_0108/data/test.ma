...
//Name: test.ma
//Last modified: Thu, Jan 24, 2013 08:17:47 PM
//Codeset: UTF-8
requires maya "2011";
...
createNode fluidShape -n "fluidShape1" -p "fluid1";
	...
	setAttr -k on ".ai_override_textures" yes;
	setAttr -k on ".ai_texture_affect_color" yes;
	setAttr -k on ".ai_texture_affect_opacity" yes;
...
connectAttr "aiNoise1.out" "fluidShape1.ai_volume_texture";
