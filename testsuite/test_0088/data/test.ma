...
//Name: test.ma
//Last modified: Wed, Aug 01, 2012 03:52:26 PM
//Codeset: 1252
requires maya "2011";
...
createNode nurbsCurve -n "curveShape1" -p "curve1";
	...
	addAttr -ci true -sn "ai_mode" -ln "aiMode" -min 0 -max 2 -en "ribbon:thick:oriented" 
		-at "enum";
	addAttr -ci true -k true -sn "rcurve" -ln "renderCurve" -min 0 -max 1 -at "bool";
	addAttr -ci true -k true -sn "cwdth" -ln "curveWidth" -dv 0.0099999997764825821 
		-at "float";
	addAttr -ci true -k true -sn "srate" -ln "sampleRate" -dv 5 -at "long";
	addAttr -ci true -k true -sn "ai_curve_shader" -ln "aiCurveShader" -at "message";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr -k off ".v";
	...
	setAttr -k on ".cwdth" 0.60000002384185791;
	setAttr -k on ".srate" 10;
...
createNode nurbsCurve -n "curveShape2" -p "curve2";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		;
	setAttr -k on ".rcurve" yes;
	setAttr -k on ".cwdth" 0.40000000596046448;
