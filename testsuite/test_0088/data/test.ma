...
//Name: test.ma
//Last modified: Fri, Feb 17, 2017 05:21:12 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	rename -uid "04BB7935-4108-20DA-9AD9-1596B0CE71CA";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.2295050579266382 10.58984177228017 2.0213391713037754 ;
	setAttr ".r" -type "double3" -67.538352729849848 90.199999999996948 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "3C0DB5F3-468C-F9FC-11AA-79AD195EC00A";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 11.931429269343278;
...
createNode transform -s -n "top";
	rename -uid "16DD7F50-4380-6461-E5ED-05B8F68CBA7C";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".v" no;
...
createNode camera -s -n "topShape" -p "top";
	rename -uid "48797750-4AC9-8658-3C01-DB9A2DC4AEC1";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
...
createNode transform -s -n "front";
	rename -uid "3F628668-4824-87BA-C1F5-D0BF6D70EF4F";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 100.1 ;
	setAttr ".lumaID" -type "string" "a:1338571498.23:0.020474217924";
createNode camera -s -n "frontShape" -p "front";
	rename -uid "789457C7-4B30-DAF5-85E2-31A7E6B1A911";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
...
createNode transform -s -n "side";
	rename -uid "40E43A7D-485D-BAF1-A9A5-AF920608254C";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".v" no;
...
createNode camera -s -n "sideShape" -p "side";
	rename -uid "F4E3DB93-4AD1-63A0-B9E1-C98BFBB9B086";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
...
createNode transform -n "curve1";
	rename -uid "E44602E3-4303-9545-9636-449299F7AC66";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".lumaID" -type "string" "a:1338571576.14:0.972738841948";
createNode nurbsCurve -n "curveShape1" -p "curve1";
	rename -uid "DF13A9A3-4E61-0BB7-05CB-9BAFFA4CECBC";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		9
		-1.7629116199361778 0 2.8062961281930234
		-2.8584017821829679 0 4.4568734047285528
		-2.0588105412485618 0 5.8550170422095
		-0.55621694578066805 0 5.4421515058305383
		0.32168310458853266 0 3.9752400113275606
		1.3869834587983503 0 2.7245162153284097
		2.4101792014173262 0 3.5729604075118497
		2.5966157241893946 0 4.9562174773065966
		1.6777678486847574 0 5.8152264881180731
		;
	setAttr ".ai_mode" 1;
	setAttr ".rcurve" yes;
	setAttr ".cwdth" 0.60000002384185791;
	setAttr ".srate" 10;
	setAttr ".lumaID" -type "string" "a:1338571576.14:0.771510307246";
createNode transform -n "curve2";
	rename -uid "89E3EEF2-4413-8D8F-8FF0-C7A48CCE849D";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".lumaID" -type "string" "a:1338571588.02:0.898626839214";
createNode nurbsCurve -n "curveShape2" -p "curve2";
	rename -uid "58DEF142-4916-3D48-316F-3DBBD277C003";
	addAttr -ci true -sn "ai_sss_sample_distribution" -ln "aiSssSampleDistribution" 
		-min 0 -max 3 -en "blue_noise:blue_noise_Pref:triangle_midpoint:polygon_midpoint" 
		-at "enum";
	addAttr -ci true -sn "ai_sss_sample_spacing" -ln "aiSssSampleSpacing" -dv 0.10000000149011612 
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		12
		0.86447924354518446 0 0.25776653033935271
		-0.78048108746410694 0 -0.50990931811738216
		-2.3471983503376226 0 -1.486319078598795
		-3.2532549886040565 0 0.21107536023721454
		-2.1459202634610941 0 1.0138485269664292
		-0.29067558959673878 0 1.8056784934333243
		-0.15320935968458266 0 -1.9702804387915702
		1.2378056381521425 0 -1.7090283069582124
		2.1483255460891062 0 -1.2391311022394973
		2.6333891499059807 0 -0.028032285326582917
		1.671278717206212 0 0.91720482887141253
		-0.75734124927716917 0 -0.51806398510599538
		;
	setAttr ".rcurve" yes;
	setAttr ".cwdth" 0.40000000596046448;
	setAttr ".lumaID" -type "string" "a:1338571588.02:0.790693887503";
createNode lightLinker -s -n "lightLinker1";
	rename -uid "CA262BA2-43BB-5459-BFB3-AA92B2893438";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
	setAttr ".lumaID" -type "string" "a:1338571498.23:0.072050097977";
createNode displayLayerManager -n "layerManager";
	rename -uid "76CD7275-4B4C-4F1B-3489-A599BB187635";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".lumaID" -type "string" "a:1338571498.23:0.475844066019";
createNode displayLayer -n "defaultLayer";
	rename -uid "50250928-40F7-CEF2-6E5E-E5910EC3106A";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".lumaID" -type "string" "a:1338571498.23:0.720118323218";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D4DF9042-48D2-AA59-8DFE-F98CE2F14BE3";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".lumaID" -type "string" "a:1338571498.23:0.253386281794";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "1F1DD723-4C3C-77AB-3F21-04966DC5BC74";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".g" yes;
	setAttr ".lumaID" -type "string" "a:1338571498.23:0.123169092147";
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "F2F29EED-4D4D-F820-76F9-3AAC8CAE25D4";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	addAttr -ci true -sn "ARV_options" -ln "ARV_options" -dt "string";
	setAttr ".lumaID" -type "string" "a:1338571498.24:0.365850055938";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "A0099DAD-4D4E-EA16-D75D-61896B01D252";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
	setAttr ".ai_translator" -type "string" "gaussian";
	setAttr ".lumaID" -type "string" "a:1338571498.24:0.00289691703387";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "CA37B788-406B-2DCA-10A0-E3985A9C0B41";
...
createNode script -n "uiConfigurationScriptNode";
	rename -uid "49921961-4B29-2123-C9EA-5B87DE5EAFF7";
	addAttr -ci true -sn "lumaID" -ln "lumaID" -dt "string";
...
createNode place2dTexture -n "place2dTexture1";
	rename -uid "DFDD72AA-4E10-5E93-4CE1-06B92AD3D7F8";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "96C4F9BE-49CF-6082-236D-5497C43FA1EE";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9B126839-41A4-DD73-484B-579152743A7E";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "7AD0E4B9-4165-8D7F-7005-5A88DA35C17A";
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "aiStandard2.out" "curveShape1.ai_curve_shader";
...
connectAttr "ramp1.oc" "aiStandard2.Kd_color";
